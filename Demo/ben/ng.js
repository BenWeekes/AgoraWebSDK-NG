/**
 * AgoraWebSDK_N-v4.1.1-7-g1aff811 Copyright AgoraInc.
 */
...
'use strict';
!function(Ka, Hb) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = Hb() : "function" == typeof define && define.amd ? define(Hb) : (Ka = "undefined" != typeof globalThis ? globalThis : Ka || self).AgoraRTC = Hb()
}(this, function() {
    function Ka(c, a, b) {
        return c(b = {
            path: a,
    ...
    function rc(c, a, b) {
        if (c.RTCPeerConnection) {
            ...
            c.removeEventListener = function(b, c) {
                ...
                return delete this._eventMap[c],
                e.apply(this, [b, d])
            }
            ;
            ba(c, "on" + a, {
                ...
                set(b) {
                    this["_on" + a] && (this.removeEventListener(a, this["_on" + a]),
                    delete this["_on" + a]);
    ...
    function jl(c) {
        return "boolean" != typeof c ? Error("Argument type: " + typeof c + ". Please use a boolean.") : (wg = c,
        c ? "adapter.js logging disabled" : "adapter.js logging enabled")
    }
    function kl(c) {
        return "boolean" != typeof c ? Error("Argument type: " + typeof c + ". Please use a boolean.") : (xg = !c,
        "adapter.js deprecation warnings " + (c ? "disabled" : "enabled"))
    }
    function kb() {
        "object" != typeof window || wg || "undefined" != typeof console && "function" == typeof console.log && console.log.apply(console, arguments)
    }
    function Ad(c, a) {
    ...
    function Ib(c) {
        ...
        if (void 0 === c || !c.navigator)
            return b.browser = "Not a browser.",
            b;
        if (a.mozGetUserMedia)
            b.browser = "firefox",
            b.version = Hb(a.userAgent, /Firefox\/(\d+)\./, 1);
        else if (a.webkitGetUserMedia || !1 === c.isSecureContext && c.webkitRTCPeerConnection && !c.RTCIceGatherer)
            b.browser = "chrome",
            ...
            if (!c.RTCPeerConnection || !a.userAgent.match(/AppleWebKit\/(\d+)\./))
                return b.browser = "Not a supported browser.",
                b;
            b.browser = "safari";
            b.version = Hb(a.userAgent, /AppleWebKit\/(\d+)\./, 1);
            b.supportsUnifiedPlan = c.RTCRtpTransceiver && "currentDirection"in c.RTCRtpTransceiver.prototype
        }
        return b
    }
    function yg(c) {
        var a;
        return "[object Object]" === Object.prototype.toString.call(c) ? xe(a = V(c)).call(a, function(a, d) {
            var b = "[object Object]" === Object.prototype.toString.call(c[d]);
            let f = b ? yg(c[d]) : c[d];
            b = b && !V(f).length;
            return void 0 === f || b ? a : Wa(a, {
                [d]: f
            })
        }, {}) : c
    }
    ...
    function Bg(c) {
        ...
        if (a.mediaDevices) {
              ...
              , d = function(a) {
                ...
                (r(b = V(a)).call(b, b=>{
                    if ("require" !== b && "advanced" !== b && "mediaSource" !== b) {
                        ...
                        var e = function(a, b) {
                            return a ? a + b.charAt(0).toUpperCase() + wb(b).call(b, 1) : "deviceId" === b ? "sourceId" : b
                        };
                        if (void 0 !== d.ideal) {
                        ...
                        c.mandatory[e("", b)] = d.exact) : r(f = ["min", "max"]).call(f, a=>{
                ...
                a.advanced) && (c.optional = n(d = c.optional || []).call(d, a.advanced));
                return c
            }
              , e = function(c, e) {
                if (61 <= b.version)
                ...
                if ((c = JSON.parse(w(c))) && "object" == typeof c.audio) {
                    ...
                    f((c = JSON.parse(w(c))).audio, "autoGainControl", "googAutoGainControl");
                ...
                if (c && "object" == typeof c.video) {
                    ...
                    f = 66 > b.version;
                    if (!(!g || "user" !== g.exact && "environment" !== g.exact && "user" !== g.ideal && "environment" !== g.ideal || a.mediaDevices.getSupportedConstraints && a.mediaDevices.getSupportedConstraints().facingMode && !f)) {
                        let b;
                        if (delete c.video.facingMode,
                        "environment" === g.exact || "environment" === g.ideal ? b = ["back", "rear"] : "user" !== g.exact && "user" !== g.ideal || (b = ["front"]),
                        b)
                            return a.mediaDevices.enumerateDevices().then(a=>{
                                a = N(a).call(a, a=>"videoinput" === a.kind);
                                let f = R(a).call(a, a=>Cg(b).call(b, b=>{
                                    var c;
                                    return La(c = a.label.toLowerCase()).call(c, b)
                                }
                                ));
                                return !f && a.length && La(b).call(b, "back") && (f = a[a.length - 1]),
                                f && (c.video.deviceId = g.exact ? {
                                    exact: f.deviceId
                                } : {
                                    ideal: f.deviceId
                                }),
                ...
                return Dg("chrome: " + w(c)),
                e(c)
            }
              , f = function(a) {
                return 64 <= b.version ? a : {
                    name: {
            ...
            ;
            if (a.getUserMedia = za(c).call(c, a),
            a.mediaDevices.getUserMedia) {
                var g;
                let b = za(g = a.mediaDevices.getUserMedia).call(g, a.mediaDevices);
                a.mediaDevices.getUserMedia = function(a) {
                    return e(a, a=>b(a).then(b=>{
                        var c;
                        if (a.audio && !b.getAudioTracks().length || a.video && !b.getVideoTracks().length)
                            throw r(c = b.getTracks()).call(c, a=>{
                                a.stop()
                            }
                            ),
    ...
    function Fg(c) {
        if ("object" != typeof c || !c.RTCPeerConnection || "ontrack"in c.RTCPeerConnection.prototype)
            rc(c, "track", a=>(a.transceiver || ba(a, "transceiver", {
                value: {
                    receiver: a.receiver
                }
            }),
            ...
            c.RTCPeerConnection.prototype.setRemoteDescription = function() {
                return this._ontrackpoly || (this._ontrackpoly = a=>{
                    ...
                    a.stream.addEventListener("addtrack", b=>{
                        let d;
                        var e;
                        c.RTCPeerConnection.prototype.getReceivers ? d = R(e = this.getReceivers()).call(e, a=>a.track && a.track.id === b.track.id) : d = {
                            track: b.track
                        };
                        e = new Event("track");
                        e.track = b.track;
                    ...
                    r(b = a.stream.getTracks()).call(b, b=>{
                        let d;
                        var e;
                        c.RTCPeerConnection.prototype.getReceivers ? d = R(e = this.getReceivers()).call(e, a=>a.track && a.track.id === b.id) : d = {
                            track: b
                        };
                        e = new Event("track");
                        e.track = b;
    ...
    function Gg(c) {
        if ("object" == typeof c && c.RTCPeerConnection && !("getSenders"in c.RTCPeerConnection.prototype) && "createDTMFSender"in c.RTCPeerConnection.prototype) {
            let a = function(a, b) {
                return {
                    track: b,
                    get dtmf() {
            ...
            c.RTCPeerConnection.prototype.removeStream = function(a) {
                ...
                r(b = a.getTracks()).call(b, a=>{
                    ...
                    var d, e;
                    c && Ma(d = this._senders).call(d, E(e = this._senders).call(e, c), 1)
                }
                )
            }
        } else if ("object" == typeof c && c.RTCPeerConnection && "getSenders"in c.RTCPeerConnection.prototype && "createDTMFSender"in c.RTCPeerConnection.prototype && c.RTCRtpSender && !("dtmf"in c.RTCRtpSender.prototype)) {
            let a = c.RTCPeerConnection.prototype.getSenders;
            c.RTCPeerConnection.prototype.getSenders = function() {
                let b = a.apply(this, []);
                return r(b).call(b, a=>a._pc = this),
                b
            }
            ;
    ...
    function Hg(c) {
        if (c.RTCPeerConnection) {
            ...
            c.RTCPeerConnection.prototype.getStats = function() {
                ...
                return 2 <= arguments.length ? a.apply(this, [function(a) {
                    c(g(f(a)))
                }
                , b]) : (new u((b,c)=>{
                    a.apply(this, [function(a) {
                        b(g(f(a)))
                    }
                    , c])
                }
    ...
    function Ig(c) {
        if ("object" == typeof c && c.RTCPeerConnection && c.RTCRtpSender && c.RTCRtpReceiver) {
            ...
            if (!("getStats"in c.RTCRtpReceiver.prototype)) {
                ...
                rc(c, "track", a=>(a.receiver._pc = a.srcElement,
                a));
            ...
            if ("getStats"in c.RTCRtpSender.prototype && "getStats"in c.RTCRtpReceiver.prototype) {
                ...
                c.RTCPeerConnection.prototype.getStats = function() {
                    if (0 < arguments.length && arguments[0]instanceof c.MediaStreamTrack) {
                        var b, d;
                        let a = arguments[0], c, g, h;
                        return r(b = this.getSenders()).call(b, b=>{
                            b.track === a && (c ? h = !0 : c = b)
                        }
                        ),
                        r(d = this.getReceivers()).call(d, b=>(b.track === a && (g ? h = !0 : g = b),
                        b.track === a)),
                        h || c && g ? u.reject(new DOMException("There are more than one sender or receiver for the track.","InvalidAccessError")) : c ? c.getStats() : g ? g.getStats() : u.reject(new DOMException("There is no sender or receiver for the track.","InvalidAccessError"))
                    }
                    return a.apply(this, arguments)
                }
            }
    ...
    function Jg(c) {
        c.RTCPeerConnection.prototype.getLocalStreams = function() {
            ...
            D(a = V(this._shimmedLocalStreams)).call(a, a=>this._shimmedLocalStreams[a][0])
        }
        ;
        ...
        c.RTCPeerConnection.prototype.addTrack = function(b, c) {
            ...
            return this._shimmedLocalStreams[c.id] ? -1 === E(d = this._shimmedLocalStreams[c.id]).call(d, e) && this._shimmedLocalStreams[c.id].push(e) : this._shimmedLocalStreams[c.id] = [c, e],
            e
        }
        ;
        let b = c.RTCPeerConnection.prototype.addStream;
        c.RTCPeerConnection.prototype.addStream = function(a) {
            ...
            c = N(d = this.getSenders()).call(d, a=>-1 === E(f).call(f, a));
        ...
        c.RTCPeerConnection.prototype.removeTrack = function(a) {
            var b;
            (this._shimmedLocalStreams = this._shimmedLocalStreams || {},
            a) && r(b = V(this._shimmedLocalStreams)).call(b, b=>{
                var c;
    ...
    function Kg(c) {
        function a(a, b) {
            var c;
            let d = b.sdp;
            return r(c = V(a._reverseStreams || [])).call(c, b=>{
        ...
        if (c.RTCPeerConnection) {
            ...
            c.RTCPeerConnection.prototype.addStream = function(a) {
                ...
                this._reverseStreams[a.id]) || (b = new c.MediaStream(a.getTracks()),
            ...
            c.RTCPeerConnection.prototype.addTrack = function(a, b) {
                ...
                if (1 !== g.length || !R(d = g[0].getTracks()).call(d, b=>b === a))
                    throw new DOMException("The adapter.js addTrack polyfill only supports a single  stream which is associated with the specified track.","NotSupportedError");
                if (R(e = this.getSenders()).call(e, b=>b.track === a))
                    throw new DOMException("Track already exists.","InvalidAccessError");
                this._streams = this._streams || {};
                this._reverseStreams = this._reverseStreams || {};
                (d = this._streams[b.id]) ? (d.addTrack(a),
                u.resolve().then(()=>{
            ...
            r(d = ["createOffer", "createAnswer"]).call(d, function(b) {
                ...
                c.RTCPeerConnection.prototype[b] = {
                    [b]() {
                        const b = arguments;
                        return arguments.length && "function" == typeof arguments[0] ? d.apply(this, [c=>{
                            c = a(this, c);
                            b[0].apply(null, [c])
                        }
                        , a=>{
                        ...
                        , arguments[2]]) : d.apply(this, arguments).then(b=>a(this, b))
                    }
                }[b]
            });
            var q = c.RTCPeerConnection.prototype.setLocalDescription;
            c.RTCPeerConnection.prototype.setLocalDescription = function() {
                return arguments.length && arguments[0].type ? (arguments[0] = b(this, arguments[0]),
                q.apply(this, arguments)) : q.apply(this, arguments)
            }
            ;
    ...
    function ze(c) {
        let a = Ib(c);
        if (!c.RTCPeerConnection && c.webkitRTCPeerConnection && (c.RTCPeerConnection = c.webkitRTCPeerConnection),
        c.RTCPeerConnection) {
            var b;
            53 > a.version && r(b = ["setLocalDescription", "setRemoteDescription", "addIceCandidate"]).call(b, function(a) {
                let b = c.RTCPeerConnection.prototype[a];
                c.RTCPeerConnection.prototype[a] = {
                    [a]() {
                        return arguments[0] = new ("addIceCandidate" === a ? c.RTCIceCandidate : c.RTCSessionDescription)(arguments[0]),
                        b.apply(this, arguments)
                    }
                }[a]
            });
            ...
            c.RTCPeerConnection.prototype.addIceCandidate = function() {
                return arguments[0] ? 78 > a.version && arguments[0] && "" === arguments[0].candidate ? u.resolve() : d.apply(this, arguments) : (arguments[1] && arguments[1].apply(null),
                u.resolve())
            }
        }
    }
    function Lg(c) {
        rc(c, "negotiationneeded", a=>{
            if ("stable" === a.target.signalingState)
                return a
        }
        )
    }
    function ll(c, a) {
        ...
        N(c).call(c, a=>{
            if (a && (a.urls || a.url)) {
                ...
                return d && (c = [c]),
                c = N(c).call(c, a=>0 === E(a).call(a, "stun:") ? !1 : (a = Bd(a).call(a, "turn") && !Bd(a).call(a, "turn:[") && La(a).call(a, "transport=udp")) && !b ? (b = !0,
                !0) : a && !b),
                delete a.url,
                a.urls = d ? c[0] : c,
                !!c.length
    ...
    function Mg(c, a, b, d, e) {
        ...
        if (a += F.writeIceParameters(c.iceGatherer.getLocalParameters()),
        a += F.writeDtlsParameters(c.dtlsTransport.getLocalParameters(), "offer" === b ? "actpass" : e || "active"),
        a += "a=mid:" + c.mid + "\r\n",
        ...
        c.rtpSender)
            ...
            c.sendEncodingParameters[0].rtx && (a += "a=ssrc:" + c.sendEncodingParameters[0].rtx.ssrc + " " + d,
            a += "a=ssrc-group:FID " + c.sendEncodingParameters[0].ssrc + " " + c.sendEncodingParameters[0].rtx.ssrc + "\r\n");
        return a += "a=ssrc:" + c.sendEncodingParameters[0].ssrc + " cname:" + F.localCName + "\r\n",
        c.rtpSender && c.sendEncodingParameters[0].rtx && (a += "a=ssrc:" + c.sendEncodingParameters[0].rtx.ssrc + " cname:" + F.localCName + "\r\n"),
        a
    }
    function ml(c, a) {
        var b = !1;
        return (c = JSON.parse(JSON.stringify(c))).filter(function(c) {
            if (c && (c.urls || c.url)) {
                ...
                d = d.filter(function(c) {
                    return 0 !== c.indexOf("turn:") || -1 === c.indexOf("transport=udp") || -1 !== c.indexOf("turn:[") || b ? 0 === c.indexOf("stun:") && 14393 <= a && -1 === c.indexOf("?transport=udp") : (b = !0,
                    !0)
                }),
                delete c.url,
                c.urls = f ? d[0] : d,
    ...
    function Cd(c, a) {
        ...
        return c.codecs.forEach(function(d) {
            for (var f = 0; f < a.codecs.length; f++) {
                var h = a.codecs[f];
                if (d.name.toLowerCase() === h.name.toLowerCase() && d.clockRate === h.clockRate && ("rtx" !== d.name.toLowerCase() || !d.parameters || !h.parameters.apt || e(d, h, c.codecs, a.codecs))) {
                    (h = JSON.parse(JSON.stringify(h))).numChannels = Math.min(d.numChannels, h.numChannels);
                    b.codecs.push(h);
                    h.rtcpFeedback = h.rtcpFeedback.filter(function(a) {
                        for (var b = 0; b < d.rtcpFeedback.length; b++)
                            if (d.rtcpFeedback[b].type === a.type && d.rtcpFeedback[b].parameter === a.parameter)
                                return !0;
                        return !1
                    });
                    break
    ...
    function Ae(c, a) {
        ...
        return b || c.addRemoteCandidate(a),
        !b
    }
    function Fa(c, a) {
        a = Error(a);
    ...
    function Og(c) {
        var a;
        c = c && c.navigator;
        let b = za(a = c.mediaDevices.getUserMedia).call(a, c.mediaDevices);
        c.mediaDevices.getUserMedia = function(a) {
            return b(a).catch(a=>u.reject(function(a) {
                return {
                    name: {
                        PermissionDeniedError: "NotAllowedError"
                    }[a.name] || a.name,
    ...
    function Pg(c) {
        var a;
        "getDisplayMedia"in c.navigator && c.navigator.mediaDevices && (c.navigator.mediaDevices && "getDisplayMedia"in c.navigator.mediaDevices || (c.navigator.mediaDevices.getDisplayMedia = za(a = c.navigator.getDisplayMedia).call(a, c.navigator)))
    }
    function Be(c) {
        let a = Ib(c);
        if (c.RTCIceGatherer && (c.RTCIceCandidate || (c.RTCIceCandidate = function(a) {
            return a
        }
        ),
        c.RTCSessionDescription || (c.RTCSessionDescription = function(a) {
            return a
        }
        ),
        15025 > a.version)) {
        ...
        !c.RTCRtpSender || "dtmf"in c.RTCRtpSender.prototype || ba(c.RTCRtpSender.prototype, "dtmf", {
            get() {
                return void 0 === this._dtmf && ("audio" === this.track.kind ? this._dtmf = new c.RTCDtmfSender(this) : "video" === this.track.kind && (this._dtmf = null)),
                this._dtmf
            }
        });
        c.RTCDtmfSender && !c.RTCDTMFSender && (c.RTCDTMFSender = c.RTCDtmfSender);
        let b = nl(c, a.version);
        c.RTCPeerConnection = function(c) {
            return c && c.iceServers && (c.iceServers = ll(c.iceServers, a.version),
    ...
    function Qg(c) {
        !c.RTCRtpSender || "replaceTrack"in c.RTCRtpSender.prototype || (c.RTCRtpSender.prototype.replaceTrack = c.RTCRtpSender.prototype.setTrack)
    }
    function Rg(c) {
        let a = Ib(c)
          , b = c && c.navigator;
        c = c && c.MediaStreamTrack;
        if (b.getUserMedia = function(a, c, d) {
        ...
        !(55 < a.version && "autoGainControl"in b.mediaDevices.getSupportedConstraints())) {
            ...
            let a = function(a, b, c) {
              ...
              , f = za(d = b.mediaDevices.getUserMedia).call(d, b.mediaDevices);
            if (b.mediaDevices.getUserMedia = function(b) {
                return "object" == typeof b && "object" == typeof b.audio && (b = JSON.parse(w(b)),
            ...
            c && c.prototype.getSettings) {
                ...
                c.prototype.getSettings = function() {
                    ...
                    return a(c, "mozAutoGainControl", "autoGainControl"),
            ...
            if (c && c.prototype.applyConstraints) {
                ...
                c.prototype.applyConstraints = function(c) {
                    return "audio" === this.kind && "object" == typeof c && (c = JSON.parse(w(c)),
    ...
    function Sg(c) {
        "object" == typeof c && c.RTCTrackEvent && "receiver"in c.RTCTrackEvent.prototype && !("transceiver"in c.RTCTrackEvent.prototype) && ba(c.RTCTrackEvent.prototype, "transceiver", {
            get() {
                return {
    ...
    function Ce(c) {
        ...
        if ("object" == typeof c && (c.RTCPeerConnection || c.mozRTCPeerConnection)) {
            var b;
            (!c.RTCPeerConnection && c.mozRTCPeerConnection && (c.RTCPeerConnection = c.mozRTCPeerConnection),
            53 > a.version) && r(b = ["setLocalDescription", "setRemoteDescription", "addIceCandidate"]).call(b, function(a) {
                let b = c.RTCPeerConnection.prototype[a];
                c.RTCPeerConnection.prototype[a] = {
                    [a]() {
            ...
            var d = c.RTCPeerConnection.prototype.addIceCandidate;
            c.RTCPeerConnection.prototype.addIceCandidate = function() {
                return arguments[0] ? 68 > a.version && arguments[0] && "" === arguments[0].candidate ? u.resolve() : d.apply(this, arguments) : (arguments[1] && arguments[1].apply(null),
                u.resolve())
            }
            ;
            var e = {
            ...
            c.RTCPeerConnection.prototype.getStats = function() {
                let[b,c,d] = arguments;
                return f.apply(this, [b || null]).then(b=>{
                    if (53 > a.version && !c)
                        try {
                            r(b).call(b, a=>{
    ...
    function Tg(c) {
        if ("object" == typeof c && c.RTCPeerConnection && c.RTCRtpSender && !(c.RTCRtpSender && "getStats"in c.RTCRtpSender.prototype)) {
            ...
            b && (c.RTCPeerConnection.prototype.addTrack = function() {
    ...
    function Vg(c) {
        !c.RTCPeerConnection || "removeStream"in c.RTCPeerConnection.prototype || (c.RTCPeerConnection.prototype.removeStream = function(a) {
            var b;
            Ad("removeStream", "removeTrack");
            r(b = this.getSenders()).call(b, b=>{
                var c;
                b.track && La(c = a.getTracks()).call(c, b.track) && this.removeTrack(b)
            }
            )
        }
        )
    ...
    function Xg(c) {
        if ("object" == typeof c && c.RTCPeerConnection) {
            if ("getLocalStreams"in c.RTCPeerConnection.prototype || (c.RTCPeerConnection.prototype.getLocalStreams = function() {
            ...
            !("addStream"in c.RTCPeerConnection.prototype)) {
                ...
                c.RTCPeerConnection.prototype.addTrack = function(b, c) {
                    var d;
                    c && (this._localStreams ? La(d = this._localStreams).call(d, c) || this._localStreams.push(c) : this._localStreams = [c]);
                    return a.call(this, b, c)
                }
            }
            "removeStream"in c.RTCPeerConnection.prototype || (c.RTCPeerConnection.prototype.removeStream = function(a) {
                var b, c, e;
                this._localStreams || (this._localStreams = []);
    ...
    function Yg(c) {
        if ("object" == typeof c && c.RTCPeerConnection && ("getRemoteStreams"in c.RTCPeerConnection.prototype || (c.RTCPeerConnection.prototype.getRemoteStreams = function() {
                ...
                set(a) {
                    ...
                    this.addEventListener("track", this._onaddstreampoly = a=>{
                        ...
                        r(b = a.streams).call(b, a=>{
                            ...
                            La(b = this._remoteStreams).call(b, a)) || (this._remoteStreams.push(a),
            ...
            c.RTCPeerConnection.prototype.setRemoteDescription = function() {
                ...
                return this._onaddstreampoly || this.addEventListener("track", this._onaddstreampoly = function(a) {
                    ...
                    r(c = a.streams).call(c, a=>{
                        ...
                        0 <= E(c = b._remoteStreams).call(c, a)) || (b._remoteStreams.push(a),
    ...
    function $g(c) {
        ...
        if (a.mediaDevices && a.mediaDevices.getUserMedia) {
            var b;
            c = a.mediaDevices;
            let d = za(b = c.getUserMedia).call(b, c);
            a.mediaDevices.getUserMedia = a=>d(ah(a))
        }
        var d;
        !a.getUserMedia && a.mediaDevices && a.mediaDevices.getUserMedia && (a.getUserMedia = za(d = function(b, c, d) {
            a.mediaDevices.getUserMedia(b).then(c, d)
        }
        ).call(d, a))
    }
    function ah(c) {
        return c && void 0 !== c.video ? Wa({}, c, {
            video: yg(c.video)
        }) : c
    }
    function bh(c) {
        ...
        c.RTCPeerConnection = function(b, c) {
            if (b && b.iceServers) {
                ...
                for (let c = 0; c < b.iceServers.length; c++) {
                    ...
                    !d.hasOwnProperty("urls") && d.hasOwnProperty("url") ? (Ad("RTCIceServer.url", "RTCIceServer.urls"),
                    d = JSON.parse(w(d)),
                    d.urls = d.url,
                    delete d.url,
                    a.push(d)) : a.push(b.iceServers[c])
                }
                b.iceServers = a
            }
            return new a(b,c)
        ...
        "generateCertificate"in c.RTCPeerConnection && ba(c.RTCPeerConnection, "generateCertificate", {
            get: ()=>a.generateCertificate
        })
    }
    function ch(c) {
        "object" == typeof c && c.RTCPeerConnection && "receiver"in c.RTCTrackEvent.prototype && !c.RTCTransceiver && ba(c.RTCTrackEvent.prototype, "transceiver", {
            get() {
                return {
                    receiver: this.receiver
                }
    ...
    function dh(c) {
        ...
        c.RTCPeerConnection.prototype.createOffer = function(b) {
            if (b) {
                ...
                let a = R(c = this.getTransceivers()).call(c, a=>"audio" === a.receiver.track.kind);
                !1 === b.offerToReceiveAudio && a ? "sendrecv" === a.direction ? a.setDirection ? a.setDirection("sendonly") : a.direction = "sendonly" : "recvonly" === a.direction && (a.setDirection ? a.setDirection("inactive") : a.direction = "inactive") : !0 !== b.offerToReceiveAudio || a || this.addTransceiver("audio");
                void 0 !== b.offerToReceiveVideo && (b.offerToReceiveVideo = !!b.offerToReceiveVideo);
                c = R(e = this.getTransceivers()).call(e, a=>"video" === a.receiver.track.kind);
                !1 === b.offerToReceiveVideo && c ? "sendrecv" === c.direction ? c.setDirection ? c.setDirection("sendonly") : c.direction = "sendonly" : "recvonly" === c.direction && (c.setDirection ? c.setDirection("inactive") : c.direction = "inactive") : !0 !== b.offerToReceiveVideo || c || this.addTransceiver("video")
            }
            return a.apply(this, arguments)
        }
    }
    function Dd(c) {
        if (c.RTCIceCandidate && !(c.RTCIceCandidate && "foundation"in c.RTCIceCandidate.prototype)) {
            ...
            c.RTCIceCandidate = function(b) {
                var c;
                if ("object" == typeof b && b.candidate && 0 === E(c = b.candidate).call(c, "a=") && ((b = JSON.parse(w(b))).candidate = b.candidate.substr(2)),
            ...
            rc(c, "icecandidate", a=>(a.candidate && ba(a, "candidate", {
    ...
    function Sc(c) {
        if (c.RTCPeerConnection) {
            var a = Ib(c);
            "sctp"in c.RTCPeerConnection.prototype || ba(c.RTCPeerConnection.prototype, "sctp", {
                get() {
            ...
            var b = function(a) {
                ...
                Cg(a).call(a, a=>{
                    var b;
                    return (a = F.parseMLine(a)) && "application" === a.kind && -1 !== E(b = a.protocol).call(b, "SCTP")
                }
                )
            }
              , d = function(a) {
              ...
              , e = function(b) {
                let c = 65536;
                return "firefox" === a.browser && (c = 57 > a.version ? -1 === b ? 16384 : 2147483637 : 60 > a.version ? 57 === a.version ? 65535 : 65536 : 2147483637),
                c
            }
              , f = function(b, c) {
                let d = 65536;
                ...
                return 0 < b.length ? d = S(b[0].substr(19), 10) : "firefox" === a.browser && -1 !== c && (d = 2147483637),
                d
            }
              , g = c.RTCPeerConnection.prototype.setRemoteDescription;
            c.RTCPeerConnection.prototype.setRemoteDescription = function() {
                if (this._sctp = null,
                "chrome" === a.browser && 76 <= a.version) {
                    var {sdpSemantics: c} = this.getConfiguration();
                    "plan-b" === c && ba(this, "sctp", {
                        get() {
                            return void 0 === this._sctp ? null : this._sctp
                        },
                        enumerable: !0,
                ...
                if (b(arguments[0])) {
                    ...
                    q = f(arguments[0], q);
                    let a;
                    a = 0 === c && 0 === q ? Number.POSITIVE_INFINITY : 0 === c || 0 === q ? Math.max(c, q) : Math.min(c, q);
                    c = {};
                    ba(c, "maxMessageSize", {
                        get: ()=>a
                    });
    ...
    function Tc(c) {
        function a(a, b) {
            ...
            a.send = function() {
                ...
                if ("open" === a.readyState && b.sctp && d > b.sctp.maxMessageSize)
                    throw new TypeError("Message too large (can send a maximum of " + b.sctp.maxMessageSize + " bytes)");
        ...
        if (c.RTCPeerConnection && "createDataChannel"in c.RTCPeerConnection.prototype) {
            ...
            ;
            rc(c, "datachannel", b=>(a(b.channel, b.target),
            b))
        }
    }
    function De(c) {
        ...
        if (c.RTCPeerConnection) {
            ...
            if (!("chrome" === a.browser && 71 <= a.version)) {
                ...
                c.RTCPeerConnection.prototype.setRemoteDescription = function(a) {
                    var c, d;
                    a && a.sdp && -1 !== E(c = a.sdp).call(c, "\na=extmap-allow-mixed") && (a.sdp = N(d = a.sdp.split("\n")).call(d, a=>"a=extmap-allow-mixed" !== tc(a).call(a)).join("\n"));
    ...
    function Ed(c) {
        return "string" == typeof c ? Wa({}, ql[c]) : c
    }
    function vc(c, a) {
        var b;
    ...
    function Fd(c, a) {
        if (null != c)
            ...
            eh(c))
                ...
                for (b in c)
                    Object.prototype.hasOwnProperty.call(c, b) && a.call(null, c[b], b, c)
    }
    function hh() {
        function c(b, c) {
            "object" == typeof a[c] && "object" == typeof b ? a[c] = hh(a[c], b) : a[c] = b
        }
    ...
    function Ge() {
        function c(b, c) {
            "object" == typeof a[c] && "object" == typeof b ? a[c] = Ge(a[c], b) : a[c] = "object" == typeof b ? Ge({}, b) : b
        }
        for (var a = {}, b = 0, d = arguments.length; b < d; b++)
            Fd(arguments[b], c);
        return a
    ...
    function mh(c) {
        ...
        return I.extend(a, Id.prototype, c),
        I.extend(a, c),
        a
    }
    function oh() {
    ...
    function Xa(c, a, b) {
        var d;
        if (!La(b).call(b, c))
            throw new m(l.INVALID_PARAMS,n(d = "".concat(a, " can only be set as ")).call(d, w(b)));
    }
    function W(c, a, b=1, d=1E4, e=!0) {
        if (c < b || c > d || e && ("number" != typeof c || 0 != c % 1)) {
            var f, g;
            throw new m(l.INVALID_PARAMS,n(f = n(g = "invalid ".concat(a, ": the value range is [")).call(g, b, ", ")).call(f, d, "]. integer only"));
        }
    }
    function Ga(c, a, b=1, d=255, e=!0) {
        if (null == c)
            throw new m(l.INVALID_PARAMS,"".concat(a || "param", " cannot be empty"));
        var f, g, h;
        if (!qh(c, b, d, e))
            throw new m(l.INVALID_PARAMS,n(f = n(g = n(h = "Invalid ".concat(a || "string param", ": Length of the string: [")).call(h, b, ",")).call(g, d, "].")).call(f, e ? " ASCII characters only." : ""));
    }
    function rh(c, a) {
        if (!cc(c))
    ...
    function Ie(c) {
        if ("string" != typeof c || !/^[a-zA-Z0-9 !#\$%&\(\)\+\-:;<=\.>\?@\[\]\^_\{\}\|~,]{1,64}$/.test(c))
            throw k.error("Invalid Channel Name ".concat(c)),
            new m(l.INVALID_PARAMS,"The length must be within 64 bytes. The supported characters: a-z,A-Z,0-9,space,!, #, $, %, &, (, ), +, -, :, ;, <, =, ., >, ?, @, [, ], ^, _,  {, }, |, ~, ,");
    }
    function Je(c) {
        var a;
        if (!("number" == typeof c && 0 <= c && 4294967295 >= c || qh(c, 1, 255)))
            throw k.error(n(a = "Invalid UID ".concat(c, " ")).call(a, typeof c)),
            new m(l.INVALID_PARAMS,"[String uid] Length of the string: [1,255]. ASCII characters only. [Number uid] The value range is [0,10000]");
    }
    function qh(c, a=1, b=255, d=!0) {
        if (a = "string" == typeof c && c.length <= b && c.length >= a) {
            if (!(d = !d))
                a: if ("string" != typeof c)
                    d = !1;
                else {
    ...
    function sh(c) {
        return "undefined" != typeof Float32Array ? function() {
            ...
            function a(a, b, c, g) {
                ...
                0 === b)
                    ...
                    a((d << 31 | e + 127 << 23 | 8388607 & Math.round(b * Math.pow(2, -e) * 8388608)) >>> 0, c, g)
                }
            }
            function b(a, b, c) {
                c = a(b, c);
        ...
        "undefined" != typeof Float64Array ? function() {
            ...
            function a(a, b, c, g, h, q) {
                ...
                0 === g)
                    a(0, h, q + b),
                    a(0 < 1 / g ? 0 : 2147483648, h, q + c);
                else if (isNaN(g))
                    a(0, h, q + b),
                    a(2146959360, h, q + c);
                else if (1.7976931348623157E308 < g)
                    a(0, h, q + b),
                    a((d << 31 | 2146435072) >>> 0, h, q + c);
                    ...
                    a((d << 31 | e + 1023 << 20 | 1048576 * g & 1048575) >>> 0, h, q + c)
                }
            }
            function b(a, b, c, g, h) {
                ...
                return 2047 === c ? b ? NaN : 1 / 0 * a : 0 === c ? 4.9E-324 * a * b : a * Math.pow(2, c - 1075) * (b + 4503599627370496)
            }
    ...
    function sl(c, a, b) {
        40 > c.length ? O.utf8.write(c, a, b) : a.utf8Write ? a.utf8Write(c, b) : a.write(c, b)
    }
    function lb(c, a) {
    ...
    function Qe() {
        ...
        if (!(4 < this.len - this.pos)) {
            for (; 3 > a; ++a) {
                if (this.pos >= this.len)
                    throw lb(this);
                if (c.lo = (c.lo | (127 & this.buf[this.pos]) << 7 * a) >>> 0,
                128 > this.buf[this.pos++])
                    return c
            }
            return c.lo = (c.lo | (127 & this.buf[this.pos++]) << 7 * a) >>> 0,
            c
        }
        for (; 4 > a; ++a)
            if (c.lo = (c.lo | (127 & this.buf[this.pos]) << 7 * a) >>> 0,
            128 > this.buf[this.pos++])
                return c;
        if (c.lo = (c.lo | (127 & this.buf[this.pos]) << 28) >>> 0,
        ...
        4 < this.len - this.pos)
            for (; 5 > a; ++a) {
                if (c.hi = (c.hi | (127 & this.buf[this.pos]) << 7 * a + 3) >>> 0,
                128 > this.buf[this.pos++])
                    return c
            }
        else
    ...
    function tl(c) {
        return Ga(c.reportId, "params.reportId", 0, 100, !1),
    ...
    function zh(c) {
        return W(c.timeout, "config.timeout", 0, 1E5),
    ...
    function Ah(c) {
        return Ga(c.turnServerURL, "turnServerURL"),
    ...
    function ul(c) {
        ...
        null == c.audioSampleRate || Xa(c.audioSampleRate, "config.audioSampleRate", [32E3, 44100, 48E3]),
        null == c.audioBitrate || W(c.audioBitrate, "config.audioBitrate", 1, 128),
        null == c.audioChannels || Xa(c.audioChannels, "config.audioChannels", [1, 2, 3, 4, 5]),
        null == c.videoGop || W(c.videoGop, "config.videoGop"),
        null == c.videoCodecProfile || Xa(c.videoCodecProfile, "config.videoCodecProfile", [66, 77, 100]),
        ...
        null == c.userConfigExtraInfo || Ga(c.userConfigExtraInfo, "config.userConfigExtraInfo", 0, 4096, !1),
        c.transcodingUsers && null != c.transcodingUsers) && (rh(c.transcodingUsers, "config.transcodingUsers"),
        ...
        c.images && null != c.images) && (rh(c.images, "config.images"),
    ...
    function Bh(c) {
        ...
        return c.token && Ga(c.token, "info.token", 1, 2047),
        Je(c.uid),
        Ie(c.channelName),
        !0
    }
    function Ch(c) {
        return Xa(c, "mediaSource", ["screen", "window", "application"]),
        !0
    }
    function va(c) {
        var a, b, d, e;
        ...
        "Safari" === f[1] && (g = c.match(/version\/(\d+)/i),
        null !== g && (f[2] = g[1]));
        -1 !== E(a = c.toLowerCase()).call(a, "qqbrowser") && (a = c.match(/(qqbrowser(?=\/))\/?(\d+)/i),
        null !== a && (f = a));
        -1 !== E(b = c.toLowerCase()).call(b, "micromessenger") && (b = c.match(/(micromessenger(?=\/))\/?(\d+)/i),
        null !== b && (f = b));
        -1 !== E(d = c.toLowerCase()).call(d, "edge") && (d = c.match(/(edge(?=\/))\/?(\d+)/i),
        null !== d && (f = d));
        -1 !== E(e = c.toLowerCase()).call(e, "trident") && (e = /\brv[ :]+(\d+)/g.exec(c) || [],
        null !== e && (f = ["", "IE", e[1]]));
        e = null;
        d = [{
            s: aa.WIN_10,
    ...
    function Te() {
        let c = va();
        return c.name === da.EDGE || c.name === da.SAFARI ? !1 : !!navigator.userAgent.toLocaleLowerCase().match(/chrome\/[\d]./i)
    }
    function Eh(c, a) {
        var b = V(c);
        if (ia) {
            var d = ia(c);
            a && (d = N(d).call(d, function(a) {
    ...
    function Ub(c) {
        for (var a = 1; a < arguments.length; a++) {
            var b, d = null != arguments[a] ? arguments[a] : {};
            if (a % 2)
    ...
    function vl(c) {
        ...
        return c.address.match(/^[\.:\d]+$/) ? "".concat(c.address.replace(/[^\d]/g, "-"), ".edge.agora.io") : (k.info("Cannot recognized as IP address ".concat(c.address, ". Used As Host instead")),
    ...
    function wl(c, a) {
        ...
        return {
            gatewayAddrs: D(b = c.addresses).call(b, a=>{
                var b, c, f;
                return a.ip.match(/^[\.:\d]+$/) ? n(b = n(c = "".concat(a.ip.replace(/[^\d]/g, "-"), ".edge")).call(c, d[e++ % d.length], ":")).call(b, a.port) : (k.info("Cannot recognized as IP address ".concat(a.ip, ". Used As Host instead")),
    ...
    function xl(c, a) {
        ...
        return {
            addressList: D(b = c.servers).call(b, (b,c)=>{
                var d, e, h;
                return n(d = n(e = n(h = "wss://".concat(b.address.replace(/\./g, "-"), ".edge.")).call(h, 0 == c % 2 ? "agora.io" : "agoraio.cn", ":")).call(e, b.wss, "?serviceName=")).call(d, encodeURIComponent(a))
            }
            ),
    ...
    function yl(c) {
        ...
        if (!c)
            return {};
        let b = {
            resolution: c.width && c.height ? n(a = "".concat(zb(c.width), "x")).call(a, zb(c.height)) : void 0,
            maxVideoBW: c.bitrateMax,
            minVideoBW: c.bitrateMin
        };
        return "number" == typeof c.frameRate ? (b.maxFrameRate = c.frameRate,
        b.minFrameRate = c.frameRate) : c.frameRate && (b.maxFrameRate = c.frameRate.max || c.frameRate.ideal || c.frameRate.exact || c.frameRate.min,
        b.minFrameRate = c.frameRate.min || c.frameRate.ideal || c.frameRate.exact || c.frameRate.max),
        b
    }
    function zl(c) {
        let a = {
        ...
        return c.bitrate.retransmit && (a.A_rb = c.bitrate.retransmit.toString()),
    ...
    function Fh(c, a) {
        ...
        return b.inputFrame && (a && b.inputFrame.height === a.height || (c.A_fhi = b.inputFrame.height ? b.inputFrame.height.toString() : "0"),
        a && b.inputFrame.width === a.width || (c.A_fwi = b.inputFrame.width ? b.inputFrame.width.toString() : "0"),
        a && b.inputFrame.frameRate === a.frameRate || (c.A_fri = b.inputFrame.frameRate ? b.inputFrame.frameRate.toString() : "0")),
        c
    }
    function Al(c, a) {
        let b = c.videoSend[0];
        ...
        switch (c.A_vstd = a._originMediaStreamTrack.enabled && a._mediaStreamTrack.enabled ? "0" : "1",
        b.sentFrame && (c.A_fhs = b.sentFrame.height.toString(),
        ...
        return c.A_nr = b.nacksCount.toString(),
    ...
    function Bl(c, a) {
        ...
        return c.A_astd = a._originMediaStreamTrack.enabled && a._mediaStreamTrack.enabled ? "0" : "1",
        b.inputLevel ? c.A_ail = Math.round(100 * b.inputLevel).toString() : c.A_ail = Math.round(100 * a._source.getAudioAvgLevel()).toString(),
    ...
    function Cl(c, a) {
        ...
        a._player && 0 < a._player.freezeTimeCounterList.length) && (c.A_vrft = Ma(d = a._player.freezeTimeCounterList).call(d, 0, 1)[0].toString());
        return c
    }
    function Dl(c, a) {
        let b = c.audioRecv[0];
        ...
        return c.bytesReceived = b.bytes.toString(),
        c.packetsLost = b.packetsLost.toString(),
        c.packetsReceived = b.packets.toString(),
        b.outputLevel ? c.A_aol = Math.round(100 * b.outputLevel).toString() : c.A_aol = Math.round(100 * a._source.getAudioAvgLevel()).toString(),
        c.A_apol = Math.round(100 * a._source.getAudioAvgLevel()).toString(),
        a && (c.A_artd = a._originMediaStreamTrack.enabled && a._mediaStreamTrack.enabled ? "0" : "1"),
    ...
    function Fl(c, a, b, d) {
        ...
        return c.framesRateFirefox && (a.frameRateDecoded = c.framesRateFirefox.toString(),
    ...
    function Gh(c) {
        return 0 <= c && .17 > c ? 1 : .17 <= c && .36 > c ? 2 : .36 <= c && .59 > c ? 3 : .59 <= c && 1 >= c ? 4 : 1 < c ? 5 : 0
    }
    function Hh(c, a) {
        var b = V(c);
        if (ia) {
    ...
    function Hl(c, a, b) {
        ...
        for (let q = 0; q < d.length; q++)
            ...
            h <= b - e || (g[g.length] = Ue({}, c, {
                [a]: d.substring(f, q)
            }),
            f = q,
            h = 127 >= d.charCodeAt(q) ? 1 : 3);
        return f !== d.length - 1 && (g[g.length] = Ue({}, c, {
            [a]: d.substring(f)
        })),
        g
    }
    ...
    function na(c=7, a) {
        ...
        return e.length === c ? n(b = "".concat(a)).call(b, e) : n(d = "".concat(a)).call(d, e) + na(c - e.length, "")
    }
    function Zc(c) {
        return new u((a,b)=>{
            ...
            d.addEventListener("playing", ()=>{
                !d.videoWidth && va().name === da.FIREFOX || (a([d.videoWidth, d.videoHeight]),
    ...
    function $c(c) {
        return u.all(D(c).call(c, a=>a.then(a=>{
            throw a;
        }
        , a=>a))).then(a=>{
            throw a;
    ...
    function Ha(c, a, ...b) {
        return 0 === c.getListeners(a).length ? u.reject(new m(l.UNEXPECTED_ERROR,"can not emit promise")) : new u((d,e)=>{
            c.emit(a, ...b, d, e)
        }
        )
    }
    ...
    function ad(c, a, ...b) {
        ...
        null !== e)
            throw e;
        if (null === d)
            throw new m(l.UNEXPECTED_ERROR,"handler is not sync");
        return d
    }
    function bd(c, a) {
        a = E(c).call(c, a);
    ...
    function Kl(c, a) {
        ...
        for (let b = 0; b < c.length; b += 1) {
            let d = c[b];
            if (N(c).call(c, a=>a === d).length !== N(a).call(a, a=>a === d).length)
                return !1
        }
        return !0
    }
    ...
    function Ll(c, a) {
        var b, d, e, f, g;
        if ("motion" === c)
            return k.debug(n(f = n(g = "adjust bitrate for motion, (".concat(a.bitrateMax, ", ")).call(g, a.bitrateMin, "}) -> (")).call(f, a.bitrateMax, ", undefined)")),
            {
                max: a.bitrateMax
            };
        if (!a.width || !a.height)
        ...
        f = Math.max(.25, .1 + .03 * zb(a.frameRate || 20));
        if (19200 > c)
            return {};
        if (76800 > c)
            g = dd[0];
        ...
        c = [Math.round((g[0][0] + g[0][1] * c) * f), Math.round((g[1][0] + g[1][1] * c) * f), Math.round((g[2][0] + g[2][1] * c) * f)];
        c = {
            min: Math.max(c[2], a.bitrateMin || 0),
            max: Math.max(c[2], a.bitrateMax || c[0])
        };
        return k.debug(n(b = n(d = n(e = "adjust bitrate for detail, (".concat(a.bitrateMax, ", ")).call(e, a.bitrateMin, "}) -> (")).call(d, c.max, ", ")).call(b, c.min, ")")),
        c
    }
    function yc() {
        if (!ed)
    ...
    function fd(c) {
        if (!Ml()) {
            ...
            c.connect = (b,e,f)=>{
                var d;
                return c._inputNodes || (c._inputNodes = []),
                La(d = c._inputNodes).call(d, b) || (b instanceof AudioNode ? (c._inputNodes.push(b),
                a.call(c, b, e, f)) : a.call(c, b, e)),
                c
            }
            ;
            c.disconnect = (d,e,f)=>{
    ...
    function Pl(c) {
        function a(a) {
            "running" === c.state ? (b(!1),
            t && c.suspend().then(d, d)) : "closed" !== c.state && (t ? b(!1) : (b(!0),
            a && c.resume().then(d, d)))
        }
        function b(a) {
            if (w !== a) {
            ...
            if (!z)
                if (u.paused)
                    if (t)
                        ...
                        a = void 0;
                        try {
                            (a = u.play()) ? a.then(h, h) : (u.addEventListener("playing", h),
        ...
        function g(a) {
            if (A !== a) {
                ...
                for (let b = 0, c = v; b < c.length; b++) {
                    let d = c[b];
                    a ? window.addEventListener(d, q, {
                        capture: !0,
                        passive: !0
                    }) : window.removeEventListener(d, q, {
                        capture: !0,
                        passive: !0
                    })
                }
        ...
        function T() {
            l && document[l.hidden] === m && (p = !document[l.hidden],
            y())
        }
        function k(a) {
        ...
        let l;
        void 0 !== document.hidden ? l = {
            hidden: "hidden",
            visibilitychange: "visibilitychange"
        } : void 0 !== document.webkitHidden ? l = {
            hidden: "webkitHidden",
            visibilitychange: "webkitvisibilitychange"
        } : void 0 !== document.mozHidden ? l = {
            hidden: "mozHidden",
            visibilitychange: "mozvisibilitychange"
        } : void 0 !== document.msHidden && (l = {
            hidden: "msHidden",
            visibilitychange: "msvisibilitychange"
        });
        var n = navigator.userAgent.toLowerCase();
        n = 0 <= E(n).call(n, "iphone") && 0 > E(n).call(n, "like iphone") || 0 <= E(n).call(n, "ipad") && 0 > E(n).call(n, "like ipad") || 0 <= E(n).call(n, "ipod") && 0 > E(n).call(n, "like ipod");
        let m = !0, p = !0, r = !0, t = !1, v = "click contextmenu auxclick dblclick mousedown mouseup touchend keydown keyup".split(" "), u, w = !1, A = !1, z = !1;
        if (n) {
            ...
            u.preload = "auto";
            u.src = "data:audio/mpeg;base64,//uQx" + x(23, "A") + "WGluZwAAAA8AAAACAAACcQCA" + x(16, "gICA") + x(66, "/") + "8AAABhTEFNRTMuMTAwA8MAAAAAAAAAABQgJAUHQQAB9AAAAnGMHkkI" + x(320, "A") + "//sQxAADgnABGiAAQBCqgCRMAAgEAH" + x(15, "/") + "7+n/9FTuQsQH//////2NG0jWUGlio5gLQTOtIoeR2WX////X4s9Atb/JRVCbBUpeRUq" + x(18, "/") + "9RUi0f2jn/+xDECgPCjAEQAABN4AAANIAAAAQVTEFNRTMuMTAw" + x(97, "V") + "Q==";
            u.loop = !0;
            u.load();
            f(!0)
        }
        ...
        n && (window.addEventListener("focus", k, !0),
        window.addEventListener("blur", k, !0));
        T();
        k()
    }
    async function Lh(c, a) {
        let b = (a,b)=>a ? "number" != typeof a ? a.max || a.exact || a.ideal || a.min || b : a : b;
        c = {
            audio: !1,
            video: {
                mandatory: {
        ...
        return a.frameRate && "number" != typeof a.frameRate ? (c.video.mandatory.maxFrameRate = a.frameRate.max,
        c.video.mandatory.minFrameRate = a.frameRate.min) : "number" == typeof a.frameRate && (c.video.mandatory.maxFrameRate = a.frameRate),
        await navigator.mediaDevices.getUserMedia(c)
    }
    async function Ql(c) {
        var a = await Mh(c.mediaSource);
        a = await Rl(a);
        return await Lh(a, c)
    }
    async function Mh(c) {
        ...
        let b = Nh();
        if (!b)
            throw new m(l.ELECTRON_IS_NULL);
        c = null;
        try {
            c = b.desktopCapturer.getSources({
                types: a
            })
        } catch (d) {
            c = null
        }
        c && c.then || (c = new u((c,e)=>{
    ...
    function Rl(c) {
        return new u((a,b)=>{
            ...
            e.setAttribute("style", "width: 100%; height: 500px; padding: 15px 25px ; box-sizing: border-box;");
            let f = document.createElement("div");
            f.innerText = "Agora Web Screensharing wants to share the contents of your screen with webdemo.agorabeckon.com. Choose what you'd like to share.";
            ...
            D(c).call(c, b=>{
                if (b.id) {
                    ...
                    c.innerHTML = '<div style="height: 120px; display: table-cell; vertical-align: middle;"><img style="width: 100%; background: #333333; box-shadow: 1px 1px 1px 1px rgba(0, 0, 0, 0.2);" src=' + b.thumbnail.toDataURL() + ' /></div><span style="\theight: 40px; line-height: 40px; display: inline-block; width: 70%; word-break: keep-all; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">' + b.name + "</span>";
                    c.onclick = ()=>{
                        document.body.removeChild(y);
                        a(b.id)
                    }
    ...
    function Nh() {
        if (Md)
            return Md;
        try {
            return Md = window.require("electron"),
            Md
        } catch (c) {
            return null
        }
    ...
    async function Bb(c, a) {
        ...
        for (; 2 > b; )
            try {
                ...
                var e, f;
                if (g instanceof m)
                    throw k.error(n(f = "[".concat(a, "] ")).call(f, g.toString())),
                    g;
                ...
                if (c.code === l.MEDIA_OPTION_INVALID)
                    ...
                    throw k.error(n(e = "[".concat(a, "] ")).call(e, c.toString())),
                    c;
            }
        if (!d)
    ...
    async function Sl(c, a, b) {
        ...
        b && (c.video && (delete c.video.width,
        delete c.video.height),
        c.screen && (delete c.screen.width,
        delete c.screen.height));
        var d = ea;
        b = new MediaStream;
        if (c.audioSource && b.addTrack(c.audioSource),
        ...
        if (c.screen)
            if (Nh())
                c.screen.sourceId ? zc(b, await Lh(c.screen.sourceId, c.screen)) : zc(b, await Ql(c.screen));
                ...
                k.debug("[".concat(a, '] Screen access on chrome stable, looking for extension"'));
                var e = await Tl(c.screen.extensionId, a);
                c.screen.mandatory.chromeMediaSourceId = e;
                zc(b, await navigator.mediaDevices.getUserMedia({
                    video: {
                        mandatory: c.screen.mandatory
                    }
                }))
                ...
                k.debug("[".concat(a, "] getDisplayMedia:"), w({
                    video: e,
                    audio: !!c.screenAudio
                })),
                zc(b, await navigator.mediaDevices.getDisplayMedia({
                    video: e,
                    audio: !!c.screenAudio
                }));
            else {
                if (va().name !== da.FIREFOX)
                    throw k.error("[".concat(a, "] This browser does not support screenSharing")),
        ...
        let f;
        e = null;
        a.name !== da.SAFARI && a.os !== aa.IOS || (e = await Xe.lock());
        try {
    ...
    function Nd(c, a) {
        ...
        default:
            var h;
            return k.error("getUserMedia unexpected error", c),
    ...
    function zc(c, a) {
        ...
        (a = a.getAudioTracks()[0]) && (d && c.removeTrack(d),
        c.addTrack(a));
        e && (b && c.removeTrack(b),
        c.addTrack(e))
    }
        ...
        return new u((b,d)=>{
            try {
                chrome.runtime.sendMessage(c, {
                    ...
                    if (!c || !c.streamId)
                        return k.error("[".concat(a, "] No response from Chrome Plugin. Plugin not installed properly"), c),
                        void d(new m(l.CHROME_PLUGIN_NO_RESPONSE,"No response from Chrome Plugin. Plugin not installed properly"));
                    b(c.streamId)
                }
                )
            } catch (f) {
                var e;
                k.error(n(e = "[".concat(a, "] AgoraRTC screensharing plugin is not accessible(")).call(e, c, ")"), f.toString());
    ...
    function Ul(c) {
        for (var a = 1; a < arguments.length; a++) {
            var b, d = null != arguments[a] ? arguments[a] : {};
            if (a % 2)
                r(b = Qh(Object(d), !0)).call(b, function(a) {
                    Pa(c, a, d[a])
                });
            else if (ja)
                Qa(c, ja(d));
                ...
                var e;
                r(e = Qh(Object(d))).call(e, function(a) {
                    ba(c, a, ca(d, a))
                })
            }
        }
    ...
    function Vb(c, a, b) {
        return new u((d,e)=>{
            ...
            a.data && !b ? (a.data = w(a.data),
            Rh += Ld(a.data)) : b && (Rh += a.data.size);
            a.headers = a.headers || {};
            a.headers["Content-Type"] = a.headers["Content-Type"] || "application/json";
            a.method = "POST";
            a.url = c;
            Cb.request(a).then(a=>{
                "string" == typeof a.data ? Ye += Ld(a.data) : a.data instanceof ArrayBuffer || a.data instanceof Uint8Array ? Ye += a.data.byteLength : Ye += Ld(w(a.data));
                d(a.data)
            }
            ).catch(a=>{
                Cb.isCancel(a) ? e(new m(l.OPERATION_ABORTED,"cancel token canceled")) : "ECONNABORTED" === a.code ? e(new m(l.NETWORK_TIMEOUT,a.message)) : a.response ? e(new m(l.NETWORK_RESPONSE_ERROR,a.response.status)) : e(new m(l.NETWORK_ERROR,a.message))
            }
            )
        }
        )
    ...
    function xa(c) {
        for (var a = 1; a < arguments.length; a++) {
            var b, d = null != arguments[a] ? arguments[a] : {};
            if (a % 2)
                r(b = Sh(Object(d), !0)).call(b, function(a) {
                    Pa(c, a, d[a])
                });
            else if (ja)
                Qa(c, ja(d));
                ...
                var e;
                r(e = Sh(Object(d))).call(e, function(a) {
                    ba(c, a, ca(d, a))
                })
            }
        }
    ...
    function fc(c, a, b, d) {
        ...
        d = new u(async(d,f)=>{
            ...
            for (let q = 0; q < e.maxRetryCount; q += 1) {
                if (h)
                    return f(new m(l.OPERATION_ABORTED));
                try {
                    const b = await c();
                    if (!a(b, q) || q + 1 === e.maxRetryCount)
                        return d(b);
                    await g()
                } catch (ra) {
                    if (!b(ra, q) || q + 1 === e.maxRetryCount)
                        return f(ra);
                    await g()
                }
            }
    ...
    function Zl(c) {
        for (var a = 1; a < arguments.length; a++) {
            var b, d = null != arguments[a] ? arguments[a] : {};
            if (a % 2)
                r(b = Wh(Object(d), !0)).call(b, function(a) {
                    Pa(c, a, d[a])
                });
            else if (ja)
                Qa(c, ja(d));
                ...
                var e;
                r(e = Wh(Object(d))).call(e, function(a) {
                    ba(c, a, ca(d, a))
                })
            }
        }
    ...
    async function $l(c, a, b, d, e) {
        let f = v()
          ...
          , h = c[0];
        b = await fc(()=>Vb(h + "".concat(-1 === E(h).call(h, "?") ? "?" : "&", "action=stringuid"), {
            data: g,
            cancelToken: d,
            headers: {
            ...
            if (0 === b.code) {
                ...
                if (0 >= b.uid || b.uid >= Math.pow(2, 32))
                    throw k.error(n(e = "Invalid Uint Uid ".concat(a, " => ")).call(e, b.uid), b),
            ...
            e = Ze(b.code);
            return e.retry && (h = c[(d + 1) % c.length]),
            t.reqUserAccount(g.sid, {
                lts: f,
                success: !1,
                serverAddr: h,
        ...
        , (a,b)=>a.code !== l.OPERATION_ABORTED && (t.reqUserAccount(g.sid, {
            lts: f,
            success: !1,
            serverAddr: h,
            stringUid: g.string_uid,
        ...
        if (0 !== b.code)
            throw b = Ze(b.code),
            new m(l.UNEXPECTED_RESPONSE,b.desc);
        return b
    }
    function am(c, a, b, d) {
        let e = v()
        ...
        return fc(async()=>({
            ...
            if (!b.res.json_body)
                throw k.debug("[".concat(a.clientId, "] Get proxy server failed: no json_body")),
                new m(l.UNEXPECTED_RESPONSE,w(b.res));
            let c = JSON.parse(b.res.json_body);
            var d, e;
            if (200 !== c.code)
                throw k.debug(n(d = n(e = "[".concat(a.clientId, "] Get proxy server failed: response code [")).call(e, c.code, "], reason [")).call(d, c.reason, "]")),
                new m(l.UNEXPECTED_RESPONSE,w(b.res));
            return k.debug("[".concat(a.clientId, "] App return server length"), c.servers.length),
            !1
        }
        , a=>a.code !== l.OPERATION_ABORTED && (t.requestProxyAppCenter(f.sid, {
            lts: e,
            succ: !1,
            APAddr: c,
    ...
    function bm(c, a, b, d) {
        ...
        return fc(async()=>({
            ...
            if (!a.res.serverResponse)
                throw new m(l.UNEXPECTED_RESPONSE,"requeet worker manager server failed: serverResponse is undefined");
            return !1
        }
        , a=>a.code !== l.OPERATION_ABORTED && (t.requestProxyWorkerManager(g.sid, {
            lts: e,
            succ: !1,
            workerManagerAddr: c,
            ec: a.code,
    ...
    function cm(c, a, b, d, e) {
        ...
        return fc(async()=>{
            ...
            if (200 !== b.code)
                throw b = new m(l.UNEXPECTED_RESPONSE,n(c = "live streaming app center error, code: ".concat(b.code, ", reason: ")).call(c, b.reason),{
                    code: b.code,
                    responseTime: q
                }),
                k.error(b.toString()),
            ...
            if (!b.servers || 0 === b.servers.length)
                throw c = new m(l.UNEXPECTED_RESPONSE,"live streaming app center empty server",{
                    code: b.code,
                    responseTime: q
                }),
                k.error(c.toString()),
                c;
            c = xl(b, a);
            return C.LIVE_STREAMING_ADDRESS && (c.addressList = C.LIVE_STREAMING_ADDRESS instanceof Array ? C.LIVE_STREAMING_ADDRESS : [C.LIVE_STREAMING_ADDRESS]),
            Zl({}, c, {
                responseTime: q
            })
        }
        , (d,e)=>(t.apworkerEvent(b.sid, {
            success: !0,
            sc: 200,
            serviceName: a,
        ...
        !!(d.code !== l.OPERATION_ABORTED && d.code !== l.UNEXPECTED_RESPONSE || d.data && d.data.retry) && (y = c[(e + 1) % c.length],
        !0)), e)
    }
    function dm(c, a, b, d) {
        a = {
        ...
        return fc(async()=>{
            ...
            if (200 !== a.code) {
                var h = new m(l.UNEXPECTED_RESPONSE,n(d = "cross channel app center error, code: ".concat(a.code, ", reason: ")).call(d, a.reason));
                throw k.error(h.toString()),
                h;
            }
            if (!a.servers || 0 === a.servers.length)
                throw d = new m(l.UNEXPECTED_RESPONSE,"cross channel app center empty server"),
                k.error(d.toString()),
                d;
            return {
                vid: a.vid,
                ...
                addressList: D(h = a.servers).call(h, a=>{
                    var b;
                    return n(b = "wss://".concat(a.address.replace(/\./g, "-"), ".edge.agora.io:")).call(b, a.wss)
                }
                )
            }
        }
    ...
    function Xh(c, a, b, d) {
        ...
        a.multiIP && a.multiIP.gateway_ip && (f.detail[5] = w({
            vocs_ip: [a.multiIP.uni_lbs_ip],
            vos_ip: [a.multiIP.gateway_ip]
        }));
        return fc(async()=>{
            let a = await Vb(c + "".concat(-1 === E(c).call(c, "?") ? "?" : "&", "action=wrtc_gateway"), {
                data: f,
                cancelToken: b,
                headers: {
                    "X-Packet-Service-Type": 0,
        ...
        , b=>{
            if (0 === b.res.code)
                return t.joinChooseServer(a.sid, {
                    lts: e,
                    succ: !0,
                    csAddr: c,
                ...
                !1;
            b = Ze(b.res.code);
            throw new m(l.CAN_NOT_GET_GATEWAY_SERVER,b.desc,{
                retry: b.retry
            });
        }
        , b=>{
            return b.code !== l.OPERATION_ABORTED && (b.code === l.CAN_NOT_GET_GATEWAY_SERVER ? (t.joinChooseServer(a.sid, {
                lts: e,
                succ: !1,
                csAddr: c,
                serverList: null,
            ...
            k.warning(n(d = n(f = n(g = "[".concat(a.clientId, "] Choose server ")).call(g, c, " failed, message: ")).call(f, b.message, ", retry: ")).call(d, b.data.retry)),
            b.data.retry) : (t.joinChooseServer(a.sid, {
                lts: e,
                succ: !1,
                csAddr: c,
                serverList: null,
    ...
    async function Yh(c, a, b) {
        return {
            gatewayInfo: await em(c, a, b)
        }
    }
    async function fm(c, a, b) {
        var d, e;
        "disabled" !== c.cloudProxyServer && (a = await gm(c, a, b),
        "443only" === c.cloudProxyServer ? c.proxyServer = C.PROXY_SERVER_TYPE2 : c.proxyServer = a.address,
        c.turnServer = {
            mode: "manual",
            servers: [{
                turnServerURL: a.address,
                tcpport: a.serverResponse.tcpport ? a.serverResponse.tcpport : Db.tcpport,
                udpport: a.serverResponse.udpport ? a.serverResponse.udpport : Db.udpport,
                username: a.serverResponse.username || Db.username,
                password: a.serverResponse.password || Db.password,
                forceturn: !0
            }]
        },
        k.debug(n(d = n(e = "[".concat(c.clientId, "] set proxy server: ")).call(e, c.proxyServer, ", mode: ")).call(d, c.cloudProxyServer)),
    ...
    async function gm(c, a, b) {
        ...
        f = v();
        e = D(g).call(g, d=>bm(d, c, a, b));
        d = null;
        try {
            d = await $c(e)
        } catch (h) {
            throw k.error("[".concat(c.clientId, "] can not get worker manager after trying several times")),
            new m(l.CAN_NOT_GET_PROXY_SERVER);
        }
        return r(e).call(e, a=>a.cancel()),
    ...
    async function em(c, a, b) {
        ...
        let e = D(d = C.WEBCS_DOMAIN).call(d, a=>{
            var b;
            return c.proxyServer ? n(b = "https://".concat(c.proxyServer, "/ap/?url=")).call(b, a + "/api/v1") : "https://".concat(a, "/api/v1")
        }
        )
          , f = null;
        d = D(e).call(e, d=>(k.debug("[".concat(c.clientId, "] Connect to choose_server:"), d),
        Xh(d, c, a, b)));
        try {
            var g;
            f = await $c(n(g = [new u(async(d,e)=>{
                var g;
                if (await Ab(1E3),
                null === f) {
                    var h = D(g = C.WEBCS_DOMAIN_BACKUP_LIST).call(g, a=>{
                      ...
                      , q = D(h).call(h, d=>(k.debug("[".concat(c.clientId, "] Connect to backup choose_server:"), d),
                    Xh(d, c, a, b)));
                    $c(q).then(a=>{
        ...
        return r(d).call(d, a=>a.cancel()),
        f
    }
    async function $h(c, a, b, d) {
        var e;
        let f = D(e = C.UAP_AP).call(e, b=>{
            var c;
            return a.proxyServer ? n(c = "https://".concat(a.proxyServer, "/ap/?url=")).call(c, b + "/api/v1?action=uap") : "https://".concat(b, "/api/v1?action=uap")
        }
        );
        try {
            return await cm(f, c, a, b, d)
        } catch (g) {
            throw g;
        }
    }
    async function hm(c, a, b) {
        var d;
        let e = D(d = C.UAP_AP).call(d, a=>{
            var b;
            return c.proxyServer ? n(b = "https://".concat(c.proxyServer, "/ap/?url=")).call(b, a + "/api/v1?action=uap") : "https://".concat(a, "/api/v1?action=uap")
        }
        );
        d = D(e).call(e, d=>dm(d, c, a, b));
        try {
            let a = await $c(d);
            return r(d).call(d, a=>a.cancel()),
            a
    ...
    async function im(c, a) {
        var b;
        let d = R(b = c.getTransceivers()).call(b, b=>"inactive" === b.direction && b.receiver.track.kind === a.kind);
        return d ? (d.direction = "sendrecv",
        await d.sender.replaceTrack(a),
        d) : c.addTransceiver(a, {
            direction: "sendrecv"
        })
    }
    function cb(c) {
        ...
        var a = {}, b;
        for (b in c)
            ai(c[b]) || Array.isArray(c[b]) ? a[b] = cb(c[b]) : a[b] = c[b];
        return a
    }
    function ai(c) {
    ...
    function ef(c, a, b, d) {
        return new (b || (b = Promise))(function(e, f) {
            ...
            function q(a) {
                a.done ? e(a.value) : (new b(function(b) {
                    b(a.value)
                }
                )).then(g, h)
            }
            ...
            return function(g) {
                return function(b) {
                    ...
                    for (; h; )
                        try {
                            if (d = 1,
                            e && (f = 2 & b[0] ? e.return : b[0] ? e.throw || ((f = e.return) && f.call(e),
                            0) : e.next) && !(f = f.call(e, b[1])).done)
                                return f;
                            switch (e = 0,
                            f && (b = [2 & b[0], f.value]),
                            b[0]) {
    ...
    function jm(c, a, b) {
        ...
        c.shaderSource(b, a);
        c.compileShader(b);
        return c.getShaderParameter(b, c.COMPILE_STATUS) ? b : (a = c.getShaderInfoLog(b),
        c.deleteShader(b),
    ...
    function km(c, a, b, d) {
        ...
        if (!e)
            throw new m(l.WEBGL_INTERNAL_ERROR,"can not create webgl program");
        r(a).call(a, a=>{
            c.attachShader(e, a)
        }
        );
    ...
    function gf(c) {
        let a = {};
        if (c.facingMode && (a.facingMode = c.facingMode),
        c.cameraId && (a.deviceId = {
            exact: c.cameraId
        }),
        !c.encoderConfig)
            return a;
        ...
        va().name === da.EDGE && "object" == typeof a.frameRate && (a.frameRate.max = 60),
        va().name === da.FIREFOX && (a.frameRate = {
            ideal: 30,
            max: 30
        }),
        a
    ...
    function di(c) {
        let a = {};
        if (Dh() || (void 0 !== c.AGC && (a.autoGainControl = c.AGC,
        Xc() && (a.googAutoGainControl = c.AGC,
        a.googAutoGainControl2 = c.AGC)),
        void 0 !== c.AEC && (a.echoCancellation = c.AEC),
        void 0 !== c.ANS && (a.noiseSuppression = c.ANS,
        ...
        return c.microphoneId && (a.deviceId = {
            exact: c.microphoneId
        }),
        Xc() && 2 === a.channelCount && (a.googAutoGainControl = !1,
    ...
    function Od(c) {
        for (var a = 1; a < arguments.length; a++) {
            var b, d = null != arguments[a] ? arguments[a] : {};
            if (a % 2)
                r(b = ei(Object(d), !0)).call(b, function(a) {
                    Pa(c, a, d[a])
                });
            else if (ja)
                Qa(c, ja(d));
                ...
                var e;
                r(e = ei(Object(d))).call(e, function(a) {
                    ba(c, a, ca(d, a))
                })
            }
        }
    ...
    function hf(c, a) {
        ...
        a.sampleRate) && (d += n(e = "maxplaybackrate=".concat(a.sampleRate, ";sprop-maxcapturerate=")).call(e, a.sampleRate, ";"));
        return a.stereo && (d += "stereo=1;sprop-stereo-1;"),
        d += "\r\n",
        c.replace(b[0], d)
    }
    function fi(c) {
    ...
    function lm(c, a) {
        var b, d, e;
        let f = za(b = RegExp.prototype.test).call(b, /^([a-z])=(.*)/);
        c = N(d = c.split(/(\r\n|\r|\n)/)).call(d, f);
        a = N(e = a.split(/(\r\n|\r|\n)/)).call(e, f);
        let g = null
          , h = new Y;
        return r(c).call(c, a=>{
            ...
            if (b && b[1])
                return void (g = b[1]);
            g && (a = a.match(/=(sendrecv|recvonly|sendonly|inactive)/)) && a[1] && h.set(g, a[1])
        }
        ),
        g = null,
        D(a).call(a, a=>{
    ...
    function mm(c, a) {
        ...
        if (!f)
            throw new m(l.UNEXPECTED_ERROR,"can not get canvas context");
        let g = d.captureStream(ea.supportRequestFrame ? 0 : a).getVideoTracks()[0]
          , h = We(()=>{
            if (b.paused && b.play(),
            2 < b.videoHeight && 2 < b.videoWidth) {
                const c = b.videoHeight / b.videoWidth * d.width;
                var a, h, q;
                2 <= Math.abs(c - d.height) && (k.debug("adjust low stream resolution", n(a = n(h = n(q = "".concat(d.width, "x")).call(q, d.height, " -> ")).call(h, d.width, "x")).call(a, c)),
                d.height = c)
            }
            f.drawImage(b, 0, 0, d.width, d.height);
            g.requestFrame && g.requestFrame();
            e !== c._mediaStreamTrack && (e = c._mediaStreamTrack,
            b.srcObject = new MediaStream([e]))
        }
        , a)
          , q = g.stop;
    ...
    function ki(c) {
        if (!(c instanceof li))
            return (new m(l.INVALID_PARAMS,"Config should be instance of [ChannelMediaRelayConfiguration]")).throw();
        let a = c.getSrcChannelMediaInfo();
        c = c.getDestChannelMediaInfo();
        if (!a)
            return (new m(l.INVALID_PARAMS,"srcChannelMediaInfo should not be empty")).throw();
        if (0 === c.size)
    ...
    async function om(c, a) {
        var b = null;
        if ("string" == typeof c) {
            let a = ni.get(c);
            if (a)
                return k.debug("use cached audio resource: ", c),
                a;
            try {
                b = (await fc(()=>Cb.get(c, {
        ...
        b = await Nl(b);
        return "string" == typeof c && a && ni.set(c, b),
        b
    }
    function oi(c, a) {
        var b = V(c);
    ...
    function mf(c, a, b, d) {
        if (b.optimizationMode)
            if (d && d.width && d.height) {
                ...
                b.encoderConfig = lf({}, d, {
                    bitrateMin: e.min,
                    bitrateMax: e.max
                });
                ("motion" === b.optimizationMode || "detail" === b.optimizationMode && d.frameRate && 10 > zb(d.frameRate)) && (a.contentHint = b.optimizationMode,
                a.contentHint === b.optimizationMode ? k.debug("[".concat(c, "] set content hint to"), b.optimizationMode) : k.debug("[".concat(c, "] set content hint failed")))
            } else
                k.warning("[".concat(c, "] can not apply optimization mode bitrate config, no encoderConfig"))
    }
    function pm(c, a, b, d) {
        let e, f = 0, g = null;
        return new u((h,q)=>{
    ...
    var Lb = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {}
      , Pd = function(c) {
        return c && c.Math == Math && c
    }
      , J = Pd("object" == typeof globalThis && globalThis) || Pd("object" == typeof window && window) || Pd("object" == typeof self && self) || Pd("object" == typeof Lb && Lb) || Function("return this")()
      , oa = function(c) {
        try {
            return !!c()
        } catch (a) {
    ...
    : pi
      ...
      , qm = {}.toString
      , Eb = function(c) {
        return qm.call(c).slice(8, -1)
    }
      , rm = "".split
      , Rd = oa(function() {
        return !Object("z").propertyIsEnumerable(0)
    }) ? function(c) {
        return "String" == Eb(c) ? rm.call(c, "") : Object(c)
    }
    : Object
      , hc = function(c) {
        if (null == c)
      ...
      , Dc = function(c, a) {
        if (!ya(c))
            return c;
        var b, d;
        if (a && "function" == typeof (b = c.toString) && !ya(d = b.call(c)) || "function" == typeof (b = c.valueOf) && !ya(d = b.call(c)) || !a && "function" == typeof (b = c.toString) && !ya(d = b.call(c)))
            return d;
      ...
      , Ec = J.document
      , Sd = ya(Ec) && ya(Ec.createElement)
      , ri = !la && !oa(function() {
        return 7 != Object.defineProperty(Sd ? Ec.createElement("div") : {}, "a", {
            get: function() {
                return 7
            }
        }).a
      ...
      , Fc = la ? si : function(c, a) {
        ...
        if (U(c, a))
            return gc(!Qd.call(c, a), c[a])
    }
      , tm = /#|\.prototype\./
      , Gc = function(c, a) {
        c = um[vm(c)];
        return c == wm || c != xm && ("function" == typeof a ? oa(a) : !!a)
    }
      , vm = Gc.normalize = function(c) {
        return String(c).replace(tm, ".").toLowerCase()
    }
      , um = Gc.data = {}
      , xm = Gc.NATIVE = "N"
      , wm = Gc.POLYFILL = "P"
      ...
      , eb = {
        f: la ? ti : function(c, a, b) {
            ...
            return "value"in b && (c[a] = b.value),
            c
        }
    }
      , nb = la ? function(c, a, b) {
    ...
    : function(c, a, b) {
      ...
      , K = function(c, a) {
        var b, d, e, f, g, h = c.target, q = c.global, y = c.stat, k = c.proto, ra = q ? J : y ? J[h] : (J[h] || {}).prototype, x = q ? fa : fa[h] || (fa[h] = {}), l = x.prototype;
        for (d in a) {
            var n = !Gc(q ? d : h + (y ? "." : "#") + d, c.forced) && ra && U(ra, d);
            var m = x[d];
            n && (e = c.noTargetGet ? (g = ym(ra, d)) && g.value : ra[d]);
            var p = n && e ? e : a[d];
            n && typeof m == typeof p || (f = c.bind && n ? ic(p, J) : c.wrap && n ? zm(p) : k && "function" == typeof p ? ic(Function.call, p) : p,
            (c.sham || p && p.sham || m && m.sham) && nb(f, "sham", !0),
            x[d] = f,
            k && (U(fa, b = h + "Prototype") || nb(fa, b, {}),
            fa[b][d] = p,
      ...
      , Mb = function(c, a) {
        return 2 > arguments.length ? ui(fa[c]) || ui(J[c]) : fa[c] && fa[c][a] || J[c] && J[c][a]
    }
      ...
      , Bm = function(c, a, b) {
        var d = b.charAt(a - 1);
        a = b.charAt(a + 1);
        return vi.test(c) && !wi.test(a) || wi.test(c) && !vi.test(d) ? "\\u" + c.charCodeAt(0).toString(16) : c
    }
      , Cm = oa(function() {
        return '"\\udf06\\ud834"' !== Td("\udf06\ud834") || '"\\udead"' !== Td("\udead")
    });
    Td && K({
        ...
        stringify: function(c, a, b) {
            ...
            return "string" == typeof d ? d.replace(Am, Bm) : d
        }
    });
    fa.JSON || (fa.JSON = {
    ...
    var Hc = {}
      ...
      , Em = Math.random()
      , Ud = function(c) {
        return "Symbol(" + String(void 0 === c ? "" : c) + ")_" + (++Dm + Em).toString(36)
    }
      , Fm = !oa(function() {
      ...
      , xi = Ka(function(c) {
        var a = eb.f
          ...
          , g = c.exports = {
            ...
            onFreeze: function(a) {
                return Fm && g.REQUIRED && e(a) && !U(a, b) && f(a),
                a
            }
        };
        Hc[b] = !0
      ...
      , yi = J["__core-js_shared__"] || Gm("__core-js_shared__", {})
      , Nb = Ka(function(c) {
        (c.exports = function(a, b) {
            return yi[a] || (yi[a] = void 0 !== b ? b : {})
        }
        )("versions", []).push({
            version: "3.4.3",
            mode: "pure",
      ...
      , Fb = !!Object.getOwnPropertySymbols && !oa(function() {
        return !String(Symbol())
    })
      , zi = Fb && !Symbol.sham && "symbol" == typeof Symbol()
      , Vd = Nb("wks")
      , nf = J.Symbol
      , Hm = zi ? nf : Ud
      , ta = function(c) {
        return U(Vd, c) || (Fb && U(nf, c) ? Vd[c] = nf[c] : Vd[c] = Hm("Symbol." + c)),
        Vd[c]
    }
      , Ob = {}
      , Im = ta("iterator")
      , Jm = Array.prototype
      , Ai = function(c) {
        return void 0 !== c && (Ob.Array === c || Jm[Im] === c)
    }
      , Km = Math.ceil
      , Lm = Math.floor
      , Wd = function(c) {
        return isNaN(c = +c) ? 0 : (0 < c ? Lm : Km)(c)
    }
      , Mm = Math.min
      , ob = function(c) {
        return 0 < c ? Mm(Wd(c), 9007199254740991) : 0
    }
      , Nm = ta("toStringTag")
      , Bi = {};
    Bi[Nm] = "z";
    var of = "[object z]" === String(Bi)
      , Om = ta("toStringTag")
      , Pm = "Arguments" == Eb(function() {
        return arguments
    }())
      , Xd = of ? Eb : function(c) {
        var a;
        if (void 0 === c)
            ...
            if (null === c)
                ...
                d = "string" == typeof (b = d) ? b : Pm ? Eb(c) : "Object" == (a = Eb(c)) && "function" == typeof c.callee ? "Arguments" : a
            }
            b = d
        }
        return b
      ...
      , Ci = function(c) {
        if (null != c)
            return c[Qm] || c["@@iterator"] || Ob[Xd(c)]
    }
      , Di = function(c, a, b, d) {
        try {
      ...
      , gd = Ka(function(c) {
        ...
        (c.exports = function(b, c, e, f, g) {
            ...
            c = ic(c, e, f ? 2 : 1);
            if (!g) {
                if ("function" != typeof (g = Ci(b)))
                    throw TypeError("Target is not iterable");
                if (Ai(g)) {
                    g = 0;
                    for (e = ob(b.length); e > g; g++)
                        if ((d = f ? c(Oa(q = b[g])[0], q[1]) : c(b[g])) && d instanceof a)
                            return d;
                    return new a(!1)
                }
                b = g.call(b)
            ...
            for (g = b.next; !(q = g.call(b)).done; )
                if ("object" == typeof (d = Di(b, c, q.value, f)) && d && d instanceof a)
                    return d;
            return new a(!1)
        }
        ).stop = function(b) {
      ...
      , hd = function(c, a, b, d) {
        ...
        d && !of && nb(c, "toString", Rm))
    }
      , pb = function(c) {
        return Object(hc(c))
    }
      , jc = Array.isArray || function(c) {
        return "Array" == Eb(c)
    }
      , Tm = ta("species")
      , qf = function(c, a) {
        var b;
        return jc(c) && ("function" != typeof (b = c.constructor) || b !== Array && !jc(b.prototype) ? ya(b) && null === (b = b[Tm]) && (b = void 0) : b = void 0),
      ...
      , kc = function(c) {
        ...
        return function(h, q, y, k) {
            var T, x, l = pb(h), n = Rd(l);
            q = ic(q, y, 3);
            y = ob(n.length);
            var m = 0;
            k = k || qf;
            for (h = a ? k(h, y) : b ? k(h, 0) : void 0; y > m; m++)
                if ((g || m in n) && (x = q(T = n[m], m, l),
                c))
                    if (a)
                        h[m] = x;
                    else if (x)
    ...
    var Ym = kc(5);
    kc(6);
    var Zm = Nb("native-function-to-string", Function.toString)
      , Fi = J.WeakMap
      , $m = "function" == typeof Fi && /native code/.test(Zm.call(Fi))
      , Gi = Nb("keys")
      , Yd = function(c) {
        return Gi[c] || (Gi[c] = Ud(c))
    }
      , an = J.WeakMap;
    if ($m) {
        var Jc = new an
    ...
    var ab = {
      ...
      , Ji = function(c, a) {
        ...
        var d = 0
          , e = [];
        for (b in c)
            !U(Hc, b) && U(c, b) && e.push(b);
        for (; a.length > d; )
            U(c, b = a[d++]) && (~Ii(e, b) || e.push(b));
        return e
    }
      , ae = "constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ")
      , Xb = Object.keys || function(c) {
        return Ji(c, ae)
    }
      , Ki = la ? Object.defineProperties : function(c, a) {
        Oa(c);
      ...
      , be = function() {
        ...
        c.close();
        for (be = c.F; a--; )
            delete be.prototype[ae[a]];
        return be()
    }
      , lc = Object.create || function(c, a) {
        var b;
        return null !== c ? (uf.prototype = Oa(c),
        b = new uf,
        uf.prototype = null,
        b[Li] = c) : b = be(),
        void 0 === a ? b : Ki(b, a)
    ...
    var vf = function(c, a, b, d) {
      ...
      , Mi = Yd("IE_PROTO")
      , mn = Object.prototype
      , xf = ln ? Object.getPrototypeOf : function(c) {
        return c = pb(c),
        U(c, Mi) ? c[Mi] : "function" == typeof c.constructor && c instanceof c.constructor ? c.constructor.prototype : c instanceof Object ? mn : null
    }
    ;
    ta("iterator");
    var Ni = !1, ce, yf, zf;
    [].keys && (zf = [].keys(),
    "next"in zf ? (yf = xf(xf(zf)),
    yf !== Object.prototype && (ce = yf)) : Ni = !0);
    null == ce && (ce = {});
    var Oi = ce
      , de = Ni
      , nn = function() {
    ...
    Object.setPrototypeOf || "__proto__"in {} && function() {
        ...
        return function(b, e) {
            ...
            return a ? c.call(b, e) : b.__proto__ = e,
            b
        }
    }();
    var Af = ta("iterator")
      ...
      , Bf = function(c, a, b, d, e, f, g) {
        ...
        if (p && (h = xf(p.call(new c)),
        Oi !== Object.prototype && h.next && (hd(h, k, !0, !0),
        Ob[k] = pn)),
        "values" == e && n && "values" !== n.name && (l = !0,
        m = function() {
            return n.call(this)
        }
        ),
    ...
    (function(c, a, b) {
        var d = -1 !== c.indexOf("Map")
          ...
          , h = g && g.prototype
          , q = {};
        if (la && "function" == typeof g && (e || h.forEach && !oa(function() {
            (new g).entries().next()
        }))) {
            ...
            var k = gn(c);
            Ic("add clear delete forEach get has set keys values entries".split(" "), function(a) {
                var b = "add" == a || "set" == a;
                !(a in h) || e && "clear" == a || nb(y.prototype, a, function(c, d) {
        ...
        getConstructor: function(c, a, b, d) {
            var e = c(function(c, g) {
              ...
              , f = Cf(a)
              , g = function(a, b, c) {
                var d, e, g = f(a), q = h(a, b);
                return q ? q.value = c : (g.last = q = {
                    index: e = Ri(b, !0),
                    key: b,
                    value: c,
                    previous: d = g.last,
            ...
            return wf(e.prototype, {
                ...
                forEach: function(a) {
                    for (var b, c = f(this), d = ic(a, 1 < arguments.length ? arguments[1] : void 0, 3); b = b ? b.next : c.first; )
    ...
    var Ti = function(c) {
        return function(a, b) {
            ...
            b = Wd(b);
            var f = a.length;
            return 0 > b || b >= f ? c ? "" : void 0 : 55296 > (d = a.charCodeAt(b)) || 56319 < d || b + 1 === f || 56320 > (e = a.charCodeAt(b + 1)) || 57343 < e ? c ? a.charAt(b) : d : c ? a.slice(b, b + 2) : e - 56320 + (d - 55296 << 10) + 65536
        }
    }
      , rn = {
        codeAt: Ti(!1),
      ...
      , sn = ab.set
      , tn = ab.getterFor("String Iterator");
    Bf(String, "String", function(c) {
        sn(this, {
        ...
        var c, a = tn(this), b = a.string, d = a.index;
        return d >= b.length ? {
            value: void 0,
            done: !0
        } : (c = rn(b, d),
    ...
    var un = ab.set
      , vn = ab.getterFor("Array Iterator");
    Bf(Array, "Array", function(c, a) {
        un(this, {
            type: "Array Iterator",
            target: db(c),
            index: 0,
        ...
        var c = vn(this)
          ...
          , b = c.kind
          , d = c.index++;
        return !a || d >= a.length ? (c.target = void 0,
        {
            value: void 0,
            done: !0
        }) : "keys" == b ? {
    ...
    var wn = {
        ...
        TextTrackList: 0,
        TouchList: 0
    }, Ui = ta("toStringTag"), ee;
    for (ee in wn) {
        var Vi = J[ee]
          , Df = Vi && Vi.prototype;
        Df && !Df[Ui] && nb(Df, Ui, ee);
        Ob[ee] = Ob.Array
    }
    var Y = fa.Map
      , xn = ta("match")
      , Ef = function(c) {
        var a;
        if (ya(c) && (void 0 !== (a = c[xn]) ? a : "RegExp" == Eb(c)))
    ...
    K({
        ...
        endsWith: function(c) {
            ...
            var b = 1 < arguments.length ? arguments[1] : void 0
              , d = ob(a.length);
            b = void 0 === b ? d : zn(ob(b), d);
            d = String(c);
            return Wi ? Wi.call(a, d, b) : a.slice(b - d.length, b) === d
        }
    });
    var Ba = function(c) {
        return fa[c + "Prototype"]
    }
      , Bn = Ba("String").endsWith
      , Xi = String.prototype
      , zg = function(c) {
        var a = c.endsWith;
        return "string" == typeof c || c === Xi || c instanceof String && a === Xi.endsWith ? Bn : a
    }
      , jd = function(c, a) {
        var b = [][c];
        return !b || !oa(function() {
            b.call(null, a || function() {
                throw 1;
            }
            , 1)
        })
    }
      , Yi = jd("forEach") ? function(c) {
    ...
    var Cn = Ba("Array").forEach
      ...
      , r = function(c) {
        var a = c.forEach;
        return c === Zi || c instanceof Array && a === Zi.forEach || Dn.hasOwnProperty(Xd(c)) ? Cn : a
    }
      , kd = {
      ...
      , $i = !fe || oa(function() {
        ...
        for (var b = pb(c), d = arguments.length, e = 1, f = kd.f, g = Qd; d > e; )
            for (var h, q = Rd(arguments[e++]), y = f ? Xb(q).concat(f(q)) : Xb(q), k = y.length, l = 0; k > l; )
                h = y[l++],
                la && !g.call(q, h) || (b[h] = q[h]);
        return b
    }
    : fe;
    K({
    ...
    K({
        ...
        reduce: function(c) {
            return Fn(this, c, arguments.length, 1 < arguments.length ? arguments[1] : void 0)
        }
    });
    var Gn = Ba("Array").reduce
      , bj = Array.prototype
      , xe = function(c) {
        var a = c.reduce;
        return c === bj || c instanceof Array && a === bj.reduce ? Gn : a
    };
    K({
        target: "Object",
        stat: !0,
    ...
    var dj = Gf(3)
      , ge = J.parseInt
      , Jn = /^[+-]?0[Xx]/
      , ej = 8 !== ge("\t\n\x0B\f\r \u00a0\u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029\ufeff08") || 22 !== ge("\t\n\x0B\f\r \u00a0\u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029\ufeff0x16") ? function(c, a) {
        c = dj(String(c));
        return ge(c, a >>> 0 || (Jn.test(c) ? 16 : 10))
    }
    : ge;
    K({
        global: !0,
    ...
    }, ld = Mb("navigator", "userAgent") || "", gj = J.process, hj = gj && gj.versions, ij = hj && hj.v8, Pb, he;
    ij ? (Pb = ij.split("."),
    he = Pb[0] + Pb[1]) : ld && (Pb = ld.match(/Edge\/(\d+)/),
    (!Pb || 74 <= Pb[1]) && (Pb = ld.match(/Chrome\/(\d+)/),
    Pb && (he = Pb[1])));
    var ie = he && +he
      , Ln = ta("species")
      , md = function(c) {
        return 51 <= ie || !oa(function() {
            var a = [];
            return (a.constructor = {})[Ln] = function() {
                return {
                    foo: 1
                }
            }
      ...
      , jj = ta("isConcatSpreadable")
      , Mn = 51 <= ie || !oa(function() {
        var c = [];
        return c[jj] = !1,
        c.concat()[0] !== c
    })
    ...
    K({
        ...
        concat: function(c) {
            var a, b, d = pb(this), e = qf(d, 0), f = 0;
            var g = -1;
    ...
    var On = Ba("Array").concat
      , kj = Array.prototype
      , n = function(c) {
        var a = c.concat;
        return c === kj || c instanceof Array && a === kj.concat ? On : a
    };
    K({
        target: "Array",
        proto: !0,
    ...
    var Pn = Ba("Array").filter
      , lj = Array.prototype
      , N = function(c) {
        var a = c.filter;
        return c === lj || c instanceof Array && a === lj.filter ? Pn : a
    }
      , Qn = J.Promise
      , mj = ta("iterator")
      , nj = !1;
    ...
    var pj = function(c, a) {
        ...
        return b
    }, Sn = ta("species"), qj = function(c, a) {
        var b;
        c = Oa(c).constructor;
        return void 0 === c || null == (b = Oa(c)[Sn]) ? a : mb(b)
    }, rj = /(iphone|ipod|ipad).*applewebkit/i.test(ld), sj = J.location, Hf = J.setImmediate, tj = J.clearImmediate, uj = J.process, vj = J.MessageChannel, If = J.Dispatch, Jf = 0, nd = {}, Kc, Kf, Lf, Mf = function(c) {
        ...
        J.postMessage(c + "", sj.protocol + "//" + sj.host)
    };
    Hf && tj || (Hf = function(c) {
        for (var a = [], b = 1; arguments.length > b; )
            a.push(arguments[b++]);
        return nd[++Jf] = function() {
    ...
    ,
    "process" == Eb(uj) ? Kc = function(c) {
        uj.nextTick(Nf(c))
    }
    : If && If.now ? Kc = function(c) {
        If.now(Nf(c))
    }
    : vj && !rj ? (Kf = new vj,
    Lf = Kf.port2,
    Kf.port1.onmessage = wj,
    Kc = ic(Lf.postMessage, Lf, 1)) : !J.addEventListener || "function" != typeof postMessage || J.importScripts || oa(xj) ? Kc = "onreadystatechange"in (Sd ? Ec.createElement("script") : {}) ? function(c) {
        tf.appendChild(Sd ? Ec.createElement("script") : {}).onreadystatechange = function() {
            tf.removeChild(this);
            Mf(c)
        }
    }
    ...
    : (Kc = xj,
    J.addEventListener("message", wj, !1)));
    var Of = Hf, Tn = Fc, yj = J.MutationObserver || J.WebKitMutationObserver, Pf = J.process, Qf = J.Promise, zj = "process" == Eb(Pf), Aj = Tn(J, "queueMicrotask"), Bj = Aj && Aj.value, od, nc, pd, Lc, Rf, Sf, Tf, Cj;
    Bj || (od = function() {
        var c;
        for (zj && (c = Pf.domain) && c.exit(); nc; ) {
            var a = nc.fn;
            nc = nc.next;
            try {
                a()
            } catch (b) {
                throw nc ? Lc() : pd = void 0,
                b;
            }
        }
        pd = void 0;
    ...
    (new yj(od)).observe(Sf, {
        characterData: !0
    }),
    Lc = function() {
        Sf.data = Rf = !Rf
    }
    ) : Qf && Qf.resolve ? (Tf = Qf.resolve(void 0),
    Cj = Tf.then,
    Lc = function() {
        Cj.call(Tf, od)
    }
    ...
    var Dj = Bj || function(c) {
      ...
      , Zn = Nb("inspectSource");
    Mb("fetch");
    var Mc = je.f, $n = Mc, qd = "process" == Eb(le), ao = !!(Vf && Vf.createEvent && J.dispatchEvent), me, Gj, ne = Gc("Promise", function() {
        if (Zn(Ra) === String(Ra) && (66 === ie || !qd && "function" != typeof PromiseRejectionEvent) || !Ra.prototype.finally)
            return !0;
        if (51 <= ie && /native code/.test(Ra))
            return !1;
        var c = Ra.resolve(1)
          , a = function(a) {
            a(function() {}, function() {})
        };
        return (c.constructor = {})[Wn] = a,
        !(c.then(function() {})instanceof a)
    }), bo = ne || !pj(function(c) {
        Ra.all(c).catch(function() {})
    }), Hj = function(c) {
        var a;
        return !(!ya(c) || "function" != typeof (a = c.then)) && a
    }, Wf = function(c, a, b) {
        if (!a.notified) {
            a.notified = !0;
            var d = a.reactions;
            Dj(function() {
                for (var e = a.value, f = 1 == a.state, g = 0; d.length > g; ) {
                    var h, q, y, k = d[g++], l = f ? k.ok : k.fail, x = k.resolve, n = k.reject, m = k.domain;
                    try {
                        l ? (f || (2 === a.rejection && co(c, a),
                        a.rejection = 1),
                        !0 === l ? h = e : (m && m.enter(),
                        h = l(e),
                        m && (m.exit(),
                        y = !0)),
                        h === k.promise ? n(Fj("Promise-chain cycle")) : (q = Hj(h)) ? q.call(h, x, n) : x(h)) : n(e)
                    } catch (bc) {
                        m && !y && m.exit(),
                        n(bc)
                    }
                ...
                a.reactions = [];
                a.notified = !1;
                b && !a.rejection && eo(c, a)
            })
        }
    }, Ij = function(c, a, b) {
        var d, e;
        ao ? ((d = Vf.createEvent("Event")).promise = a,
        d.reason = b,
        d.initEvent(c, !1, !0),
        J.dispatchEvent(d)) : d = {
            promise: a,
        ...
        (e = J["on" + c]) ? e(d) : "unhandledrejection" === c && Vn("Unhandled promise rejection", b)
    }, eo = function(c, a) {
        Of.call(J, function() {
            var b, d = a.value;
            if (1 !== a.rejection && !a.parent && (b = ke(function() {
                qd ? le.emit("unhandledRejection", d, c) : Ij("unhandledrejection", c, d)
            }),
        ...
        Of.call(J, function() {
            qd ? le.emit("rejectionHandled", c) : Ij("rejectionhandled", c, a.value)
        })
    }, Nc = function(c, a, b, d) {
        return function(e) {
            c(a, b, e, d)
        ...
        if (!a.done) {
            ...
            try {
                if (c === b)
                    throw Fj("Promise can't be resolved itself");
                var e = Hj(b);
                e ? Dj(function() {
                    var d = {
                        done: !1
    ...
    me.prototype = wf(Ra.prototype, {
        then: function(c, a) {
            var b = Yn(this)
              , d = Mc(qj(this, Ra));
            return d.ok = "function" != typeof c || c,
    ...
    var fo = Ba("Array").map
      ...
      , D = function(c) {
        var a = c.map;
        return c === Kj || c instanceof Array && a === Kj.map ? fo : a
    }
      , go = Math.max
      , ho = Math.min;
    K({
        ...
        splice: function(c, a) {
            var b, d, e, f, g = pb(this), h = ob(g.length), q = $d(c, h);
            var y = arguments.length;
            if (0 === y ? b = d = 0 : 1 === y ? (b = 0,
            d = h - q) : (b = y - 2,
            d = ho(go(Wd(a), 0), h - q)),
            ...
            b < d) {
                ...
                for (e = h - d; e > q; e--)
                    k = e + b - 1,
                    (f = e + d - 1)in g ? g[k] = g[f] : delete g[k];
            for (e = 0; e < b; e++)
                g[e + q] = arguments[e + 2];
            return g.length = h - d + b,
            y
        }
    });
    var io = Ba("Array").splice
      , Lj = Array.prototype
      , Ma = function(c) {
        var a = c.splice;
        return c === Lj || c instanceof Array && a === Lj.splice ? io : a
    }
      , Mj = [].indexOf
      , Nj = !!Mj && 0 > 1 / [1].indexOf(1, -0)
      , jo = jd("indexOf");
    K({
        target: "Array",
        proto: !0,
        ...
        indexOf: function(c) {
            return Nj ? Mj.apply(this, arguments) || 0 : Ii(this, c, 1 < arguments.length ? arguments[1] : void 0)
        }
    });
    var ko = Ba("Array").indexOf
      , Oj = Array.prototype
      , E = function(c) {
        var a = c.indexOf;
        return c === Oj || c instanceof Array && a === Oj.indexOf ? ko : a
    }
      , lo = ta("species")
      , mo = [].slice
      , no = Math.max;
    K({
        ...
        slice: function(c, a) {
            ...
            c = $d(c, e);
            a = $d(void 0 === a ? e : a, e);
            if (jc(d) && ("function" != typeof (b = d.constructor) || b !== Array && !jc(b.prototype) ? ya(b) && null === (b = b[lo]) && (b = void 0) : b = void 0,
            b === Array || void 0 === b))
                return mo.call(d, c, a);
            b = new (void 0 === b ? Array : b)(no(a - c, 0));
            for (e = 0; c < a; c++,
            e++)
                c in d && mc(b, e, d[c]);
            return b.length = e,
    ...
    var oo = Ba("Array").slice
      , Pj = Array.prototype
      , wb = function(c) {
        var a = c.slice;
        return c === Pj || c instanceof Array && a === Pj.slice ? oo : a
    }
      , Qj = !0;
    ...
    K({
        ...
        find: function(c) {
            return Ym(this, c, 1 < arguments.length ? arguments[1] : void 0)
        }
    });
    var po = Ba("Array").find
      , Rj = Array.prototype
      , R = function(c) {
        var a = c.find;
        return c === Rj || c instanceof Array && a === Rj.find ? po : a
    }
      , Sj = [].slice
      , Yf = {};
    K({
        ...
        bind: Function.bind || function(c) {
            var a = mb(this)
              , b = Sj.call(arguments, 1)
              , d = function() {
                var e = b.concat(Sj.call(arguments));
            ...
            return ya(a.prototype) && (d.prototype = a.prototype),
            d
        }
    });
    var qo = Ba("Function").bind
      , Tj = Function.prototype
      , za = function(c) {
        var a = c.bind;
        return c === Tj || c instanceof Function && a === Tj.bind ? qo : a
    };
    K({
        target: "Array",
        proto: !0
        ...
        includes: function(c) {
            return kn(this, c, 1 < arguments.length ? arguments[1] : void 0)
        }
    });
    var ro = Ba("Array").includes;
    K({
        target: "String",
        proto: !0,
        forced: !Ff("includes")
        ...
        includes: function(c) {
            return !!~String(hc(this)).indexOf(Ef(c), 1 < arguments.length ? arguments[1] : void 0)
        }
    });
    var so = Ba("String").includes
      , Uj = Array.prototype
      , Vj = String.prototype
      , La = function(c) {
        var a = c.includes;
        return c === Uj || c instanceof Array && a === Uj.includes ? ro : "string" == typeof c || c === Vj || c instanceof String && a === Vj.includes ? so : a
    };
    K({
        target: "Array",
        proto: !0,
    ...
    var to = Ba("Array").some
      , Wj = Array.prototype
      , Cg = function(c) {
        var a = c.some;
        return c === Wj || c instanceof Array && a === Wj.some ? to : a
    };
    let Dg = kb;
    var Xj = Object.freeze({
        ...
        shimGetDisplayMedia: function(c, a) {
            c.navigator.mediaDevices && "getDisplayMedia"in c.navigator.mediaDevices || c.navigator.mediaDevices && ("function" == typeof a ? c.navigator.mediaDevices.getDisplayMedia = function(b) {
                return a(b).then(a=>{
    ...
    K({
        ...
        startsWith: function(c) {
            var a = String(hc(this));
            Ef(c);
            var b = ob(uo(1 < arguments.length ? arguments[1] : void 0, a.length))
              , d = String(c);
            return Yj ? Yj.call(a, d, b) : a.slice(b, b + d.length) === d
        }
    });
    var wo = Ba("String").startsWith
      , Zj = String.prototype
      , Bd = function(c) {
        var a = c.startsWith;
        return "string" == typeof c || c === Zj || c instanceof String && a === Zj.startsWith ? wo : a
    };
    K({
        target: "String",
        proto: !0,
    ...
    var xo = Ba("String").trim
      , ak = String.prototype
      , tc = function(c) {
        var a = c.trim;
        return "string" == typeof c || c === ak || c instanceof String && a === ak.trim ? xo : a
    }
      , F = Ka(function(c) {
        var a = {
        ...
        a.matchPrefix = function(b, c) {
            var d;
            return N(d = a.splitLines(b)).call(d, function(a) {
        ...
        a.parseCandidate = function(a) {
            var b;
            a = {
                foundation: (b = 0 === E(a).call(a, "a=candidate:") ? a.substring(12).split(" ") : a.substring(10).split(" "))[0],
                component: S(b[1], 10),
        ...
        a.writeRtcpFb = function(a) {
            var b, c = "", f = a.payloadType;
            (void 0 !== a.preferredPayloadType && (f = a.preferredPayloadType),
            a.rtcpFeedback && a.rtcpFeedback.length) && r(b = a.rtcpFeedback).call(b, function(a) {
                c += "a=rtcp-fb:" + f + " " + a.type + (a.parameter && a.parameter.length ? " " + a.parameter : "") + "\r\n"
            });
            return c
        }
        ;
        a.parseSsrcMedia = function(a) {
            var b = E(a).call(a, " ")
              , c = {
                ssrc: S(a.substr(7, b - 7), 10)
            }
              , f = E(a).call(a, ":", b);
            return -1 < f ? (c.attribute = a.substr(b + 1, f - b - 1),
            c.value = a.substr(f + 1)) : c.attribute = a.substr(b + 1),
            c
        }
        ;
        ...
        a.getDtlsParameters = function(b, c) {
            ...
            return {
                role: "auto",
                fingerprints: D(b).call(b, a.parseFingerprint)
            }
        }
        ;
        a.writeDtlsParameters = function(a, c) {
            var b, d = "a=setup:" + c + "\r\n";
            return r(b = a.fingerprints).call(b, function(a) {
        ...
        a.getIceParameters = function(b, c) {
            b = a.splitLines(b);
            return b = n(b).call(b, a.splitLines(c)),
            {
                usernameFragment: N(b).call(b, function(a) {
                    return 0 === E(a).call(a, "a=ice-ufrag:")
                })[0].substr(12),
                password: N(b).call(b, function(a) {
        ...
        a.parseRtpParameters = function(b) {
            for (var c, e = {
                ...
                fecMechanisms: [],
                rtcp: []
            }, f = a.splitLines(b)[0].split(" "), g = 3; g < f.length; g++) {
                var h = f[g]
                ...
                if (q) {
                    ...
                    switch (q.parameters = k.length ? a.parseFmtp(k[0]) : {},
                    q.rtcpFeedback = D(y = a.matchPrefix(b, "a=rtcp-fb:" + h + " ")).call(y, a.parseRtcpFb),
                    e.codecs.push(q),
                    q.name.toUpperCase()) {
                    case "RED":
                    case "ULPFEC":
            ...
            return r(c = a.matchPrefix(b, "a=extmap:")).call(c, function(b) {
        ...
        a.writeRtpDescription = function(b, c) {
            ...
            h += " UDP/TLS/RTP/SAVPF ";
            h += D(d = c.codecs).call(d, function(a) {
            ...
            0 < k && (h += "a=maxptime:" + k + "\r\n"),
            h += "a=rtcp-mux\r\n",
            c.headerExtensions) && r(q = c.headerExtensions).call(q, function(b) {
                h += a.writeExtmap(b)
            });
            return h
        }
        ...
        a.parseRtpEncodingParameters = function(b) {
            var c, e, f, g, h, q, k, T = [], l = a.parseRtpParameters(b), x = -1 !== E(c = l.fecMechanisms).call(c, "RED"), n = -1 !== E(e = l.fecMechanisms).call(e, "ULPFEC");
            c = N(f = D(g = a.matchPrefix(b, "a=ssrc:")).call(g, function(b) {
            ...
            r(q = l.codecs).call(q, function(a) {
                "RTX" === a.name.toUpperCase() && a.parameters.apt && (a = {
                    ssrc: m,
                    codecPayloadType: S(a.parameters.apt, 10)
                },
                m && k && (a.rtx = {
                    ssrc: k
                }),
                T.push(a),
                x && ((a = JSON.parse(w(a))).fec = {
                    ssrc: m,
            ...
            var p, t, u = a.matchPrefix(b, "b=");
            u.length && (u = 0 === E(p = u[0]).call(p, "b=TIAS:") ? S(u[0].substr(7), 10) : 0 === E(t = u[0]).call(t, "b=AS:") ? 950 * S(u[0].substr(5), 10) - 16E3 : void 0,
        ...
        a.parseRtcpParameters = function(b) {
            var c, e, f = {}, g = N(c = D(e = a.matchPrefix(b, "a=ssrc:")).call(e, function(b) {
                return a.parseSsrcMedia(b)
            })).call(c, function(a) {
                return "cname" === a.attribute
            })[0];
            ...
            return f.mux = 0 < b.length,
            f
        }
        ;
        a.parseMsid = function(b) {
            var c, e, f, g = a.matchPrefix(b, "a=msid:");
            if (1 === g.length)
                return {
                    stream: (f = g[0].substr(7).split(" "))[0],
                    track: f[1]
                };
            b = N(c = D(e = a.matchPrefix(b, "a=ssrc:")).call(e, function(b) {
                return a.parseSsrcMedia(b)
            })).call(c, function(a) {
                return "msid" === a.attribute
            });
            return 0 < b.length ? {
                stream: (f = b[0].value.split(" "))[0],
                track: f[1]
            } : void 0
        }
        ;
        ...
        a.writeMediaSection = function(b, c, e, f) {
            ...
            if (c += a.writeIceParameters(b.iceGatherer.getLocalParameters()),
            c += a.writeDtlsParameters(b.dtlsTransport.getLocalParameters(), "offer" === e ? "actpass" : "active"),
            c += "a=mid:" + b.mid + "\r\n",
            ...
            b.rtpSender)
                ...
                b.sendEncodingParameters[0].rtx && (c += "a=ssrc:" + b.sendEncodingParameters[0].rtx.ssrc + " " + e,
                c += "a=ssrc-group:FID " + b.sendEncodingParameters[0].ssrc + " " + b.sendEncodingParameters[0].rtx.ssrc + "\r\n");
      ...
      , nl = function(c, a) {
        function b(a, b) {
            b.addTrack(a);
            b.dispatchEvent(new c.MediaStreamTrackEvent("addtrack",{
                track: a
            }))
        }
        function d(a, b, d, e) {
        ...
        var e = function(b) {
            ...
            "negotiate" === b.rtcpMuxPolicy)
                throw Fa("NotSupportedError", "rtcpMuxPolicy 'negotiate' is not supported");
            switch (b.rtcpMuxPolicy || (b.rtcpMuxPolicy = "require"),
            ...
            if (b.iceServers = ml(b.iceServers || [], a),
            this._iceGatherers = [],
        ...
        e.prototype.addTrack = function(a, b) {
            if (this._isClosed)
                throw Fa("InvalidStateError", "Attempted to call addTrack on a closed peerconnection.");
            var d;
            ...
            return d || (d = this._createTransceiver(a.kind)),
        ...
        e.prototype.removeTrack = function(a) {
            if (this._isClosed)
                throw Fa("InvalidStateError", "Attempted to call removeTrack on a closed peerconnection.");
            ...
            if (!b)
                throw Fa("InvalidAccessError", "Sender was not created by this connection.");
            var d = b.stream;
            b.rtpSender.stop();
            b.rtpSender = null;
            b.track = null;
            ...
            -1 === this.transceivers.map(function(a) {
                return a.stream
            }).indexOf(d) && -1 < this.localStreams.indexOf(d) && this.localStreams.splice(this.localStreams.indexOf(d), 1);
            this._maybeFireNegotiationNeeded()
        }
        ;
        ...
        e.prototype._createIceGatherer = function(a, b) {
            ...
            this.transceivers[a].bufferCandidates = function(b) {
                ...
                null !== d.transceivers[a].bufferedCandidateEvents && d.transceivers[a].bufferedCandidateEvents.push(b)
            }
            ,
            ...
            if (!e.onlocalcandidate) {
                ...
                e.onlocalcandidate = function(c) {
                    if (!(d.usingBundle && 0 < b)) {
                        ...
                        var g = c.candidate;
                        (c = !g || 0 === Object.keys(g).length) ? "new" !== e.state && "gathering" !== e.state || (e.state = "completed") : ("new" === e.state && (e.state = "gathering"),
                        g.component = 1,
                        ...
                        g[f.candidate.sdpMLineIndex] += c ? "a=end-of-candidates\r\n" : "a=" + f.candidate.candidate + "\r\n";
                        ...
                        "gathering" !== d.iceGatheringState && (d.iceGatheringState = "gathering",
                        d._emitGatheringStateChange());
                        c || d._dispatchEvent("icecandidate", f);
                        g && (d._dispatchEvent("icecandidate", new Event("icecandidate")),
        ...
        e.prototype._transceive = function(b, c, d) {
            ...
            b.rtpSender.send(e));
            d && b.rtpReceiver && 0 < e.codecs.length && ("video" === b.kind && b.recvEncodingParameters && 15019 > a && b.recvEncodingParameters.forEach(function(a) {
                delete a.rtx
            }),
            b.recvEncodingParameters.length ? e.encodings = b.recvEncodingParameters : e.encodings = [{}],
            e.rtcp = {
                compound: b.rtcpParameters.compound
            },
        ...
        e.prototype.setLocalDescription = function(a) {
            ...
            if (-1 === ["offer", "answer"].indexOf(a.type))
                return Promise.reject(Fa("TypeError", 'Unsupported type "' + a.type + '"'));
            if (!Ng("setLocalDescription", a.type, b.signalingState) || b._isClosed)
                return Promise.reject(Fa("InvalidStateError", "Can not set local " + a.type + " in state " + b.signalingState));
            if ("offer" === a.type) {
                ...
                c.forEach(function(a, c) {
                    ...
                    if (!(F.isRejected(a) && 0 === F.matchPrefix(a, "a=bundle-only").length || f.rejected)) {
                        var l = F.getIceParameters(a, d);
                        a = F.getDtlsParameters(a, d);
                        e && (a.role = "server");
                        b.usingBundle && 0 !== c || (b._gather(f.mid, c),
                        "new" === h.state && h.start(g, l, e ? "controlling" : "controlled"),
        ...
        e.prototype.setRemoteDescription = function(e) {
            ...
            if (-1 === ["offer", "answer"].indexOf(e.type))
                return Promise.reject(Fa("TypeError", 'Unsupported type "' + e.type + '"'));
            if (!Ng("setRemoteDescription", e.type, f.signalingState) || f._isClosed)
                return Promise.reject(Fa("InvalidStateError", "Can not set remote " + e.type + " in state " + f.signalingState));
            var g = {};
            ...
            return f.canTrickleIceCandidates = !!p && 0 <= p.substr(14).split(" ").indexOf("trickle"),
            l.forEach(function(d, h) {
                ...
                var p = F.parseMsid(d)
                  , ra = F.getMid(d) || F.generateIdentifier();
                if (l || "application" === y && ("DTLS/SCTP" === T || "UDP/DTLS/SCTP" === T))
                    f.transceivers[h] = {
                        mid: ra,
                        kind: y,
                        protocol: T,
                    ...
                    var r, t;
                    !l && f.transceivers[h] && f.transceivers[h].rejected && (f.transceivers[h] = f._createTransceiver(y, !0));
                    var sc, u, xb = F.parseRtpParameters(d);
                    l || (sc = F.getIceParameters(d, n),
                    ...
                    d = F.matchPrefix(d, "a=candidate:").map(function(a) {
                        return F.parseCandidate(a)
                    }).filter(function(a) {
                        return 1 === a.component
                    });
                    if (("offer" === e.type || "answer" === e.type) && !l && m && 0 < h && f.transceivers[h] && (f._disposeIceAndDtlsTransports(h),
                    f.transceivers[h].iceGatherer = f.transceivers[0].iceGatherer,
                    f.transceivers[h].iceTransport = f.transceivers[0].iceTransport,
                    f.transceivers[h].dtlsTransport = f.transceivers[0].dtlsTransport,
                    f.transceivers[h].rtpSender && f.transceivers[h].rtpSender.setTransport(f.transceivers[0].dtlsTransport),
                    f.transceivers[h].rtpReceiver && f.transceivers[h].rtpReceiver.setTransport(f.transceivers[0].dtlsTransport)),
                    "offer" !== e.type || l) {
                        if ("answer" === e.type && !l) {
                            ...
                            ra = r.localCapabilities;
                            f.transceivers[h].recvEncodingParameters = T;
                            f.transceivers[h].remoteCapabilities = xb;
                            f.transceivers[h].rtcpParameters = v;
                            d.length && "new" === w.state && (!x && !bc || m && 0 !== h ? d.forEach(function(a) {
                                Ae(r.iceTransport, a)
                            }) : w.setRemoteCandidates(d));
                            m && 0 !== h || ("new" === w.state && w.start(y, sc, "controlling"),
                            "new" === A.state && A.start(u));
                            !Cd(r.localCapabilities, r.remoteCapabilities).codecs.filter(function(a) {
                                return "rtx" === a.name.toLowerCase()
                            }).length && r.sendEncodingParameters[0].rtx && delete r.sendEncodingParameters[0].rtx;
                            f._transceive(r, "sendrecv" === q || "recvonly" === q, "sendrecv" === q || "sendonly" === q);
                            !z || "sendrecv" !== q && "sendonly" !== q ? delete r.rtpReceiver : (t = z.track,
                            p ? (g[p.stream] || (g[p.stream] = new c.MediaStream),
                            b(t, g[p.stream]),
                            k.push([t, z, g[p.stream]])) : (g.default || (g.default = new c.MediaStream),
                            b(t, g.default),
                            k.push([t, z, g.default])))
                        }
                    } else {
                        (r = f.transceivers[h] || f._createTransceiver(y)).mid = ra;
                        r.iceGatherer || (r.iceGatherer = f._createIceGatherer(h, m));
                        d.length && "new" === r.iceTransport.state && (!bc || m && 0 !== h ? d.forEach(function(a) {
                            Ae(r.iceTransport, a)
                        }) : r.iceTransport.setRemoteCandidates(d));
                        ra = c.RTCRtpReceiver.getCapabilities(y);
                        15019 > a && (ra.codecs = ra.codecs.filter(function(a) {
                            return "rtx" !== a.name
                        }));
                        l = r.sendEncodingParameters || [{
                            ssrc: 1001 * (2 * h + 2)
                        ...
                        if ("sendrecv" === q || "sendonly" === q) {
                            if (sc = !r.rtpReceiver,
                            z = r.rtpReceiver || new c.RTCRtpReceiver(r.dtlsTransport,y),
                            sc)
                                t = z.track,
                                p && "-" === p.stream || (p ? (g[p.stream] || (g[p.stream] = new c.MediaStream,
                                ...
                                w = g[p.stream]) : (g.default || (g.default = new c.MediaStream),
                                w = g.default)),
                                w && (b(t, w),
                                r.associatedRemoteMediaStreams.push(w)),
                                k.push([t, z, w])
                        } else
                            r.rtpReceiver && r.rtpReceiver.track && (r.associatedRemoteMediaStreams.forEach(function(a) {
                                var b = a.getTracks().find(function(a) {
                                    return a.id === r.rtpReceiver.track.id
                                });
                                b && function(a, b) {
                                    b.removeTrack(a);
                                    b.dispatchEvent(new c.MediaStreamTrackEvent("removetrack",{
                                        track: a
                                    }))
                                }(b, a)
                            }),
                            r.associatedRemoteMediaStreams = []);
                        r.localCapabilities = ra;
            ...
            f._remoteDescription = {
                type: e.type,
                sdp: e.sdp
            },
            "offer" === e.type ? f._updateSignalingState("have-remote-offer") : f._updateSignalingState("stable"),
            ...
            c.setTimeout(function() {
                f && f.transceivers && f.transceivers.forEach(function(a) {
        ...
        e.prototype.createOffer = function(b) {
            var d = this;
            if (d._isClosed)
                return Promise.reject(Fa("InvalidStateError", "Can not call createOffer after close"));
            ...
            if (b) {
                ...
                void 0 !== b.offerToReceiveVideo && (f = !0 === b.offerToReceiveVideo ? 1 : !1 === b.offerToReceiveVideo ? 0 : b.offerToReceiveVideo)
            }
            for (d.transceivers.forEach(function(a) {
                "audio" === a.kind ? 0 > --e && (a.wantReceive = !1) : "video" === a.kind && 0 > --f && (a.wantReceive = !1)
            }); 0 < e || 0 < f; )
                0 < e && (d._createTransceiver("audio"),
                e--),
                0 < f && (d._createTransceiver("video"),
                f--);
            ...
            d.transceivers.forEach(function(b, e) {
                ...
                15019 > a && (h.codecs = h.codecs.filter(function(a) {
                    return "rtx" !== a.name
                }));
                h.codecs.forEach(function(a) {
                    ...
                    b.remoteCapabilities && b.remoteCapabilities.codecs && b.remoteCapabilities.codecs.forEach(function(b) {
                ...
                h.headerExtensions.forEach(function(a) {
                    (b.remoteCapabilities && b.remoteCapabilities.headerExtensions || []).forEach(function(b) {
                ...
                f && 15019 <= a && "video" === g && !e[0].rtx && (e[0].rtx = {
                    ssrc: e[0].ssrc + 1
                });
            ...
            "max-compat" !== d._config.bundlePolicy && (g += "a=group:BUNDLE " + d.transceivers.map(function(a) {
                return a.mid
            }).join(" ") + "\r\n");
            ...
            d.transceivers.forEach(function(a, b) {
                ...
                g += "a=rtcp-rsize\r\n";
                !a.iceGatherer || "new" === d.iceGatheringState || 0 !== b && d.usingBundle || (a.iceGatherer.getLocalCandidates().forEach(function(a) {
                    a.component = 1;
        ...
        e.prototype.createAnswer = function() {
            var b = this;
            if (b._isClosed)
                return Promise.reject(Fa("InvalidStateError", "Can not call createAnswer after close"));
            if ("have-remote-offer" !== b.signalingState && "have-local-pranswer" !== b.signalingState)
                return Promise.reject(Fa("InvalidStateError", "Can not call createAnswer in signalingState " + b.signalingState));
            var d = F.writeSessionBoilerplate(b._sdpSessionId, b._sdpSessionVersion++);
            b.usingBundle && (d += "a=group:BUNDLE " + b.transceivers.map(function(a) {
                return a.mid
            }).join(" ") + "\r\n");
            ...
            b.transceivers.forEach(function(c, f) {
                if (!(f + 1 > e)) {
                    if (c.rejected)
                        return "application" === c.kind ? "DTLS/SCTP" === c.protocol ? d += "m=application 0 DTLS/SCTP 5000\r\n" : d += "m=application 0 " + c.protocol + " webrtc-datachannel\r\n" : "audio" === c.kind ? d += "m=audio 0 UDP/TLS/RTP/SAVPF 0\r\na=rtpmap:0 PCMU/8000\r\n" : "video" === c.kind && (d += "m=video 0 UDP/TLS/RTP/SAVPF 120\r\na=rtpmap:120 VP8/90000\r\n"),
                        void (d += "c=IN IP4 0.0.0.0\r\na=inactive\r\na=mid:" + c.mid + "\r\n");
                    var g;
                    c.stream && ("audio" === c.kind ? g = c.stream.getAudioTracks()[0] : "video" === c.kind && (g = c.stream.getVideoTracks()[0]),
                    g && 15019 <= a && "video" === c.kind && !c.sendEncodingParameters[0].rtx && (c.sendEncodingParameters[0].rtx = {
        ...
        e.prototype.addIceCandidate = function(a) {
            ...
            return a && void 0 === a.sdpMLineIndex && !a.sdpMid ? Promise.reject(new TypeError("sdpMLineIndex or sdpMid required")) : new Promise(function(d, e) {
                if (!c._remoteDescription)
                    return e(Fa("InvalidStateError", "Can not add ICE candidate without a remote description"));
                if (a && "" !== a.candidate) {
                    ...
                    if ("tcp" === g.protocol && (0 === g.port || 9 === g.port) || g.component && 1 !== g.component)
                        return d();
                    if ((0 === f || 0 < f && h.iceTransport !== c.transceivers[0].iceTransport) && !Ae(h.iceTransport, g))
                        return e(Fa("OperationError", "Can not add ICE candidate"));
                    e = a.candidate.trim();
                    0 === e.indexOf("a=") && (e = e.substr(2));
                    (b = F.getMediaSections(c._remoteDescription.sdp))[f] += "a=" + (g.type ? e : "end-of-candidates") + "\r\n";
                    c._remoteDescription.sdp = F.getDescription(c._remoteDescription.sdp) + b.join("")
                } else
                    for (f = 0; f < c.transceivers.length && (c.transceivers[f].rejected || (c.transceivers[f].iceTransport.addRemoteCandidate({}),
                    (b = F.getMediaSections(c._remoteDescription.sdp))[f] += "a=end-of-candidates\r\n",
                    c._remoteDescription.sdp = F.getDescription(c._remoteDescription.sdp) + b.join(""),
                    !c.usingBundle)); f++)
                        ;
                d()
        ...
        (f = ["setLocalDescription", "setRemoteDescription", "addIceCandidate"]).forEach(function(a) {
            var b = e.prototype[a];
            e.prototype[a] = function() {
                var a = arguments;
      ...
      , ck = Object.freeze({
        ...
        shimGetUserMedia: Rg,
        shimGetDisplayMedia: function(c, a) {
            c.navigator.mediaDevices && "getDisplayMedia"in c.navigator.mediaDevices || c.navigator.mediaDevices && (c.navigator.mediaDevices.getDisplayMedia = function(b) {
                return b && b.video ? (!0 === b.video ? b.video = {
                    mediaSource: a
                } : b.video.mediaSource = a,
                c.navigator.mediaDevices.getUserMedia(b)) : (b = new DOMException("getDisplayMedia without video constraints is undefined"),
    ...
    let $a = function(c) {
        ...
        return (a = c.match(/([0-9]+\.[0-9]+\.[0-9]+)\-special\.([0-9]+)/)) && a[1] && a[2] ? (b = a[2],
        n(d = "".concat(a[1], ".")).call(d, 100 * (Number(b) + 1))) : "4.0.0.999"
    }("4.1.1")
      , Db = {
        username: "test",
        password: "111111",
      ...
      , zo = [[0, 1, 2, 3, 4, 5, 5], [0, 2, 2, 3, 4, 5, 5], [0, 3, 3, 3, 4, 5, 5], [0, 4, 4, 4, 4, 5, 5], [0, 5, 5, 5, 5, 5, 5]]
      , ek = [];
    var Zf = []
      , fk = Zf.sort
      , Ao = oa(function() {
    ...
    K({
        ...
        sort: function(c) {
            return void 0 === c ? fk.call(pb(this)) : fk.call(pb(this), mb(c))
        }
    });
    var Do = Ba("Array").sort
      , gk = Array.prototype
      , rd = function(c) {
        var a = c.sort;
        return c === gk || c instanceof Array && a === gk.sort ? Do : a
    };
    K({
        target: "Array",
        stat: !0
    ...
    var nh = function(c, a) {
      ...
      , I = {
        ...
        isBuffer: function(c) {
            return null != c && null != c.constructor && "function" == typeof c.constructor.isBuffer && c.constructor.isBuffer(c)
        },
    ...
    var kh = Gd
      ...
      , jk = function(c, a) {
        I.forEach(c, function(b, d) {
            d !== a && d.toUpperCase() === a.toUpperCase() && (c[a] = b,
            delete c[d])
        })
    }
      ...
      , Eo = "age authorization content-length content-type etag expires from host if-modified-since if-unmodified-since last-modified location max-forwards proxy-authorization referer retry-after user-agent".split(" ")
      , Fo = function(c) {
        var a, b, d, e = {};
        return c ? (I.forEach(c.split("\n"), function(c) {
            (d = c.indexOf(":"),
            a = I.trim(c.substr(0, d)).toLowerCase(),
            b = I.trim(c.substr(d + 1)),
            !a) || e[a] && 0 <= Eo.indexOf(a) || (e[a] = "set-cookie" === a ? (e[a] ? e[a] : []).concat([b]) : e[a] ? e[a] + ", " + b : b)
        }),
        e) : e
    }
      , Go = I.isStandardBrowserEnv() ? function() {
        function c(a) {
            return b && (d.setAttribute("href", a),
            a = d.href),
        ...
        var a, b = /(msie|trident)/i.test(navigator.userAgent), d = document.createElement("a");
      ...
      , Ho = I.isStandardBrowserEnv() ? {
        ...
        read: function(c) {
            return (c = document.cookie.match(new RegExp("(^|;\\s*)(" + c + ")=([^;]*)"))) ? decodeURIComponent(c[3]) : null
        },
        remove: function(c) {
      ...
      , Io = function(c) {
        return new Promise(function(a, b) {
            ...
            c.auth && (e.Authorization = "Basic " + btoa((c.auth.username || "") + ":" + (c.auth.password || "")));
            if (f.open(c.method.toUpperCase(), hk(c.url, c.params, c.paramsSerializer), !0),
            f.timeout = c.timeout,
            f.onreadystatechange = function() {
                if (f && 4 === f.readyState && (0 !== f.status || f.responseURL && 0 === f.responseURL.indexOf("file:"))) {
                    var d = "getAllResponseHeaders"in f ? Fo(f.getAllResponseHeaders()) : null;
                    d = {
                    ...
                    !e || e(d.status) ? a(d) : b(oe(Error("Request failed with status code " + d.status), d.config, null, d.request, d));
                    f = null
                }
            }
            ,
            f.onabort = function() {
                f && (b(oe(Error("Request aborted"), c, "ECONNABORTED", f, void 0)),
                f = null)
            }
            ,
            f.onerror = function() {
            ...
            f.ontimeout = function() {
                b(oe(Error("timeout of " + c.timeout + "ms exceeded"), c, "ECONNABORTED", f, void 0));
                f = null
            }
            ,
            I.isStandardBrowserEnv()) {
                var g = (c.withCredentials || Go(c.url)) && c.xsrfCookieName ? Ho.read(c.xsrfCookieName) : void 0;
                g && (e[c.xsrfHeaderName] = g)
            }
            if ("setRequestHeader"in f && I.forEach(e, function(a, b) {
                void 0 === d && "content-type" === b.toLowerCase() ? delete e[b] : f.setRequestHeader(b, a)
            }),
            ...
            "function" == typeof c.onDownloadProgress && f.addEventListener("progress", c.onDownloadProgress);
            "function" == typeof c.onUploadProgress && f.upload && f.upload.addEventListener("progress", c.onUploadProgress);
            c.cancelToken && c.cancelToken.promise.then(function(a) {
                f && (f.abort(),
                b(a),
                f = null)
            });
      ...
      , pe = {
        adapter: function() {
            var c;
            return ("undefined" != typeof process && "[object process]" === Object.prototype.toString.call(process) || "undefined" != typeof XMLHttpRequest) && (c = Io),
            c
        }(),
        transformRequest: [function(c, a) {
            return jk(a, "Accept"),
            jk(a, "Content-Type"),
            I.isFormData(c) || I.isArrayBuffer(c) || I.isBuffer(c) || I.isStream(c) || I.isFile(c) || I.isBlob(c) ? c : I.isArrayBufferView(c) ? c.buffer : I.isURLSearchParams(c) ? (jh(a, "application/x-www-form-urlencoded;charset=utf-8"),
            c.toString()) : I.isObject(c) ? (jh(a, "application/json;charset=utf-8"),
            JSON.stringify(c)) : c
        }
        ],
    ...
    var Ko = function(c, a) {
      ...
      , Lo = function(c) {
        ...
        return c.baseURL && !/^([a-z][a-z\d\+\-\.]*:)?\/\//i.test(c.url) && (c.url = Ko(c.baseURL, c.url)),
        c.headers = c.headers || {},
        ...
        (c.adapter || pe.adapter)(c).then(function(a) {
            c.cancelToken && c.cancelToken.throwIfRequested();
            return a.data = $f(a.data, a.headers, c.transformResponse),
            a
        }, function(a) {
            ik(a) || (c.cancelToken && c.cancelToken.throwIfRequested(),
            a && a.response && (a.response.data = $f(a.response.data, a.response.headers, c.transformResponse)));
      ...
      , ag = function(c, a) {
        a = a || {};
        var b = {};
        return I.forEach(["url", "method", "params", "data"], function(c) {
            void 0 !== a[c] && (b[c] = a[c])
        }),
        I.forEach(["headers", "auth", "proxy"], function(d) {
            I.isObject(a[d]) ? b[d] = I.deepMerge(c[d], a[d]) : void 0 !== a[d] ? b[d] = a[d] : I.isObject(c[d]) ? b[d] = I.deepMerge(c[d]) : void 0 !== c[d] && (b[d] = c[d])
        }),
        I.forEach("baseURL transformRequest transformResponse paramsSerializer timeout withCredentials adapter responseType xsrfCookieName xsrfHeaderName onUploadProgress onDownloadProgress maxContentLength validateStatus maxRedirects httpAgent httpsAgent cancelToken socketPath".split(" "), function(d) {
    ...
    Uc.prototype.request = function(c, a) {
        ...
        (c = ag(this.defaults, c)).method = c.method ? c.method.toLowerCase() : "get";
        var b = [Lo, void 0];
        c = Promise.resolve(c);
    ...
    Uc.prototype.getUri = function(c) {
        ...
        hk(c.url, c.params, c.paramsSerializer).replace(/^\?/, "")
    }
    ;
    I.forEach(["delete", "get", "head", "options"], function(c) {
        Uc.prototype[c] = function(a, b) {
            return this.request(I.merge(b || {}, {
                method: c,
                url: a
            }))
        }
    ...
    class Mo {
        ...
        setProxyServer(c) {
            var a;
            c ? this.uploadURL = n(a = "https://".concat(c, "/ls/?h=")).call(a, C.LOG_UPLOAD_SERVER, "&p=443&d=upload/v1") : this.uploadURL = "https://".concat(C.LOG_UPLOAD_SERVER, "/upload/v1")
        }
        log(...c) {
            var a, b, d, e;
            let f = Math.max(0, Math.min(4, c[0]));
            if (!(c[0] = oh() + " Agora-SDK [".concat(kk(f), "]:"),
            this.appendLogToWaitingList(f, c),
            f < this.logLevel)) {
                var g = oh() + " %cAgora-SDK [".concat(kk(f), "]:");
                switch (f) {
                case qb.DEBUG:
                    ...
                    break;
                case qb.INFO:
                    c = n(b = [g, "color: #1E88E5; font-weight: bold;"]).call(b, wb(c).call(c, 1));
                    console.log.apply(console, c);
                    break;
                case qb.WARNING:
                    c = n(d = [g, "color: #FB8C00; font-weight: bold;"]).call(d, wb(c).call(c, 1));
                    console.warn.apply(console, c);
                    break;
                case qb.ERROR:
                    c = n(e = [g, "color: #B00020; font-weight: bold;"]).call(e, wb(c).call(c, 1)),
        ...
        async uploadLogs() {
            ...
            c = await Cb.post(this.uploadURL, c, {
                responseType: "text"
            });
            if ("OK" !== c.data)
        ...
        uploadLogInterval() {
            if (0 !== this.uploadLogUploadingList.length || 0 !== this.uploadLogWaitingList.length) {
                var c;
                0 === this.uploadLogUploadingList.length && (this.uploadLogUploadingList = Ma(c = this.uploadLogWaitingList).call(c, 0, 10));
    ...
    class m {
        ...
        toString() {
            var c;
            return this.data ? n(c = "".concat(this.message, " data: ")).call(c, w(this.data)) : this.message
        }
        throw() {
            throw k.error(this.toString()),
            this;
        }
    }
    var lk, Ia;
      ...
      , Oo = Ka(function(c, a) {
        ...
        a.encode = function(a, c, d) {
            for (var e, f = null, g = [], k = 0, l = 0; c < d; ) {
                ...
                8191 < k && ((f || (f = [])).push(String.fromCharCode.apply(String, g)),
                k = 0)
            }
            return l && (g[k++] = b[e],
            g[k++] = 61,
            1 === l && (g[k++] = 61)),
            f ? (k && f.push(String.fromCharCode.apply(String, g.slice(0, k))),
            f.join("")) : String.fromCharCode.apply(String, g.slice(0, k))
        }
        ;
      ...
      , Ro = Ka(function(c, a) {
        a.length = function(a) {
            for (var b = 0, c = 0, f = 0; f < a.length; ++f)
                128 > (c = a.charCodeAt(f)) ? b += 1 : 2048 > c ? b += 2 : 55296 == (64512 & c) && 56320 == (64512 & a.charCodeAt(f + 1)) ? (++f,
                b += 4) : b += 3;
            return b
        }
        ;
        a.read = function(a, c, e) {
            ...
            for (var b, d = null, h = [], q = 0; c < e; )
                128 > (b = a[c++]) ? h[q++] = b : 191 < b && 224 > b ? h[q++] = (31 & b) << 6 | 63 & a[c++] : 239 < b && 365 > b ? (b = ((7 & b) << 18 | (63 & a[c++]) << 12 | (63 & a[c++]) << 6 | 63 & a[c++]) - 65536,
                h[q++] = 55296 + (b >> 10),
                h[q++] = 56320 + (1023 & b)) : h[q++] = (15 & b) << 12 | (63 & a[c++]) << 6 | 63 & a[c++],
                8191 < q && ((d || (d = [])).push(String.fromCharCode.apply(String, h)),
                q = 0);
            return d ? (q && d.push(String.fromCharCode.apply(String, h.slice(0, q))),
            d.join("")) : String.fromCharCode.apply(String, h.slice(0, q))
        }
        ;
        a.write = function(a, c, e) {
            for (var b, d, h = e, q = 0; q < a.length; ++q)
                128 > (b = a.charCodeAt(q)) ? c[e++] = b : 2048 > b ? (c[e++] = b >> 6 | 192,
                c[e++] = 63 & b | 128) : 55296 == (64512 & b) && 56320 == (64512 & (d = a.charCodeAt(q + 1))) ? (b = 65536 + ((1023 & b) << 10) + (1023 & d),
                ++q,
                c[e++] = b >> 18 | 240,
                c[e++] = b >> 12 & 63 | 128,
                c[e++] = b >> 6 & 63 | 128,
                c[e++] = 63 & b | 128) : (c[e++] = b >> 12 | 224,
                c[e++] = b >> 6 & 63 | 128,
                c[e++] = 63 & b | 128);
            return e - h
        }
    ...
    ;
    var To = Aa.zeroHash = "\x00\x00\x00\x00\x00\x00\x00\x00";
    Aa.fromNumber = function(c) {
        if (0 === c)
            return oc;
        var a = 0 > c;
        a && (c = -c);
    ...
    Aa.from = function(c) {
        if ("number" == typeof c)
            return Aa.fromNumber(c);
        if (O.isString(c)) {
            if (!O.Long)
                return Aa.fromNumber(parseInt(c, 10));
            c = O.Long.fromString(c)
        }
        return c.low || c.high ? new Aa(c.low >>> 0,c.high >>> 0) : oc
    }
    ;
    Aa.prototype.toNumber = function(c) {
        if (!c && this.hi >>> 31) {
            c = 1 + ~this.lo >>> 0;
            var a = ~this.hi >>> 0;
            return c || (a = a + 1 >>> 0),
    ...
    ;
    Aa.prototype.toLong = function(c) {
        return O.Long ? new O.Long(0 | this.lo,0 | this.hi,!!c) : {
            low: 0 | this.lo,
            high: 0 | this.hi,
            unsigned: !!c
        }
    ...
    Aa.fromHash = function(c) {
        return c === To ? oc : new Aa((Yb.call(c, 0) | Yb.call(c, 1) << 8 | Yb.call(c, 2) << 16 | Yb.call(c, 3) << 24) >>> 0,(Yb.call(c, 4) | Yb.call(c, 5) << 8 | Yb.call(c, 6) << 16 | Yb.call(c, 7) << 24) >>> 0)
    }
    ;
    Aa.prototype.toHash = function() {
        return String.fromCharCode(255 & this.lo, this.lo >>> 8 & 255, this.lo >>> 16 & 255, this.lo >>> 24, 255 & this.hi, this.hi >>> 8 & 255, this.hi >>> 16 & 255, this.hi >>> 24)
    }
    ;
    Aa.prototype.zzEncode = function() {
        var c = this.hi >> 31;
    ...
    ;
    Aa.prototype.zzDecode = function() {
        var c = -(1 & this.lo);
    ...
    ;
    Aa.prototype.length = function() {
        var c = this.lo
          , a = (this.lo >>> 28 | this.hi << 4) >>> 0
          , b = this.hi >>> 24;
        return 0 === b ? 0 === a ? 16384 > c ? 128 > c ? 1 : 2 : 2097152 > c ? 3 : 4 : 16384 > a ? 128 > a ? 5 : 6 : 2097152 > a ? 7 : 8 : 128 > b ? 9 : 10
    }
    ;
    var O = Ka(function(c, a) {
        function b(a, b, c) {
        ...
        function d(a) {
            ...
            return (c.prototype = Object.create(Error.prototype)).constructor = c,
        ...
        a.pool = So;
        a.LongBits = Aa;
        a.isNode = !!(void 0 !== Lb && Lb && Lb.process && Lb.process.versions && Lb.process.versions.node);
        a.global = a.isNode && Lb || "undefined" != typeof window && window || "undefined" != typeof self && self || Lb;
    ...
    }), Pe = Z, bg, qe = O.LongBits, mk = O.base64, nk = O.utf8, ok = function() {
    ...
    ;
    O.Array !== Array && (Z.alloc = O.pool(Z.alloc, O.Array.prototype.subarray));
    Z.prototype._push = function(c, a, b) {
        return this.tail = this.tail.next = new Vc(c,a,b),
        this.len += a,
        this
    }
    ;
    ...
    Z.prototype.uint32 = function(c) {
        return this.len += (this.tail = this.tail.next = new Me(128 > (c >>>= 0) ? 1 : 16384 > c ? 2 : 2097152 > c ? 3 : 268435456 > c ? 4 : 5,c)).len,
        this
    }
    ;
    ...
    Z.prototype.float = function(c) {
        return this._push(O.float.writeFloatLE, 4, c)
    }
    ;
    Z.prototype.double = function(c) {
        return this._push(O.float.writeDoubleLE, 8, c)
    }
    ;
    var Uo = O.Array.prototype.set ? function(c, a, b) {
        a.set(c, b)
    }
    : function(c, a, b) {
    ...
    Z.prototype.bytes = function(c) {
        var a = c.length >>> 0;
        if (!a)
            return this._push(Le, 1, 0);
        if (O.isString(c)) {
            var b = Z.alloc(a = mk.length(c));
            mk.decode(c, b, 0);
            c = b
        }
        return this.uint32(a)._push(Uo, a, c)
    }
    ;
    Z.prototype.string = function(c) {
        var a = nk.length(c);
        return a ? this.uint32(a)._push(nk.write, a, c) : this._push(Le, 1, 0)
    }
    ;
    Z.prototype.fork = function() {
        return this.states = new rl(this),
    ...
    Z.prototype.reset = function() {
        ...
        this.states = this.states.next) : (this.head = this.tail = new Vc(Ke,0,0),
        this.len = 0),
        this
    }
    ;
    Z.prototype.ldelim = function() {
        var c = this.head
          , a = this.tail
          , b = this.len;
        return this.reset().uint32(b),
        b && (this.tail.next = c.next,
        this.tail = a,
        this.len += b),
        this
    }
    ...
    yb._configure = function() {
        yb.alloc = O._Buffer_allocUnsafe;
        yb.writeBytesBuffer = O.Buffer && O.Buffer.prototype instanceof Uint8Array && "set" === O.Buffer.prototype.set.name ? function(c, a, b) {
            a.set(c, b)
        }
        : function(c, a, b) {
            if (c.copy)
                c.copy(a, b, 0, c.length);
            else
    ...
    yb.prototype.bytes = function(c) {
        O.isString(c) && (c = O._Buffer_from(c, "base64"));
        var a = c.length >>> 0;
        return this.uint32(a),
        a && this._push(yb.writeBytesBuffer, a, c),
        this
    }
    ;
    yb.prototype.string = function(c) {
        var a = O.Buffer.byteLength(c);
        return this.uint32(a),
        a && this._push(sl, a, c),
        this
    }
    ;
    yb._configure();
    var Re = sa, cg, xh = O.LongBits, Vo = O.utf8, pk = "undefined" != typeof Uint8Array ? function(c) {
    ...
    , qk = function() {
        return O.Buffer ? function(c) {
            return (sa.create = function(a) {
                return O.Buffer.isBuffer(a) ? new cg(a) : pk(a)
            }
            )(c)
        }
        : pk
    ...
    sa.create = qk();
    sa.prototype._slice = O.Array.prototype.subarray || O.Array.prototype.slice;
    sa.prototype.uint32 = (fb = 4294967295,
    function() {
        if ((fb = (127 & this.buf[this.pos]) >>> 0,
        128 > this.buf[this.pos++]) || (fb = (fb | (127 & this.buf[this.pos]) << 7) >>> 0,
        128 > this.buf[this.pos++]) || (fb = (fb | (127 & this.buf[this.pos]) << 14) >>> 0,
        128 > this.buf[this.pos++]) || (fb = (fb | (127 & this.buf[this.pos]) << 21) >>> 0,
        128 > this.buf[this.pos++]) || (fb = (fb | (15 & this.buf[this.pos]) << 28) >>> 0,
        128 > this.buf[this.pos++]))
            return fb;
    ...
    sa.prototype.bytes = function() {
        ...
        if (b > this.len)
            throw lb(this, c);
        return this.pos += c,
        Array.isArray(this.buf) ? this.buf.slice(a, b) : a === b ? new this.buf.constructor(0) : this._slice.call(this.buf, a, b)
    }
    ;
    sa.prototype.string = function() {
        var c = this.bytes();
        return Vo.read(c, 0, c.length)
    }
    ;
    sa.prototype.skip = function(c) {
        if ("number" == typeof c) {
    ...
    ;
    sa.prototype.skipType = function(c) {
        switch (c) {
        case 0:
            this.skip();
            break;
    ...
    ;
    sa._configure = function(c) {
        cg = c;
        sa.create = qk();
        cg._configure();
        var a = O.Long ? "toLong" : "toNumber";
        O.merge(sa.prototype, {
            int64: function() {
    ...
    dc._configure = function() {
        O.Buffer && (dc.prototype._slice = O.Buffer.prototype.slice)
    }
    ;
    ...
    ;
    dc._configure();
    (Wc.prototype = Object.create(O.EventEmitter.prototype)).constructor = Wc;
    Wc.prototype.rpcCall = function g(a, b, d, e, f) {
        if (!e)
            throw TypeError("request must be specified");
        var h = this;
        if (!f)
            return O.asPromise(g, h, a, b, d, e);
        if (h.rpcImpl)
            try {
                return h.rpcImpl(a, b[h.requestDelimited ? "encodeDelimited" : "encode"](e).finish(), function(b, e) {
                    if (b)
                        return h.emit("error", b, a),
                        f(b);
                    if (null !== e) {
                        if (!(e instanceof d))
                            try {
                                ...
                                return h.emit("error", T, a),
                                f(T)
                            }
                        return h.emit("data", e, a),
                        f(null, e)
                    }
                    h.end(!0)
                })
            } catch (q) {
                return h.emit("error", q, a),
    ...
    Wc.prototype.end = function(a) {
        return this.rpcImpl && (a || this.rpcImpl(null, null, null),
        this.rpcImpl = null,
        this.emit("end").off()),
        this
    }
    ;
    var Wo = Ka(function(a, b) {
        b.Service = Wc
    }), Xo = {}, Qb = Ka(function(a, b) {
        function d() {
            e.util._configure();
        ...
        e.configure = d;
        d()
    }), Ja = Qb.Reader, re = Qb.Writer, p = Qb.util, ua = Qb.roots.default || (Qb.roots.default = {}), Pc;
    ua.Events = (Pc = {},
    Pc.Message = function() {
        function a(a) {
            if (a)
        ...
        return a.prototype.id = p.Long ? p.Long.fromBits(0, 0, !1) : 0,
        ...
        a.decode = function(a, d) {
            ...
            for (var b = new ua.Events.Message; a.pos < d; ) {
                var f = a.uint32();
                switch (f >>> 3) {
                case 1:
                    b.id = a.int64();
        ...
        a.decodeDelimited = function(a) {
            return a instanceof Ja || (a = new Ja(a)),
            this.decode(a, a.uint32())
        }
        ,
        a.verify = function(a) {
            return "object" != typeof a || null === a ? "object expected" : null == a.id || !a.hasOwnProperty("id") || p.isInteger(a.id) || a.id && p.isInteger(a.id.low) && p.isInteger(a.id.high) ? null == a.msg || !a.hasOwnProperty("msg") || a.msg && "number" == typeof a.msg.length || p.isString(a.msg) ? null : "msg: buffer expected" : "id: integer|Long expected"
        }
        ,
        a.fromObject = function(a) {
            if (a instanceof ua.Events.Message)
                return a;
            var b = new ua.Events.Message;
            return null != a.id && (p.Long ? (b.id = p.Long.fromValue(a.id)).unsigned = !1 : "string" == typeof a.id ? b.id = S(a.id, 10) : "number" == typeof a.id ? b.id = a.id : "object" == typeof a.id && (b.id = (new p.LongBits(a.id.low >>> 0,a.id.high >>> 0)).toNumber())),
            null != a.msg && ("string" == typeof a.msg ? p.base64.decode(a.msg, b.msg = p.newBuffer(p.base64.length(a.msg)), 0) : a.msg.length && (b.msg = a.msg)),
            b
        }
        ,
        a.toObject = function(a, d) {
            ...
            if (d.defaults) {
                if (p.Long) {
                    ...
                    b.id = d.longs === String ? "0" : 0;
                d.bytes === String ? b.msg = "" : (b.msg = [],
                d.bytes !== Array && (b.msg = p.newBuffer(b.msg)))
            }
            return null != a.id && a.hasOwnProperty("id") && ("number" == typeof a.id ? b.id = d.longs === String ? String(a.id) : a.id : b.id = d.longs === String ? p.Long.prototype.toString.call(a.id) : d.longs === Number ? (new p.LongBits(a.id.low >>> 0,a.id.high >>> 0)).toNumber() : a.id),
            null != a.msg && a.hasOwnProperty("msg") && (b.msg = d.bytes === String ? p.base64.encode(a.msg, 0, a.msg.length) : d.bytes === Array ? wb(Array.prototype).call(a.msg) : a.msg),
            b
        }
        ,
    ...
    Pc.ProtoRaws = function() {
        ...
        return a.prototype.sendTs = p.Long ? p.Long.fromBits(0, 0, !1) : 0,
        ...
        a.encode = function(a, d) {
            if (d || (d = re.create()),
            null != a.sendTs && Object.hasOwnProperty.call(a, "sendTs") && d.uint32(8).int64(a.sendTs),
            null != a.payloads && a.payloads.length)
                for (var b = 0; b < a.payloads.length; ++b)
                    ua.Events.Message.encode(a.payloads[b], d.uint32(18).fork()).ldelim();
            return d
        }
        ,
        a.encodeDelimited = function(a, d) {
        ...
        a.decode = function(a, d) {
            a instanceof Ja || (a = Ja.create(a));
            d = void 0 === d ? a.len : a.pos + d;
            for (var b = new ua.Events.ProtoRaws; a.pos < d; ) {
                var f = a.uint32();
                switch (f >>> 3) {
                case 1:
                    b.sendTs = a.int64();
                ...
                case 2:
                    ...
                    b.payloads.push(ua.Events.Message.decode(a, a.uint32()));
                    break;
                default:
                    a.skipType(7 & f)
                }
        ...
        a.verify = function(a) {
            ...
            if (null != a.sendTs && a.hasOwnProperty("sendTs") && !(p.isInteger(a.sendTs) || a.sendTs && p.isInteger(a.sendTs.low) && p.isInteger(a.sendTs.high)))
                return "sendTs: integer|Long expected";
            if (null != a.payloads && a.hasOwnProperty("payloads")) {
                if (!cc(a.payloads))
                    return "payloads: array expected";
                for (var b = 0; b < a.payloads.length; ++b) {
                    var e = ua.Events.Message.verify(a.payloads[b]);
                    if (e)
                        return "payloads." + e
                }
            }
        ...
        ,
        a.fromObject = function(a) {
            if (a instanceof ua.Events.ProtoRaws)
                return a;
            var b = new ua.Events.ProtoRaws;
            if (null != a.sendTs && (p.Long ? (b.sendTs = p.Long.fromValue(a.sendTs)).unsigned = !1 : "string" == typeof a.sendTs ? b.sendTs = S(a.sendTs, 10) : "number" == typeof a.sendTs ? b.sendTs = a.sendTs : "object" == typeof a.sendTs && (b.sendTs = (new p.LongBits(a.sendTs.low >>> 0,a.sendTs.high >>> 0)).toNumber())),
            a.payloads) {
                if (!cc(a.payloads))
                ...
                for (var e = 0; e < a.payloads.length; ++e) {
                    ...
                    b.payloads[e] = ua.Events.Message.fromObject(a.payloads[e])
                }
            }
            return b
        }
        ...
        a.toObject = function(a, d) {
            d || (d = {});
            var b = {};
            if ((d.arrays || d.defaults) && (b.payloads = []),
            d.defaults)
                if (p.Long) {
                    var f = new p.Long(0,0,!1);
                    b.sendTs = d.longs === String ? f.toString() : d.longs === Number ? f.toNumber() : f
                } else
                    b.sendTs = d.longs === String ? "0" : 0;
            if (null != a.sendTs && a.hasOwnProperty("sendTs") && ("number" == typeof a.sendTs ? b.sendTs = d.longs === String ? String(a.sendTs) : a.sendTs : b.sendTs = d.longs === String ? p.Long.prototype.toString.call(a.sendTs) : d.longs === Number ? (new p.LongBits(a.sendTs.low >>> 0,a.sendTs.high >>> 0)).toNumber() : a.sendTs),
            a.payloads && a.payloads.length)
                for (b.payloads = [],
                f = 0; f < a.payloads.length; ++f)
                    b.payloads[f] = ua.Events.Message.toObject(a.payloads[f], d);
            return b
        }
        ,
        a.prototype.toJSON = function() {
    ...
    Pc.APWorkerEvent = function() {
        ...
        a.encode = function(a, d) {
            ...
            null != a.cname && Object.hasOwnProperty.call(a, "cname") && d.uint32(18).string(a.cname),
            ...
            null != a.success && Object.hasOwnProperty.call(a, "success") && d.uint32(56).bool(a.success),
            null != a.elapse && Object.hasOwnProperty.call(a, "elapse") && d.uint32(64).int64(a.elapse),
            ...
            null != a.serverIp && Object.hasOwnProperty.call(a, "serverIp") && d.uint32(98).string(a.serverIp),
            null != a.firstSuccess && Object.hasOwnProperty.call(a, "firstSuccess") && d.uint32(104).bool(a.firstSuccess),
            null != a.responseTime && Object.hasOwnProperty.call(a, "responseTime") && d.uint32(112).int32(a.responseTime),
            null != a.serviceName && Object.hasOwnProperty.call(a, "serviceName") && d.uint32(122).string(a.serviceName),
            null != a.responseDetail && Object.hasOwnProperty.call(a, "responseDetail") && d.uint32(130).string(a.responseDetail),
            d
        }
        ,
        a.encodeDelimited = function(a, d) {
        ...
        a.decode = function(a, d) {
            a instanceof Ja || (a = Ja.create(a));
            d = void 0 === d ? a.len : a.pos + d;
            for (var b = new ua.Events.APWorkerEvent; a.pos < d; ) {
                var f = a.uint32();
                switch (f >>> 3) {
                case 1:
                    b.sid = a.string();
        ...
        ,
        a.verify = function(a) {
            return "object" != typeof a || null === a ? "object expected" : null != a.sid && a.hasOwnProperty("sid") && !p.isString(a.sid) ? "sid: string expected" : null != a.cname && a.hasOwnProperty("cname") && !p.isString(a.cname) ? "cname: string expected" : null == a.cid || !a.hasOwnProperty("cid") || p.isInteger(a.cid) || a.cid && p.isInteger(a.cid.low) && p.isInteger(a.cid.high) ? null == a.lts || !a.hasOwnProperty("lts") || p.isInteger(a.lts) || a.lts && p.isInteger(a.lts.low) && p.isInteger(a.lts.high) ? null != a.ip && a.hasOwnProperty("ip") && !p.isString(a.ip) ? "ip: string expected" : null == a.uid || !a.hasOwnProperty("uid") || p.isInteger(a.uid) || a.uid && p.isInteger(a.uid.low) && p.isInteger(a.uid.high) ? null != a.success && a.hasOwnProperty("success") && "boolean" != typeof a.success ? "success: boolean expected" : null == a.elapse || !a.hasOwnProperty("elapse") || p.isInteger(a.elapse) || a.elapse && p.isInteger(a.elapse.low) && p.isInteger(a.elapse.high) ? null == a.peer || !a.hasOwnProperty("peer") || p.isInteger(a.peer) || a.peer && p.isInteger(a.peer.low) && p.isInteger(a.peer.high) ? null != a.ec && a.hasOwnProperty("ec") && !p.isInteger(a.ec) ? "ec: integer expected" : null != a.sc && a.hasOwnProperty("sc") && !p.isInteger(a.sc) ? "sc: integer expected" : null != a.serverIp && a.hasOwnProperty("serverIp") && !p.isString(a.serverIp) ? "serverIp: string expected" : null != a.firstSuccess && a.hasOwnProperty("firstSuccess") && "boolean" != typeof a.firstSuccess ? "firstSuccess: boolean expected" : null != a.responseTime && a.hasOwnProperty("responseTime") && !p.isInteger(a.responseTime) ? "responseTime: integer expected" : null != a.serviceName && a.hasOwnProperty("serviceName") && !p.isString(a.serviceName) ? "serviceName: string expected" : null != a.responseDetail && a.hasOwnProperty("responseDetail") && !p.isString(a.responseDetail) ? "responseDetail: string expected" : null : "peer: integer|Long expected" : "elapse: integer|Long expected" : "uid: integer|Long expected" : "lts: integer|Long expected" : "cid: integer|Long expected"
        }
        ,
        a.fromObject = function(a) {
            if (a instanceof ua.Events.APWorkerEvent)
                return a;
            var b = new ua.Events.APWorkerEvent;
            return null != a.sid && (b.sid = String(a.sid)),
            null != a.cname && (b.cname = String(a.cname)),
            null != a.cid && (p.Long ? (b.cid = p.Long.fromValue(a.cid)).unsigned = !1 : "string" == typeof a.cid ? b.cid = S(a.cid, 10) : "number" == typeof a.cid ? b.cid = a.cid : "object" == typeof a.cid && (b.cid = (new p.LongBits(a.cid.low >>> 0,a.cid.high >>> 0)).toNumber())),
            null != a.lts && (p.Long ? (b.lts = p.Long.fromValue(a.lts)).unsigned = !1 : "string" == typeof a.lts ? b.lts = S(a.lts, 10) : "number" == typeof a.lts ? b.lts = a.lts : "object" == typeof a.lts && (b.lts = (new p.LongBits(a.lts.low >>> 0,a.lts.high >>> 0)).toNumber())),
            null != a.ip && (b.ip = String(a.ip)),
            null != a.uid && (p.Long ? (b.uid = p.Long.fromValue(a.uid)).unsigned = !1 : "string" == typeof a.uid ? b.uid = S(a.uid, 10) : "number" == typeof a.uid ? b.uid = a.uid : "object" == typeof a.uid && (b.uid = (new p.LongBits(a.uid.low >>> 0,a.uid.high >>> 0)).toNumber())),
            null != a.success && (b.success = !!a.success),
            null != a.elapse && (p.Long ? (b.elapse = p.Long.fromValue(a.elapse)).unsigned = !1 : "string" == typeof a.elapse ? b.elapse = S(a.elapse, 10) : "number" == typeof a.elapse ? b.elapse = a.elapse : "object" == typeof a.elapse && (b.elapse = (new p.LongBits(a.elapse.low >>> 0,a.elapse.high >>> 0)).toNumber())),
            null != a.peer && (p.Long ? (b.peer = p.Long.fromValue(a.peer)).unsigned = !1 : "string" == typeof a.peer ? b.peer = S(a.peer, 10) : "number" == typeof a.peer ? b.peer = a.peer : "object" == typeof a.peer && (b.peer = (new p.LongBits(a.peer.low >>> 0,a.peer.high >>> 0)).toNumber())),
        ...
        a.toObject = function(a, d) {
            ...
            if (d.defaults) {
                ...
                p.Long ? (f = new p.Long(0,0,!1),
                b.lts = d.longs === String ? f.toString() : d.longs === Number ? f.toNumber() : f) : b.lts = d.longs === String ? "0" : 0;
                b.ip = "";
                p.Long ? (f = new p.Long(0,0,!1),
                b.uid = d.longs === String ? f.toString() : d.longs === Number ? f.toNumber() : f) : b.uid = d.longs === String ? "0" : 0;
                b.success = !1;
                p.Long ? (f = new p.Long(0,0,!1),
                b.elapse = d.longs === String ? f.toString() : d.longs === Number ? f.toNumber() : f) : b.elapse = d.longs === String ? "0" : 0;
                p.Long ? (f = new p.Long(0,0,!1),
                b.peer = d.longs === String ? f.toString() : d.longs === Number ? f.toNumber() : f) : b.peer = d.longs === String ? "0" : 0;
                b.ec = 0;
                b.sc = 0;
                b.serverIp = "";
                b.firstSuccess = !1;
            ...
            return null != a.sid && a.hasOwnProperty("sid") && (b.sid = a.sid),
            null != a.cname && a.hasOwnProperty("cname") && (b.cname = a.cname),
            null != a.cid && a.hasOwnProperty("cid") && ("number" == typeof a.cid ? b.cid = d.longs === String ? String(a.cid) : a.cid : b.cid = d.longs === String ? p.Long.prototype.toString.call(a.cid) : d.longs === Number ? (new p.LongBits(a.cid.low >>> 0,a.cid.high >>> 0)).toNumber() : a.cid),
            null != a.lts && a.hasOwnProperty("lts") && ("number" == typeof a.lts ? b.lts = d.longs === String ? String(a.lts) : a.lts : b.lts = d.longs === String ? p.Long.prototype.toString.call(a.lts) : d.longs === Number ? (new p.LongBits(a.lts.low >>> 0,a.lts.high >>> 0)).toNumber() : a.lts),
            null != a.ip && a.hasOwnProperty("ip") && (b.ip = a.ip),
            null != a.uid && a.hasOwnProperty("uid") && ("number" == typeof a.uid ? b.uid = d.longs === String ? String(a.uid) : a.uid : b.uid = d.longs === String ? p.Long.prototype.toString.call(a.uid) : d.longs === Number ? (new p.LongBits(a.uid.low >>> 0,a.uid.high >>> 0)).toNumber() : a.uid),
            null != a.success && a.hasOwnProperty("success") && (b.success = a.success),
            null != a.elapse && a.hasOwnProperty("elapse") && ("number" == typeof a.elapse ? b.elapse = d.longs === String ? String(a.elapse) : a.elapse : b.elapse = d.longs === String ? p.Long.prototype.toString.call(a.elapse) : d.longs === Number ? (new p.LongBits(a.elapse.low >>> 0,a.elapse.high >>> 0)).toNumber() : a.elapse),
            null != a.peer && a.hasOwnProperty("peer") && ("number" == typeof a.peer ? b.peer = d.longs === String ? String(a.peer) : a.peer : b.peer = d.longs === String ? p.Long.prototype.toString.call(a.peer) : d.longs === Number ? (new p.LongBits(a.peer.low >>> 0,a.peer.high >>> 0)).toNumber() : a.peer),
            ...
            null != a.firstSuccess && a.hasOwnProperty("firstSuccess") && (b.firstSuccess = a.firstSuccess),
            null != a.responseTime && a.hasOwnProperty("responseTime") && (b.responseTime = a.responseTime),
            null != a.serviceName && a.hasOwnProperty("serviceName") && (b.serviceName = a.serviceName),
            null != a.responseDetail && a.hasOwnProperty("responseDetail") && (b.responseDetail = a.responseDetail),
            b
        }
        ,
        a.prototype.toJSON = function() {
    ...
    Pc.WorkerEvent = function() {
        ...
        a.encode = function(a, d) {
            ...
            null != a.elapse && Object.hasOwnProperty.call(a, "elapse") && d.uint32(64).int64(a.elapse),
            null != a.peer && Object.hasOwnProperty.call(a, "peer") && d.uint32(72).int64(a.peer),
            null != a.command && Object.hasOwnProperty.call(a, "command") && d.uint32(82).string(a.command),
            null != a.actionType && Object.hasOwnProperty.call(a, "actionType") && d.uint32(90).string(a.actionType),
            null != a.url && Object.hasOwnProperty.call(a, "url") && d.uint32(98).string(a.url),
            null != a.payload && Object.hasOwnProperty.call(a, "payload") && d.uint32(106).string(a.payload),
            null != a.serverCode && Object.hasOwnProperty.call(a, "serverCode") && d.uint32(112).int32(a.serverCode),
            null != a.code && Object.hasOwnProperty.call(a, "code") && d.uint32(120).int32(a.code),
            null != a.traceId && Object.hasOwnProperty.call(a, "traceId") && d.uint32(130).string(a.traceId),
            null != a.workerType && Object.hasOwnProperty.call(a, "workerType") && d.uint32(136).int32(a.workerType),
            null != a.responseTime && Object.hasOwnProperty.call(a, "responseTime") && d.uint32(144).int32(a.responseTime),
            null != a.requestId && Object.hasOwnProperty.call(a, "requestId") && d.uint32(152).int64(a.requestId),
            null != a.packIndex && Object.hasOwnProperty.call(a, "packIndex") && d.uint32(160).int32(a.packIndex),
            null != a.requestByUser && Object.hasOwnProperty.call(a, "requestByUser") && d.uint32(168).bool(a.requestByUser),
            null != a.tid && Object.hasOwnProperty.call(a, "tid") && d.uint32(178).string(a.tid),
            null != a.productType && Object.hasOwnProperty.call(a, "productType") && d.uint32(186).string(a.productType),
            d
        }
        ,
        a.encodeDelimited = function(a, d) {
        ...
        a.decode = function(a, d) {
            a instanceof Ja || (a = Ja.create(a));
            d = void 0 === d ? a.len : a.pos + d;
            for (var b = new ua.Events.WorkerEvent; a.pos < d; ) {
                var f = a.uint32();
                switch (f >>> 3) {
                case 1:
                    b.sid = a.string();
        ...
        ,
        a.verify = function(a) {
            return "object" != typeof a || null === a ? "object expected" : null != a.sid && a.hasOwnProperty("sid") && !p.isString(a.sid) ? "sid: string expected" : null != a.cname && a.hasOwnProperty("cname") && !p.isString(a.cname) ? "cname: string expected" : null == a.cid || !a.hasOwnProperty("cid") || p.isInteger(a.cid) || a.cid && p.isInteger(a.cid.low) && p.isInteger(a.cid.high) ? null == a.lts || !a.hasOwnProperty("lts") || p.isInteger(a.lts) || a.lts && p.isInteger(a.lts.low) && p.isInteger(a.lts.high) ? null != a.ip && a.hasOwnProperty("ip") && !p.isString(a.ip) ? "ip: string expected" : null == a.uid || !a.hasOwnProperty("uid") || p.isInteger(a.uid) || a.uid && p.isInteger(a.uid.low) && p.isInteger(a.uid.high) ? null != a.success && a.hasOwnProperty("success") && "boolean" != typeof a.success ? "success: boolean expected" : null == a.elapse || !a.hasOwnProperty("elapse") || p.isInteger(a.elapse) || a.elapse && p.isInteger(a.elapse.low) && p.isInteger(a.elapse.high) ? null == a.peer || !a.hasOwnProperty("peer") || p.isInteger(a.peer) || a.peer && p.isInteger(a.peer.low) && p.isInteger(a.peer.high) ? null != a.command && a.hasOwnProperty("command") && !p.isString(a.command) ? "command: string expected" : null != a.actionType && a.hasOwnProperty("actionType") && !p.isString(a.actionType) ? "actionType: string expected" : null != a.url && a.hasOwnProperty("url") && !p.isString(a.url) ? "url: string expected" : null != a.payload && a.hasOwnProperty("payload") && !p.isString(a.payload) ? "payload: string expected" : null != a.serverCode && a.hasOwnProperty("serverCode") && !p.isInteger(a.serverCode) ? "serverCode: integer expected" : null != a.code && a.hasOwnProperty("code") && !p.isInteger(a.code) ? "code: integer expected" : null != a.traceId && a.hasOwnProperty("traceId") && !p.isString(a.traceId) ? "traceId: string expected" : null != a.workerType && a.hasOwnProperty("workerType") && !p.isInteger(a.workerType) ? "workerType: integer expected" : null != a.responseTime && a.hasOwnProperty("responseTime") && !p.isInteger(a.responseTime) ? "responseTime: integer expected" : null == a.requestId || !a.hasOwnProperty("requestId") || p.isInteger(a.requestId) || a.requestId && p.isInteger(a.requestId.low) && p.isInteger(a.requestId.high) ? null != a.packIndex && a.hasOwnProperty("packIndex") && !p.isInteger(a.packIndex) ? "packIndex: integer expected" : null != a.requestByUser && a.hasOwnProperty("requestByUser") && "boolean" != typeof a.requestByUser ? "requestByUser: boolean expected" : null != a.tid && a.hasOwnProperty("tid") && !p.isString(a.tid) ? "tid: string expected" : null != a.productType && a.hasOwnProperty("productType") && !p.isString(a.productType) ? "productType: string expected" : null : "requestId: integer|Long expected" : "peer: integer|Long expected" : "elapse: integer|Long expected" : "uid: integer|Long expected" : "lts: integer|Long expected" : "cid: integer|Long expected"
        }
        ,
        a.fromObject = function(a) {
            if (a instanceof ua.Events.WorkerEvent)
                return a;
            var b = new ua.Events.WorkerEvent;
            return null != a.sid && (b.sid = String(a.sid)),
            null != a.cname && (b.cname = String(a.cname)),
            null != a.cid && (p.Long ? (b.cid = p.Long.fromValue(a.cid)).unsigned = !1 : "string" == typeof a.cid ? b.cid = S(a.cid, 10) : "number" == typeof a.cid ? b.cid = a.cid : "object" == typeof a.cid && (b.cid = (new p.LongBits(a.cid.low >>> 0,a.cid.high >>> 0)).toNumber())),
            null != a.lts && (p.Long ? (b.lts = p.Long.fromValue(a.lts)).unsigned = !1 : "string" == typeof a.lts ? b.lts = S(a.lts, 10) : "number" == typeof a.lts ? b.lts = a.lts : "object" == typeof a.lts && (b.lts = (new p.LongBits(a.lts.low >>> 0,a.lts.high >>> 0)).toNumber())),
            ...
            null != a.responseTime && (b.responseTime = 0 | a.responseTime),
            null != a.requestId && (p.Long ? (b.requestId = p.Long.fromValue(a.requestId)).unsigned = !1 : "string" == typeof a.requestId ? b.requestId = S(a.requestId, 10) : "number" == typeof a.requestId ? b.requestId = a.requestId : "object" == typeof a.requestId && (b.requestId = (new p.LongBits(a.requestId.low >>> 0,a.requestId.high >>> 0)).toNumber())),
        ...
        a.toObject = function(a, d) {
            ...
            if (d.defaults) {
                ...
                b.responseTime = 0;
                p.Long ? (f = new p.Long(0,0,!1),
                b.requestId = d.longs === String ? f.toString() : d.longs === Number ? f.toNumber() : f) : b.requestId = d.longs === String ? "0" : 0;
                b.packIndex = 0;
                b.requestByUser = !1;
                b.tid = "";
                b.productType = ""
            ...
            null != a.responseTime && a.hasOwnProperty("responseTime") && (b.responseTime = a.responseTime),
            null != a.requestId && a.hasOwnProperty("requestId") && ("number" == typeof a.requestId ? b.requestId = d.longs === String ? String(a.requestId) : a.requestId : b.requestId = d.longs === String ? p.Long.prototype.toString.call(a.requestId) : d.longs === Number ? (new p.LongBits(a.requestId.low >>> 0,a.requestId.high >>> 0)).toNumber() : a.requestId),
            null != a.packIndex && a.hasOwnProperty("packIndex") && (b.packIndex = a.packIndex),
            null != a.requestByUser && a.hasOwnProperty("requestByUser") && (b.requestByUser = a.requestByUser),
            null != a.tid && a.hasOwnProperty("tid") && (b.tid = a.tid),
            null != a.productType && a.hasOwnProperty("productType") && (b.productType = a.productType),
            b
        }
        ,
        a.prototype.toJSON = function() {
    ...
    ;
    var A, z, pc, Rb, Ac, sd, rb, Da, B, P, qa, M, ha, sb, X, G, gb;
    !function(a) {
    ...
    var hb, Qc, ka, sk, Ea, wa, L, ib, td, ue;
    !function(a) {
    ...
    var Qa = Ka(function(a) {
      ...
      , cp = ae.concat("length", "prototype")
      , gg = {
        f: Object.getOwnPropertyNames || function(a) {
            return Ji(a, cp)
        }
    }
      , dp = Mb("Reflect", "ownKeys") || function(a) {
        var b = gg.f(Oa(a))
          , d = kd.f;
    ...
    K({
        ...
        getOwnPropertyDescriptors: function(a) {
            var b, d;
            a = db(a);
            for (var e = Fc, f = dp(a), g = {}, h = 0; f.length > h; )
    ...
    var ja = fa.Object.getOwnPropertyDescriptors
      , tk = gg.f
      , ep = {}.toString
      , uk = "object" == typeof window && window && Object.getOwnPropertyNames ? Object.getOwnPropertyNames(window) : []
      , vk = function(a) {
        if (uk && "[object Window]" == ep.call(a))
            try {
                var b = tk(a)
            } catch (d) {
                b = uk.slice()
    ...
    : Zb
      ...
      , mg = Fb && "symbol" == typeof Ta.iterator ? function(a) {
    ...
    : function(a) {
      ...
      , ve = function(a, b, d) {
        ...
        b = Dc(b, !0);
        return Oa(d),
        U(Sb, b) ? (d.enumerable ? (U(a, Sa) && a[Sa][b] && (a[Sa][b] = !1),
        d = lc(d, {
            enumerable: gc(0, !1)
        })) : (U(a, Sa) || Zb(a, Sa, gc(1, {})),
        a[Sa][b] = !0),
      ...
      , Dk = function(a, b) {
        ...
        var d = db(b);
        b = Xb(d).concat(ng(d));
        return Ic(b, function(b) {
            la && !Ck.call(d, b) || ve(a, b, d[b])
        }),
        a
    }
      , Ck = function(a) {
        a = Dc(a, !0);
        var b = hp.call(this, a);
        return !(this === tb && U(Sb, a) && !U(vd, a)) && (!(b || !U(this, a) || !U(Sb, a) || U(this, Sa) && this[Sa][a]) || b)
    }
      , Ek = function(a, b) {
        a = db(a);
        b = Dc(b, !0);
        if (a !== tb || !U(Sb, b) || U(vd, b)) {
            var d = zk(a, b);
            return !d || !U(Sb, b) || U(a, Sa) && a[Sa][b] || (d.enumerable = !0),
            d
        }
    }
      , Fk = function(a) {
    ...
    gg.f = vk = Fk,
    kd.f = ng,
    la && Zb(Ta.prototype, "description", {
        configurable: !0,
        get: function() {
            return yk(this).description
        }
    })),
    zi || (wk.f = function(a) {
        return Bk(ta(a), a)
    ...
    K({
        ...
        create: function(a, b) {
            return void 0 === b ? lc(a) : Dk(lc(a), b)
        },
        defineProperty: ve,
        defineProperties: Dk,
        getOwnPropertyDescriptor: Ek
    }),
    K({
        target: "Object",
        stat: !0,
    ...
    Ta.prototype[xk] || nb(Ta.prototype, xk, Ta.prototype.valueOf);
    hd(Ta, "Symbol");
    Hc[Sa] = !0;
    var ia = fa.Object.getOwnPropertySymbols
      , Pa = function(a, b, d) {
        return b in a ? cj(a, b, {
            value: d,
            enumerable: !0,
            configurable: !0,
            writable: !0
      ...
      , qc = function(a) {
        var b = a.values;
        return a === Gk || a instanceof Array && b === Gk.values || lp.hasOwnProperty(Xd(a)) ? kp : b
    }
      , mp = !pj(function(a) {
        Array.from(a)
    });
    K({
        ...
        from: function(a) {
            ...
            var f = 1 < e ? arguments[1] : void 0
              ...
              , h = 0;
            var q = Ci(b);
            if (g && (f = ic(f, 2 < e ? arguments[2] : void 0, 2)),
            null == q || d == Array && Ai(q))
                for (d = new d(e = ob(b.length)); e > h; h++)
                    mc(d, h, g ? f(b[h], h) : b[h]);
            else
                for (e = (b = q.call(b)).next,
                d = new d; !(q = e.call(b)).done; h++)
                    mc(d, h, g ? Di(b, f, [q.value, h], !0) : q.value);
            return d.length = h,
            d
        }
    });
    ...
    class Ua {
        ...
        getListeners(a) {
            var b;
            return this._events[a] ? D(b = this._events[a]).call(b, a=>a.listener) : []
        }
        on(a, b) {
    ...
    class np extends Ua {
        ...
        record(a, b, d) {
            ...
            if (e && (e.result.push(d),
            5 <= e.result.length)) {
                var f;
                d = La(f = e.result).call(f, !0);
                e.isPrevNormal && !d && this.emit("exception", Hk[a], a, b);
                !e.isPrevNormal && d && this.emit("exception", Hk[a] + 2E3, a + "_RECOVER", b);
                e.isPrevNormal = d;
                e.result = []
            }
        }
        ...
        checkFramerateInput(a, b) {
            let d = null;
            b._encoderConfig && b._encoderConfig.frameRate && (d = zb(b._encoderConfig.frameRate));
    ...
    class Yc {
        constructor(a) {
            ...
            this.updateStats = ()=>{
                ...
                r(a = this.remoteConnectionsMap).call(a, a=>{
                    ...
                    let r = this.trafficStats && R(b = this.trafficStats.peer_delay).call(b, b=>b.peer_uid === a.connection.getUserId());
                    m && ("opus" !== m.codec && "aac" !== m.codec || (k.codecType = m.codec),
                    m.outputLevel ? k.receiveLevel = Math.round(32767 * m.outputLevel) : a.connection.user.audioTrack && (k.receiveLevel = Math.round(32767 * a.connection.user.audioTrack.getVolumeLevel())),
                    ...
                    k.receiveBitrate = d ? 8 * Math.max(0, k.receiveBytes - d.receiveBytes) : 0,
                    ...
                    10 < k.totalDuration && Yc.isRemoteAudioFreeze(b) && (k.totalFreezeTime += 1));
                    p && ("H264" !== p.codec && "VP8" !== p.codec || (l.codecType = p.codec),
                    ...
                    p.receivedFrame ? (l.receiveFrameRate = p.receivedFrame.frameRate,
                    l.receiveResolutionHeight = p.receivedFrame.height,
                    l.receiveResolutionWidth = p.receivedFrame.width) : a.connection.user.videoTrack && (l.receiveResolutionHeight = a.connection.user.videoTrack._videoHeight || 0,
                    l.receiveResolutionHeight = a.connection.user.videoTrack._videoWidth || 0),
                    void 0 !== p.framesRateFirefox && (l.receiveFrameRate = Math.round(p.framesRateFirefox)),
                    ...
                    Yc.isRemoteVideoFreeze(a.connection.user.videoTrack, p, q) && (l.totalFreezeTime += 1),
                    l.freezeRate = l.totalFreezeTime / l.totalDuration);
                    r && (k.end2EndDelay = r.B_ad,
                    ...
                    a.videoStats = l;
                    a.pcStats = n;
                    a.connection.user.audioTrack && this.exceptionMonitor.setRemoteAudioStats(a.connection.user.audioTrack, k);
                ...
                r(d = this.localConnectionsMap).call(d, a=>{
                    ...
                    n && ("opus" !== n.codec && "aac" !== n.codec || (e.codecType = n.codec),
                    n.inputLevel ? e.sendVolumeLevel = Math.round(32767 * n.inputLevel) : a.connection.audioTrack && (e.sendVolumeLevel = Math.round(32767 * a.connection.audioTrack.getVolumeLevel())),
                    e.sendBytes = n.bytes,
                    e.sendPackets = n.packets,
                    e.sendPacketsLost = n.packetsLost,
                    e.sendBitrate = b ? 8 * Math.max(0, e.sendBytes - b.sendBytes) : 0);
                    l && ("H264" !== l.codec && "VP8" !== l.codec || (k.codecType = l.codec),
                    k.sendBytes = l.bytes,
                    k.sendBitrate = d ? 8 * Math.max(0, k.sendBytes - d.sendBytes) : 0,
                    l.inputFrame ? (k.captureFrameRate = l.inputFrame.frameRate,
                    k.captureResolutionHeight = l.inputFrame.height,
                    k.captureResolutionWidth = l.inputFrame.width) : a.connection.videoTrack && (k.captureResolutionWidth = a.connection.videoTrack._videoWidth || 0,
                    k.captureResolutionHeight = a.connection.videoTrack._videoHeight || 0),
                    l.sentFrame ? (k.sendFrameRate = l.sentFrame.frameRate,
                    k.sendResolutionHeight = l.sentFrame.height,
                    k.sendResolutionWidth = l.sentFrame.width) : a.connection.videoTrack && (k.sendResolutionWidth = a.connection.videoTrack._videoWidth || 0,
        ...
        getLocalAudioTrackStats(a) {
            return (a = this.localConnectionsMap.get(a)) && a.audioStats ? a.audioStats : Ub({}, se)
        }
        getLocalVideoTrackStats(a) {
            return (a = this.localConnectionsMap.get(a)) && a.videoStats ? a.videoStats : Ub({}, te)
        }
        getRemoteAudioTrackStats(a) {
            ...
            if (!this.trafficStats)
                return d.audioStats;
            a = R(b = this.trafficStats.peer_delay).call(b, a=>a.peer_uid === d.connection.user.uid);
            return a && (d.audioStats.publishDuration = a.B_ppad + (v() - this.trafficStats.timestamp)),
            d.audioStats
        }
        getRemoteVideoTrackStats(a) {
            ...
            if (!this.trafficStats)
                return d.videoStats;
            a = R(b = this.trafficStats.peer_delay).call(b, a=>a.peer_uid === d.connection.user.uid);
            return a && (d.videoStats.publishDuration = a.B_ppvd + (v() - this.trafficStats.timestamp)),
            d.videoStats
        }
        getRTCStats() {
            var a, b;
            ...
            r(a = this.localConnectionsMap).call(a, a=>{
                a.audioStats && (d += a.audioStats.sendBytes,
                e += a.audioStats.sendBitrate);
                a.videoStats && (d += a.videoStats.sendBytes,
                e += a.videoStats.sendBitrate)
            }
            );
            r(b = this.remoteConnectionsMap).call(b, a=>{
                a.audioStats && (f += a.audioStats.receiveBytes,
                g += a.audioStats.receiveBitrate);
                a.videoStats && (f += a.videoStats.receiveBytes,
        ...
        updateTrafficStats(a) {
            var b;
            let d = N(b = a.peer_delay).call(b, a=>{
                var b;
            ...
            r(d).call(d, a=>{
                var b, d;
                let e = R(b = Kb(qc(d = this.remoteConnectionsMap).call(d))).call(b, b=>b.connection._userId === a.peer_uid);
                void 0 !== a.B_ppad && void 0 !== a.B_ppvd && (this.onUploadPublishDuration && this.onUploadPublishDuration(a.peer_uid, a.B_ppad, a.B_ppvd, e ? v() - e.connection.startTime : 0),
        ...
        updateUplinkStats(a) {
            var b;
            this.uplinkStats && this.uplinkStats.B_fir !== a.B_fir && k.debug(n(b = "[".concat(this.clientId, "]: Period fir changes to ")).call(b, a.B_fir));
            this.uplinkStats = a
        }
    ...
    let og = ()=>{}
      , Jh = {}
      , dd = [[[100, .00520833333333333], [66.6666666666666, .00434027777777778], [66.6666666666667, .00173611111111111]], [[233.333333333333, .00347222222222222], [266.666666666667], [.00173611111111111], [183.333333333333, 2.17013888888889E-4]], [[700, .001953125], [200, .001953125], [175, 2.44140625E-4]], [[899.999999999998, .00173611111111111], [1200, 8.68055555555556E-4], [160, 2.60416666666667E-4]], [[2666.66666666667, 8.84130658436214E-4], [1166.66666666667, 8.84130658436214E-4], [600, 4.82253E-5]]];
    class op {
        constructor() {
            this.fnMap = new Y
        }
    ...
    let Jk = new op
      , Kk = za(Ik = Jk.throttleByKey).call(Ik, Jk)
      , Lk = window.AudioContext || window.webkitAudioContext
      , ed = null
      , wd = new Ua;
    (function() {
        Lk ? (ed = new Lk,
        ...
        ,
        Pl(ed)) : k.error("your browser is not support web audio")
    }
    )();
    let Ve = null
      , ea = {
    ...
    class $b {
        constructor(a) {
            ...
            this.lockId = pp++;
            a && (this.name = a);
            k.debug(n(b = "[lock-".concat(this.name, "-")).call(b, this.lockId, "] is created."))
        }
        get isLocked() {
            return 0 < this.locks
        }
        lock() {
            ...
            let d;
            this.locks += 1;
            k.debug(n(a = n(b = "[lock-".concat(this.name, "-")).call(b, this.lockId, "] is locked, current queue ")).call(a, this.locks, "."));
            let e = new u(a=>{
                d = ()=>{
                    var b, d;
                    --this.locks;
                    k.debug(n(b = n(d = "[lock-".concat(this.name, "-")).call(d, this.lockId, "] is not locked, current queue ")).call(b, this.locks, "."));
                    a()
                }
            }
            );
    ...
    class qp extends Ua {
        constructor() {
            ...
            this.init().then(()=>{
                var a, b;
                navigator.mediaDevices && navigator.mediaDevices.addEventListener && navigator.mediaDevices.addEventListener("devicechange", za(b = this.updateDevicesInfo).call(b, this));
                window.setInterval(za(a = this.updateDevicesInfo).call(a, this), 2500)
            }
        ...
        set state(a) {
            a !== this._state && (this.emit(Rb.STATE_CHANGE, a),
            this._state = a)
        }
        async enumerateDevices(a, b, d=!1) {
            ...
            let h = e = null
              , q = null;
            if (!d && (f || g)) {
                Xe.isLocked && (k.debug("[device manager] wait GUM lock"),
                (await Xe.lock())(),
                ...
                k.debug("[device manager] check media device permissions", a, b, f, g),
                f && g) {
                    try {
                    ...
                    try {
                        h = await navigator.mediaDevices.getUserMedia({
                            video: b
                        })
                    } catch (x) {
                        d = Nd(x.name || x.code || x, x.message);
            ...
            try {
                ...
                return e && r(n = e.getTracks()).call(n, a=>a.stop()),
        ...
        async getDeviceById(a) {
            ...
            if (!b)
                throw new m(l.DEVICE_NOT_FOUND,"deviceId: ".concat(a));
            return b
        }
        async init() {
            ...
            try {
                ...
                this.state = pc.IDLE,
                "boolean" == typeof isSecureContext ? isSecureContext : "https:" === location.protocol || "file:" === location.protocol || "localhost" === location.hostname || "127.0.0.1" === location.hostname || "::1" === location.hostname) || (new m(l.WEB_SECURITY_RESTRICT,"Your context is limited by web security, please try using https protocol or localhost.")).throw(),
                a;
            }
        }
        async updateDevicesInfo() {
            ...
            r(a = this.deviceInfoMap).call(a, (a,b)=>{
                "ACTIVE" === a.state && a.updateAt !== d && (a.state = "INACTIVE",
                e.push(a))
            }
            );
            this.state === pc.INITEND && r(e).call(e, a=>{
        ...
        checkMediaDeviceInfoIsOk(a) {
            let b = N(a).call(a, a=>"audioinput" === a.kind);
            a = N(a).call(a, a=>"videoinput" === a.kind);
            let d = {
                audio: !1,
                video: !1
      ...
      , Mk = function(a) {
        return function(b, d) {
            var e = 2 < arguments.length
              , f = e ? rp.call(arguments, 2) : void 0;
            return a(e ? function() {
    ...
    K({
        ...
        setTimeout: Mk(J.setTimeout),
        setInterval: Mk(J.setInterval)
    });
    var Cc = fa.setTimeout;
    let Rh = 0
      , Ye = 0
      , Nk = (a,b)=>{
        b = ua.Events[a].create(b);
        return ua.Events[a].encode(b).finish()
    }
    ;
    class tp {
        constructor() {
            ...
            this.eventUploadTimer = window.setInterval(za(a = this.doSend).call(a, this), C.EVENT_REPORT_SEND_INTERVAL);
            this.setSessionIdTimer = window.setInterval(za(b = this.appendSessionId).call(b, this), C.EVENT_REPORT_SEND_INTERVAL)
        }
        reportApiInvoke(a, b, d) {
            ...
            return {
                onSuccess: a=>{
                    ...
                    ;
                    return d ? Kk(e, b.name + "Success", d, ()=>q = !0) : e()
                }
                ,
                onError: a=>{
                    let e = ()=>{
                    ...
                    ;
                    return d ? Kk(e, b.name + "Error", d, ()=>q = !0) : e()
                }
            }
        }
        sessionInit(a, b) {
            if (!this.baseInfoMap.has(a)) {
                ...
                a.cname = b.cname;
                var e = Wa({}, {
                    willUploadConsoleLog: C.UPLOAD_LOG
                }, b.extend)
                  , f = v();
                b = xa({}, a, {
                    ...
                    build: "v4.1.1-7-g1aff811(2020/10/14 \u4e0b\u53484:22:18)",
                    lts: f,
                    elapse: f - d,
                    extend: w(e),
                    mode: b.mode,
        ...
        joinChannelTimeout(a, b) {
            if (a = this.baseInfoMap.get(a)) {
                ...
                b = xa({}, a.info, {
                    lts: d,
                    timeout: b,
                    elapse: d - a.startTime
                });
                this.send({
                    type: pa.JOIN_CHANNEL_TIMEOUT,
                    data: b
                }, !0)
            }
        }
        ...
        requestProxyAppCenter(a, b) {
            if (a = this.baseInfoMap.get(a)) {
                ...
                this.send({
                    type: pa.REQUEST_PROXY_APPCENTER,
                    data: b
                }, !0)
            }
        }
        requestProxyWorkerManager(a, b) {
            if (a = this.baseInfoMap.get(a)) {
                ...
                this.send({
                    type: pa.REQUEST_PROXY_WORKER_MANAGER,
                    data: b
                }, !0)
            }
        }
        setProxyServer(a) {
            ...
            a || (this.url = "https://".concat(C.EVENT_REPORT_DOMAIN, ":6443"),
            this.backupUrl = "https://".concat(C.EVENT_REPORT_BACKUP_DOMAIN, ":6443"))
        }
        ...
        async sendCustomReportMessage(a, b) {
            ...
            try {
                ...
                throw k.error("send custom report message failed", d.toString()),
        ...
        appendSessionId() {
            ...
            r(a = this.clientList).call(a, a=>{
                var d;
                a._sessionId && (r(d = this.apiInvokeUploadPendingItems).call(d, b=>{
                    b.sid = a._sessionId;
        ...
        send(a, b) {
            ...
            this.normalEventUploadPendingItems.length > C.NORMAL_EVENT_QUEUE_CAPACITY) && Ma(d = this.normalEventUploadPendingItems).call(d, 0, 1);
        ...
        doSend() {
            ...
            0 < this.normalEventUploadPendingItems.length && 5E3 <= v() - this.lastSendNormalEventTime && this.sendItems(this.normalEventUploadPendingItems, !1)
        }
        sendItems(a, b) {
            let d = []
              , e = [];
            for (var f = []; a.length; ) {
                let b = a.shift();
                Zo(b) ? 20 > e.length ? e.push(b) : f.push(b) : 20 > d.length ? d.push(b) : f.push(b)
            }
            a.push(...f);
            for (let a of [...d, ...e]) {
                var g, h;
                -1 !== E(g = this.ltsList).call(g, a.data.lts) ? (a.data.lts = this.ltsList[this.ltsList.length - 1] + 1,
            ...
            g = Nk("ProtoRaws", {
                sentTs: Math.round(v() / 1E3),
                payloads: D(e).call(e, a=>({
                    id: a.id,
                    msg: Nk(a.type, a.data)
                }))
            });
            h = a=>d=>{
                var e, f, g;
                b ? this.keyEventUploadPendingItems = n(e = this.keyEventUploadPendingItems).call(e, a) : (this.normalEventUploadPendingItems = n(f = this.normalEventUploadPendingItems).call(f, a),
                this.normalEventUploadPendingItems.length > C.NORMAL_EVENT_QUEUE_CAPACITY && (Ma(g = this.normalEventUploadPendingItems).call(g, 0, this.normalEventUploadPendingItems.length - C.NORMAL_EVENT_QUEUE_CAPACITY),
                k.warning("report: drop normal events")))
            }
            ;
            return e.length && this.postDataToStatsCollector(g, !0).catch(h(e)),
        ...
        async postDataToStatsCollector(a, b=!1) {
            ...
            let g = b ? "/events/proto-raws" : "/events/messages"
              , h = this.proxyServer ? n(d = n(e = "https://".concat(this.proxyServer, "/rs/?h=")).call(e, C.EVENT_REPORT_DOMAIN, "&p=6443&d=")).call(d, g) : n(f = "".concat(this.url)).call(f, g);
            for (d = 0; 2 > d; d += 1) {
                var k, l, m;
                1 === d && (h = this.proxyServer ? n(k = n(l = "https://".concat(this.proxyServer, "/rs/?h=")).call(l, C.EVENT_REPORT_BACKUP_DOMAIN, "&p=6443&d=")).call(k, g) : n(m = "".concat(this.backupUrl)).call(m, g));
                try {
                    b ? await Vl(h, {
                        timeout: 1E4,
                        data: a
    ...
    class pg extends Ua {
        ...
        set state(a) {
            ...
            "reconnecting" === this._state ? this.emit(Q.RECONNECTING, this.reconnectMode) : "connected" === this._state ? this.emit(Q.CONNECTED) : "closed" === this._state ? this.emit(Q.CLOSED) : "failed" === this._state && this.emit(Q.FAILED))
        }
        init(a) {
            return new u((b,d)=>{
                this.urls = a;
        ...
        async createWebSocketConnection(a) {
            ...
            return new u((d,e)=>{
                ...
                this.websocket.close());
                C.GATEWAY_WSS_ADDRESS && Bd(f = this.name).call(f, "gateway") && (a = C.GATEWAY_WSS_ADDRESS);
                k.debug(n(g = "[".concat(this.name, "] start connect, url: ")).call(g, a));
                try {
                    ...
                    return k.error(n(h = "[".concat(this.name, "]")).call(h, f)),
                    void e(f)
                }
                Ab(5E3).then(()=>{
                ...
                this.websocket.onclose = async a=>{
                    var b, f, g, h;
                    if (k.debug(n(b = n(f = n(g = n(h = "[".concat(this.name, "] websocket close ")).call(h, this.websocket && this.websocket.url, ", code: ")).call(g, a.code, ", reason: ")).call(f, a.reason, ", current mode: ")).call(b, this.reconnectMode)),
                    this.reconnectCount < this.retryConfig.maxRetryCount) {
                        "connected" === this.state && (this.state = "reconnecting");
                        b = ec(this, Q.WILL_RECONNECT, this.reconnectMode) || this.reconnectMode;
                        ...
                        if (!b)
                            return e(new m(l.WS_DISCONNECT,"websocket reconnect failed: ".concat(a.code))),
                            void this.close(!0);
                        d()
                    } else
        ...
        async reconnectWithAction(a, b) {
            ...
            if (!b && this.reconnectCount >= this.retryConfig.maxRetryCount || !this.urls || "closed" === this.state)
                return !1;
            this.onlineReconnectListener || !navigator || void 0 === navigator.onLine || navigator.onLine || (this.onlineReconnectListener = new u(a=>{
                let b = ()=>{
            ...
            b = Yl(this.reconnectCount, this.retryConfig);
            if (k.debug(n(d = n(e = "[".concat(this.name, "] wait ")).call(e, b, "ms to reconnect websocket, mode: ")).call(d, a)),
            await u.race([Ab(b), this.onlineReconnectListener || new u(()=>{}
            )]),
            "closed" === this.state)
                return !1;
            ...
            try {
                if ("retry" === a)
                    ...
                    k.debug(n(f = n(g = "[".concat(this.name, "] websocket url length: ")).call(g, this.urls.length, " current index: ")).call(f, this.currentURLIndex));
                    await this.createWebSocketConnection(this.urls[this.currentURLIndex])
                } else
                ...
                return k.error("[".concat(this.name, "] reconnect failed"), h.toString()),
    ...
    class up {
        ...
        add(a) {
            var b;
            (this.input.push(a),
            this.input.length > this.size) && Ma(b = this.input).call(b, 0, 1)
        }
        mean() {
            var a;
            return 0 === this.input.length ? 0 : xe(a = this.input).call(a, (a,d)=>a + d) / this.input.length
        }
    }
    class vp extends Ua {
        constructor(a) {
            super();
            this._connectionState = qa.CLOSED;
            this.openConnectionTime = v();
            this.lastMsgTime = v();
            this.uploadCache = [];
            this.rttRolling = new up(5);
            this.pingpongTimeoutCount = 0;
            this.onWebsocketMessage = a=>{
                if (a.data instanceof ArrayBuffer)
                    return void this.emit(M.ON_BINARY_DATA, a.data);
                a = JSON.parse(a.data);
                if (this.lastMsgTime = v(),
                a.hasOwnProperty("_id")) {
                    let b = "res-@".concat(a._id);
                    this.emit(b, a._result, a._message)
                } else if (a.hasOwnProperty("_type") && (this.emit(a._type, a._message),
            ...
            this.spec = a;
            this.websocket = new pg("gateway-".concat(this.clientId),this.spec.retryConfig);
            this.handleWebsocketEvents();
            window.addEventListener("offline", ()=>{
                this.connectionState === qa.CONNECTED && this.reconnect("retry", "offline")
            }
            )
        }
        get connectionState() {
        ...
        set connectionState(a) {
            ...
            a === qa.CONNECTED ? this.emit(M.WS_CONNECTED) : a === qa.RECONNECTING ? this.emit(M.WS_RECONNECTING) : a === qa.CLOSED && this.emit(M.WS_CLOSED, this._disconnectedReason))
        }
        get url() {
            return this.websocket ? this.websocket.url : null
        }
        ...
        async request(a, b, d) {
            ...
            var x = ()=>new u((a,b)=>{
                if (this.connectionState === qa.CONNECTED)
                    return a();
                const d = ()=>{
                    this.off(M.WS_CLOSED, e);
                    a()
                }
                  , e = ()=>{
                    this.off(M.WS_CONNECTED, d);
                    b(new m(l.WS_ABORT))
                }
                ;
                this.once(M.WS_CONNECTED, d);
                this.once(M.WS_CLOSED, e)
            }
            );
            this.connectionState !== qa.CONNECTING && this.connectionState !== qa.RECONNECTING || a === ha.JOIN || a === ha.REJOIN || await x();
            var v = new u((d,e)=>{
                let f = !1;
                const g = (e,g)=>{
                    f = !0;
                    ...
                    this.off(M.WS_CLOSED, h);
                    this.off(M.WS_RECONNECTING, h);
                    this.emit(M.REQUEST_SUCCESS, a, b)
                }
                ;
                ...
                ;
                this.once(M.WS_CLOSED, h);
                this.once(M.WS_RECONNECTING, h);
                Ab(C.SIGNAL_REQUEST_TIMEOUT).then(()=>{
                    this.websocket.connectionID !== t || f || (k.warning("ws request timeout, type: ".concat(a)),
                    this.emit(M.REQUEST_TIMEOUT, a, b))
                }
                )
            }
            );
            ...
            try {
                ...
                if (this.connectionState === qa.CLOSED || a === ha.LEAVE)
                    throw new m(l.WS_ABORT);
                return !this.spec.forceWaitGatewayResponse || d ? xb.throw() : a === ha.JOIN || a === ha.REJOIN ? null : (await x(),
            ...
            x = Th(d);
            v = new m(l.UNEXPECTED_RESPONSE,n(e = "".concat(x.desc, ": ")).call(e, r.message.error_str),{
                code: d,
                data: r.message
            });
            return "success" === x.action ? r.message : (k.warning(n(f = n(g = n(h = n(q = "[".concat(this.websocket.connectionID, "] unexpected response from type ")).call(q, a, ", error_code: ")).call(h, d, ", message: ")).call(g, x.desc, ", action: ")).call(f, x.action)),
            "failed" === x.action ? v.throw() : "quit" === x.action ? (this.initError = v,
            this.close(),
            v.throw()) : (d === B.ERR_JOIN_BY_MULTI_IP ? (this.multiIpOption = r.message.option,
            k.warning("[".concat(this.clientId, "] detect multi ip, recover")),
            this.reconnect("recover")) : this.reconnect(x.action),
            a === ha.JOIN || a === ha.REJOIN ? null : await this.request(a, b)))
        }
        waitMessage(a, b) {
            return new u(d=>{
                let e = f=>{
        ...
        upload(a, b) {
            ...
            try {
                ...
                this.uploadCache.length > b) && Ma(d = this.uploadCache).call(d, 0, 1);
        ...
        init(a) {
            ...
            new u((b,d)=>{
                this.once(M.WS_CONNECTED, ()=>b(this.joinResponse));
                this.once(M.WS_CLOSED, ()=>d(this.initError || new m(l.WS_ABORT)));
                this.connectionState = qa.CONNECTING;
        ...
        close(a) {
            ...
            this.connectionState = qa.CLOSED;
            this.websocket.close()
        }
        async join() {
            var a;
            if (!this.joinResponse) {
                var b = ad(this, M.REQUEST_JOIN_INFO);
                b = await this.request(ha.JOIN, b);
                if (!b)
                    return this.emit(M.REPORT_JOIN_GATEWAY, l.TIMEOUT, this.url || ""),
                    !1;
                this.joinResponse = b;
                this.reconnectToken = this.joinResponse.rejoin_token
            }
            return this.connectionState = qa.CONNECTED,
            this.pingpongTimer && window.clearInterval(this.pingpongTimer),
            this.pingpongTimer = window.setInterval(za(a = this.handlePingPong).call(a, this), 3E3),
            !0
        }
        async rejoin() {
            var a, b;
            ...
            var d = ad(this, M.REQUEST_REJOIN_INFO);
            d.token = this.reconnectToken;
            d = await this.request(ha.REJOIN, d);
            return !!d && (this.connectionState = qa.CONNECTED,
            this.pingpongTimer && window.clearInterval(this.pingpongTimer),
            this.pingpongTimer = window.setInterval(za(a = this.handlePingPong).call(a, this), 3E3),
            d.peers && r(b = d.peers).call(b, a=>{
                this.emit(X.ON_USER_ONLINE, {
                    uid: a.uid
                });
                a.audio_mute ? this.emit(X.MUTE_AUDIO, {
                    uid: a.uid
                }) : this.emit(X.UNMUTE_AUDIO, {
                    uid: a.uid
                });
                a.video_mute ? this.emit(X.MUTE_VIDEO, {
                    uid: a.uid
                }) : this.emit(X.UNMUTE_VIDEO, {
                    uid: a.uid
                });
                a.audio_enable_local ? this.emit(X.ENABLE_LOCAL_AUDIO, {
                    uid: a.uid
                }) : this.emit(X.DISABLE_LOCAL_AUDIO, {
                    uid: a.uid
                });
                a.video_enable_local ? this.emit(X.ENABLE_LOCAL_VIDEO, {
                    uid: a.uid
                }) : this.emit(X.DISABLE_LOCAL_VIDEO, {
                    uid: a.uid
                });
                a.audio || a.video || this.emit(X.ON_REMOVE_STREAM, {
                    uid: a.uid,
                    uint_id: a.uint_id
                });
                a.audio && this.emit(X.ON_ADD_AUDIO_STREAM, {
                    uid: a.uid,
                    uint_id: a.uint_id,
                    audio: !0
                });
                a.video && this.emit(X.ON_ADD_VIDEO_STREAM, {
                    uid: a.uid,
                    uint_id: a.uint_id,
                    video: !0
                })
        ...
        handleNotification(a) {
            ...
            a = Th(a.code);
            "success" !== a.action && ("failed" !== a.action ? "quit" !== a.action ? this.reconnect(a.action) : this.close() : k.error("[".concat(this.clientId, "] ignore error: "), a.desc))
        }
        handlePingPong() {
            if (this.websocket && "connected" === this.websocket.state) {
                ...
                b - this.lastMsgTime > C.WEBSOCKET_TIMEOUT_MIN) ? this.reconnect() : this.request(ha.PING, void 0, !0).then(()=>{
                    this.pingpongTimeoutCount = 0;
                    let a = v() - b;
                    this.rttRolling.add(a);
                    C.REPORT_STATS && this.send(ha.PING_BACK, {
                        pingpongElapse: a
                    })
                }
                ).catch(a=>{}
        ...
        handleWebsocketEvents() {
            ...
            this.websocket.on(Q.RECONNECTING, a=>{
                this.joinResponse = void 0;
                this.connectionState === qa.CONNECTED ? this.connectionState = qa.RECONNECTING : this.connectionState = qa.CONNECTING
            }
            );
            this.websocket.on(Q.WILL_RECONNECT, (a,b)=>{
                if (ad(this, M.IS_P2P_DISCONNECTED) && "retry" === a)
                    return this.reconnectToken = void 0,
                    this.emit(M.NEED_RENEW_SESSION),
            ...
            this.websocket.on(Q.CONNECTED, ()=>{
                ...
                this.reconnectToken ? this.rejoin().catch(a=>{
                    var b;
                    k.warning(n(b = "[".concat(this.clientId, "] rejoin failed ")).call(b, a));
                    this.reconnect("tryNext")
                }
                ) : this.join().catch(a=>{
                    if (this.emit(M.REPORT_JOIN_GATEWAY, a.code, this.url || ""),
                    a instanceof m && a.code === l.UNEXPECTED_RESPONSE && a.data.code === B.ERR_NO_AUTHORIZED)
                    ...
                    this.spec.forceWaitGatewayResponse ? this.reconnect("tryNext") : (this.initError = a,
                    this.close())
                }
                )
            }
            ...
            this.websocket.on(Q.REQUEST_NEW_URLS, (a,b)=>{
                Ha(this, M.REQUEST_RECOVER, this.multiIpOption).then(a).catch(b)
            }
            )
        }
    }
    ...
    class qg extends Ok {
        constructor(a, b) {
            ...
            ;
            this._enabledMutex = new $b("".concat(b));
        ...
        close() {
            ...
            this._enabledMutex = this._originMediaStreamTrack = null;
        ...
        async _registerTrackProcessor(a) {
            ...
            if (-1 === E(b = this._trackProcessors).call(b, a)) {
                ...
                ;
                d ? (d.onOutputChange = async()=>{
                    d.output && await a.setInput(d.output)
                }
                ,
                await a.setInput(d.output || d.input || this._originMediaStreamTrack)) : await a.setInput(this._originMediaStreamTrack)
            }
        }
    ...
    class Pk extends Ua {
        constructor() {
            ...
            this.audioOutputLevelCacheMaxLength = C.AUDIO_SOURCE_AVG_VOLUME_DURATION / C.AUDIO_SOURCE_VOLUME_UPDATE_INTERVAL || 15;
            this.isDestroyed = !1;
        ...
        getAudioAvgLevel() {
            ...
            return xe(a = this.audioOutputLevelCache).call(a, (a,d)=>a + d) / this.audioOutputLevelCache.length
        }
        getAudioVolume() {
        ...
        connect() {
            ...
            this.updateAudioOutputLevelInterval = window.setInterval(za(a = this.updateAudioOutputLevel).call(a, this), C.AUDIO_SOURCE_VOLUME_UPDATE_INTERVAL || 400)
        }
        updateAudioOutputLevel() {
            ...
            this.analyserNode) {
                if (this.analyserNode.getFloatTimeDomainData) {
                    ...
                    let d = !0;
                    a = new Float32Array(D(b = Kb(a)).call(b, a=>(128 !== a && (d = !1),
                    .0078125 * (a - 128))));
    ...
    class Qk extends Pk {
        constructor(a, b) {
            ...
            this.audioElement.srcObject = a;
            a = va();
            b && a.os === aa.IOS && (wd.on("state-change", this.rebuildWebAudio),
            this.onNoAudioInput = ()=>{
    ...
    class wp {
        ...
        play(a, b) {
            if (!this.elementMap.has(b)) {
                ...
                (a = this.sinkIdMap.get(b)) && d.setSinkId(a).catch(a=>{
                    k.warning("[".concat(b, "] set sink id failed"), a.toString())
                }
                );
                (a = d.play()) && a.then && a.catch(a=>{
    ...
    class Va extends qg {
        ...
        setVolume(a) {
            ...
            try {
                ...
                Ya(this, L.NEED_REPLACE_TRACK, this._mediaStreamTrack).then(()=>{
        ...
        async setPlaybackDevice(a) {
            ...
            if (!this._useAudioElement)
                throw new m(l.NOT_SUPPORTED,"your browser does not support setting the audio output device");
            try {
        ...
        async setEnabled(a) {
            ...
            if (a !== this._enabled) {
                ...
                k.info(n(b = "[".concat(this.getTrackId(), "] setEnabled to ")).call(b, a, " success"));
                this._enabled = !0;
                d()
            }
        }
        ...
        setAudioFrameCallback(a, b=4096) {
            if (!a)
                return this._source.removeAllListeners(gb.ON_AUDIO_BUFFER),
        ...
        play() {
            ...
            jb.play(this._mediaStreamTrack, this.getTrackId())) : this._source.play();
            a.onSuccess()
        }
        stop() {
            let a = t.reportApiInvoke(null, {
    ...
    class rg extends Va {
        ...
        async setDevice(a) {
            ...
            k.info(n(b = "[".concat(this.getTrackId, "] start set device to ")).call(b, a));
            try {
                ...
                try {
                    ...
                    throw k.error("[track-".concat(this.getTrackId(), "] setDevice failed"), g.toString()),
                    d = await Bb({
                ...
                throw e.onError(f),
                k.error("[track-".concat(this.getTrackId(), "] setDevice error"), f.toString()),
                f;
            }
            e.onSuccess();
            k.info(n(d = "[".concat(this.getTrackId, "] set device to ")).call(d, a, " success"))
        }
    ...
    class Rc extends Va {
        ...
        addAudioTrack(a) {
            var b;
            -1 === E(b = this.trackList).call(b, a) ? (k.debug("add ".concat(a.getTrackId(), " to mixing track")),
    ...
    class yp extends Ua {
        ...
        set state(a) {
            if (a !== this._state) {
                var b = this._state;
                this._state = a;
                "DISCONNECTED" === a && this._disconnectedReason ? this.emit(wa.CONNECTION_STATE_CHANGE, a, b, this._disconnectedReason) : this.emit(wa.CONNECTION_STATE_CHANGE, a, b)
            }
        }
        async join(a, b) {
            var d;
            ...
            try {
                ...
                throw k.error("[".concat(this.clientId, "] User join failed"), g.toString()),
                t.joinGateway(a.sid, {
                    lts: e,
                    succ: !1,
            ...
            this.networkQualityInterval = window.setInterval(()=>{
                ...
                }) : "CONNECTED" === this.state && this._statsCollector.trafficStats ? this.emit(wa.NETWORK_QUALITY, {
                    uplinkNetworkQuality: Gh(this._statsCollector.trafficStats.B_unq),
                    downlinkNetworkQuality: Gh(this._statsCollector.trafficStats.B_dnq)
                }) : this.emit(wa.NETWORK_QUALITY, {
        ...
        async leave(a=!1) {
            if ("DISCONNECTED" !== this.state) {
                ...
                try {
                    if (!a && this.signal.connectionState === qa.CONNECTED) {
                        var b = this.signal.request(ha.LEAVE, void 0, !0);
                        await (3E3 === 1 / 0 ? b : u.race([b, Jl(3E3)]))
                    }
                } catch (d) {
                    k.warning("[".concat(this.clientId, "] leave request failed, ignore"), d)
                }
                this.signal.close();
                this.reset();
        ...
        async publish(a, b) {
            ...
            let d = a.getUserId()
              , e = a.videoTrack ? yl(a.videoTrack) : {};
            if (a.on(G.NEED_ANSWER, (f,g,h)=>{
                var q;
                let n = {
                    state: "offer",
                    stream_type: b,
                    ...
                    audio: !!a.audioTrack,
                    video: !!a.videoTrack,
                    screen: a.videoTrack && -1 !== E(q = a.videoTrack._hints).call(q, ib.SCREEN_TRACK),
                    attributes: e,
                ...
                this.signal.request(ha.PUBLISH, n, !0).then(a=>{
                    d && this.needToSendUnpubUnsub.set(d, !0);
                    g(JSON.parse(a.sdp))
                }
                ).catch(b=>{
                    if (f.retry && b.data && b.data.code === B.ERR_PUBLISH_REQUEST_INVALID)
            ...
            a.on(G.NEED_RENEGOTIATE, (d,e,h)=>{
                this.signal.request(ha.PUBLISH, {
                    state: "negotiation",
                    stream_type: b,
                    p2p_id: a.pc.ID,
                    sdp: d
            ...
            a.on(G.NEED_UNPUB, e=>d && !this.needToSendUnpubUnsub.has(d) ? e(!1) : "RECONNECTING" === this.state ? e(!0) : void this.signal.request(ha.UNPUBLISH, {
            ...
            "RECONNECTING" !== this.state) {
                if ("CONNECTED" !== this.state)
                    return (new m(l.INVALID_OPERATION,"can not publish when connection state is ".concat(this.state))).throw();
        ...
        async subscribe(a) {
            ...
            if (a.on(G.NEED_ANSWER, (d,e,f)=>{
                ...
                this.signal.request(ha.SUBSCRIBE, g, !0).then(a=>{
                    this.needToSendUnpubUnsub.set(b, !0);
                    e(JSON.parse(a.sdp))
                }
                ).catch(b=>{
                    if (d.retry && b.data && b.data.code === B.ERR_SUBSCRIBE_REQUEST_INVALID)
            ...
            a.on(G.NEED_UNSUB, d=>this.needToSendUnpubUnsub.has(b) ? "RECONNECTING" === this.state ? d(!0) : void this.signal.request(ha.UNSUBSCRIBE, {
                stream_id: a.getUserId()
            }, !0).then(()=>d(!1)).catch(a=>{
            ...
            "RECONNECTING" !== this.state) {
                if ("CONNECTED" !== this.state)
                    return (new m(l.INVALID_OPERATION,"can not subscribe when connection state is ".concat(this.state))).throw();
                await a.startP2PConnection()
            } else
                a.readyToReconnectPC()
        }
        async subscribeChange(a, b) {
            ...
            "RECONNECTING" !== this.state) {
                if ("CONNECTED" !== this.state)
                    return (new m(l.INVALID_OPERATION,"can not subscribe change when connection state is ".concat(this.state))).throw();
                k.debug(n(d = n(e = "[".concat(this.clientId, "] send subscribe change, audio: ")).call(e, b.audio, ", video: ")).call(d, b.video));
                await this.signal.request(ha.SUBSCRIBE_CHANGE, {
                    stream_id: a.getUserId(),
                    audio: !!b.audio,
                    video: !!b.video
                }, !0)
        ...
        renewToken(a) {
            return this.signal.request(ha.RENEW_TOKEN, {
                token: a
            })
        }
        async setClientRole(a) {
            a !== this.role && ("CONNECTED" === this.state ? (await this.signal.request(ha.SET_CLIENT_ROLE, {
                role: a
            }),
        ...
        getInChannelInfo() {
            return this.inChannelInfo.joinAt && (this.inChannelInfo.duration = v() - this.inChannelInfo.joinAt),
        ...
        reset() {
            if (this.inChannelInfo.joinAt && (this.inChannelInfo.duration = v() - this.inChannelInfo.joinAt,
        ...
        updateTurnConfigFromSignal() {
            if (this.joinInfo) {
                ...
                (a = (a = (this.signal.url || "").match(/wss:\/\/([^:]+):(\d+)/)) ? {
                    ...
                    udpport: S(a[2]) + 30,
                    forceturn: !1
                } : null) && "off" !== this.joinInfo.turnServer.mode && this.joinInfo.turnServer.servers.push(af({}, Db, {
        ...
        async updateTrafficStats() {
            ...
            if ("CONNECTED" === this.state) {
                ...
                r(a = b.peer_delay).call(a, a=>{
                    var b;
                    let d = this._statsCollector.trafficStats && R(b = this._statsCollector.trafficStats.peer_delay).call(b, b=>b.peer_uid === a.peer_uid);
                    d && d.B_st !== a.B_st && Za(()=>{
        ...
        getJoinMessage() {
            ...
            if (this.joinInfo.aesmode && this.joinInfo.aespassword)
                if (b.aes_mode = this.joinInfo.aesmode,
                C.ENCRYPT_AES) {
                    ...
                    if (0 !== g) {
                        var h = new d.constructor(d.length + g);
                    ...
                    h = new Uint32Array(f.length + d.length);
                    f = (h.set(f, 0),
                    h.set(d, f.length),
                    h);
                    for (d = 0; d < f.length; d++)
                        f[d] ^= e,
                        f[d] = ~f[d];
                    e = Kh(new Uint8Array(f.buffer));
                    b.aes_secret = e;
                    b.aes_encrypt = !0
                } else
                    b.aes_secret = this.joinInfo.aespassword;
            return a.addresses[this.signal.websocket.currentURLIndex] && (b.ap_response.ticket = a.addresses[this.signal.websocket.currentURLIndex].ticket,
            delete a.addresses),
            b
        }
        getRejoinMessage() {
        ...
        handleSignalEvents() {
            this.signal.on(M.WS_RECONNECTING, ()=>{
            ...
            this.signal.on(M.WS_CLOSED, a=>{
                this.reset();
                this._disconnectedReason = a;
                this.state = "DISCONNECTED"
            }
            );
            this.signal.on(M.WS_CONNECTED, ()=>{
            ...
            this.signal.on(M.REQUEST_RECOVER, (a,b,d)=>{
                if (!this.joinInfo)
                ...
                Ha(this, wa.REQUEST_NEW_GATEWAY_LIST).then(b).catch(d)
            }
            );
            this.signal.on(M.REQUEST_JOIN_INFO, a=>{
                a(this.getJoinMessage())
            }
            );
            this.signal.on(M.REQUEST_REJOIN_INFO, a=>{
                a(this.getRejoinMessage())
            }
            );
            this.signal.on(M.REPORT_JOIN_GATEWAY, (a,b)=>{
                this.joinInfo && t.joinGateway(this.joinInfo.sid, {
                    lts: this.joinGatewayStartTime,
                    succ: !1,
                    ec: a,
            ...
            this.signal.on(M.IS_P2P_DISCONNECTED, a=>{
                a(ad(this, wa.IS_P2P_DISCONNECTED))
            }
            );
            this.signal.on(M.DISCONNECT_P2P, ()=>{
                this.needToSendUnpubUnsub = new Y;
                this.emit(wa.DISCONNECT_P2P)
            }
            );
            this.signal.on(M.NEED_RENEW_SESSION, ()=>{
                this.emit(wa.NEED_RENEW_SESSION)
            }
            );
            this.signal.on(M.REQUEST_SUCCESS, ()=>{
                this._signalTimeout = !1
            }
            );
            this.signal.on(M.REQUEST_TIMEOUT, ()=>{
    ...
    class zp {
        ...
        updateConfig(a, b) {
            if (b) {
                null != b.uploadLog && (vc("UPLOAD_LOG", b.uploadLog),
                ...
                null != b.dualStream && (this.client._isDualStreamEnabled = b.dualStream,
                t.reportApiInvoke(this.client._sessionId || null, {
                    name: A.SET_CONFIG_DISTRIBUTE,
                    options: {
                        feature: "dualStream",
                ...
                null == b.streamFallbackOptions || (this.client._defaultStreamFallbackType = b.streamFallbackOptions);
                try {
                    var d, e;
                    k.debug(n(d = "[".concat(a, "] setParameter in distribution: ")).call(d, w(b)));
                    D(e = V(b)).call(e, a=>vc(a, b[a]))
                } catch (g) {
                    var f;
                    k.debug(n(f = "[".concat(a, "] setParameter in distribution failed: ")).call(f, w(b)))
                }
            }
        }
    }
    ...
    var tg = function() {
        ...
        return (ug = Object.assign || function(a) {
        ...
        a.prototype.calcLossRate = function(a) {
            ...
            for (var e = this.lossRateWindowStats.length, f = 0, g = 0, h = 0, k = 0, l = function(d) {
                a[d].forEach(function(a, q) {
                    if (b.lossRateWindowStats[e - 1][d][q] && b.lossRateWindowStats[0][d][q]) {
                        var l = b.lossRateWindowStats[e - 1][d][q].packets - b.lossRateWindowStats[0][d][q].packets;
                        q = b.lossRateWindowStats[e - 1][d][q].packetsLost - b.lossRateWindowStats[0][d][q].packetsLost;
                        "videoSend" === d || "audioSend" === d ? (f += l,
                        h += q) : (g += l,
                        k += q);
                        Number.isNaN(l) || Number.isNaN(l) ? a.packetLostRate = 0 : a.packetLostRate = 0 >= l || 0 >= q ? 0 : q / l
                    }
                })
            }, n = 0, m = ["videoSend", "audioSend", "videoRecv", "audioRecv"]; n < m.length; n++)
                l(m[n]);
        ...
        b.prototype.processSSRCStats = function(a) {
            ...
            a.forEach(function(a) {
                ...
                case "video_recv":
                    ...
                    d.packetsLost = Number(a.packetsLost),
                    d.ssrc = Number(a.ssrc),
                    0 < d.packets && !b.isFirstVideoReceived && (b.onFirstVideoReceived && b.onFirstVideoReceived(),
                    b.isFirstVideoReceived = !0),
                    0 < d.framesDecodeCount && !b.isFirstVideoDecoded && (b.onFirstVideoDecoded && b.onFirstVideoDecoded(d.decodedFrame.width, d.decodedFrame.height),
                    ...
                    e) {
                        ...
                        d.framesDecodeCount > a.framesDecodeCount ? (e.lts = Date.now(),
                        d.framesDecodeInterval = f,
                        500 <= d.framesDecodeInterval && (d.framesDecodeFreezeTime += d.framesDecodeInterval)) : d.framesDecodeCount < e.stats.framesDecodeCount && (d.framesDecodeInterval = 0)
                    }
                ...
                case "audio_recv":
                    ...
                    d.droppedFrames = Number(a.googDecodingPLC) + Number(a.googDecodingPLCCNG) || Number(a.packetsLost);
                    0 < d.receivedFrames && !b.isFirstAudioReceived && (b.onFirstAudioReceived && b.onFirstAudioReceived(),
                    b.isFirstAudioReceived = !0);
                    0 < d.decodingNormal && !b.isFirstAudioDecoded && (b.onFirstAudioDecoded && b.onFirstAudioDecoded(),
                ...
                case "audio_send":
                    ...
                    d.aecReturnLossEnhancement = Number(a.googEchoCancellationReturnLossEnhancement || 0),
                    d.residualEchoLikelihood = Number(a.googResidualEchoLikelihood || 0),
                    d.residualEchoLikelihoodRecentMax = Number(a.googResidualEchoLikelihoodRecentMax || 0),
                    d.bytes = Number(a.bytesSent),
                    d.packets = Number(a.packetsSent),
                    d.packetsLost = Number(a.packetsLost),
                    d.ssrc = Number(a.ssrc),
    ...
    var Vk = function(a) {
        ...
        b.prototype.processVideoInboundStats = function(a) {
            ...
            if (d) {
                ...
                b.framesDecodeCount > k.framesDecodeCount ? (d.lts = Date.now(),
                b.framesDecodeInterval = l,
                500 <= b.framesDecodeInterval && (b.framesDecodeFreezeTime += b.framesDecodeInterval)) : b.framesDecodeCount < k.framesDecodeCount && (b.framesDecodeInterval = 0)
            }
            if (g && 800 <= h - g.lts ? (b.decodeFrameRate = Math.round((b.framesDecodeCount - g.count) / ((h - g.lts) / 1E3)),
            this.lastVideoFramesDecode.set(b.ssrc, {
                count: b.framesDecodeCount,
                lts: h,
                rate: b.decodeFrameRate
            })) : g ? b.decodeFrameRate = g.rate : this.lastVideoFramesDecode.set(b.ssrc, {
                count: b.framesDecodeCount,
                lts: h,
                rate: 0
            }),
        ...
        b.prototype.processVideoOutboundStats = function(a) {
            ...
            d ? d.add(a.bytesSent) : ((g = new tg(10)).add(a.bytesSent),
            this.mediaBytesSent.set(a.ssrc, g));
            void 0 !== a.retransmittedBytesSent && ((d = this.mediaBytesRetransmit.get(a.ssrc)) ? d.add(a.retransmittedBytesSent) : ((g = new tg(10)).add(a.retransmittedBytesSent),
            this.mediaBytesRetransmit.set(a.ssrc, g)));
            if (a.totalEncodedBytesTarget) {
                var g;
                (d = this.mediaBytesTargetEncode.get(a.ssrc)) ? d.add(a.totalEncodedBytesTarget) : ((g = new tg(10)).add(a.totalEncodedBytesTarget),
            ...
            a.totalEncodeTime && a.framesEncoded)
                ...
                b.avgEncodeMs = !d || d.lastFrameCount > a.framesEncoded ? 1E3 * a.totalEncodeTime / a.framesEncoded : 1E3 * (a.totalEncodeTime - d.lastEncoderTime) / (a.framesEncoded - d.lastFrameCount),
            ...
            a.remoteId) ? this.processRemoteInboundStats(a.remoteId, b) : (d = this.findRemoteStatsId(a.ssrc, ac.REMOTE_INBOUND)) && this.processRemoteInboundStats(d, b)
        }
        ,
        ...
        b.prototype.processVideoTrackSenderStats = function(a, b) {
            if (a = this.report.get(a)) {
                ...
                h && 800 <= e - h.lts ? (d = Math.round((a.framesSent - h.count) / ((e - h.lts) / 1E3)),
                this.lastVideoFramesSent.set(b.ssrc, {
                    count: a.framesSent,
                    lts: e,
                    rate: d
                })) : h ? d = h.rate : this.lastVideoFramesSent.set(b.ssrc, {
                    count: a.framesSent,
                    lts: e,
                    rate: 0
                });
        ...
        b.prototype.processVideoTrackReceiverStats = function(a, b) {
            if (a = this.report.get(a)) {
                ...
                var h = 0;
                d && 800 <= e - d.lts ? (h = Math.round((a.framesReceived - d.count) / ((e - d.lts) / 1E3)),
                this.lastVideoFramesRecv.set(b.ssrc, {
                    count: a.framesReceived,
                    lts: e,
                    rate: h
                })) : d ? h = d.rate : this.lastVideoFramesRecv.set(b.ssrc, {
                    count: a.framesReceived,
                    lts: e,
                    rate: 0
                });
                ...
                a.jitterBufferDelay && a.jitterBufferEmittedCount && (b.jitterBufferMs = 1E3 * a.jitterBufferDelay / a.jitterBufferEmittedCount,
        ...
        b.prototype.processAudioTrackReceiverStats = function(a, b) {
            if (a = this.report.get(a)) {
                a.removedSamplesForAcceleration && a.totalSamplesReceived && (b.accelerateRate = a.removedSamplesForAcceleration / a.totalSamplesReceived);
                a.jitterBufferDelay && a.jitterBufferEmittedCount && (b.jitterBufferMs = 1E3 * a.jitterBufferDelay / a.jitterBufferEmittedCount);
                b.outputLevel = a.audioLevel;
                var d = 1920;
                a.totalSamplesDuration && a.totalSamplesReceived && (d = a.totalSamplesReceived / a.totalSamplesDuration / 50,
    ...
    class Wk {
        constructor(a) {
            ...
            void 0 === d && (d = 8);
            var e;
            this.statsFilter = (e = (e = navigator.userAgent.toLocaleLowerCase().match(/chrome\/[\d]./i)) && e[0] ? Number(e[0].split("/")[1]) : null) ? 76 > e ? new Ap(a,{
                updateInterval: b,
                lossRateInterval: d
            }) : new Vk(a,{
                updateInterval: b,
                lossRateInterval: d
            }) : window.RTCStatsReport && a.getStats()instanceof Promise ? new Vk(a,{
                updateInterval: b,
                lossRateInterval: d
            }) : new Bp(a,{
                updateInterval: b,
        ...
        async createOfferSDP() {
            try {
                ...
                a.sdp=a.sdp.replace('useinbandfec=1','useinbandfec=1; maxaveragebitrate=256000; stereo=1;');
                console.log("createOfferSDP "+a.sdp);
                return a.sdp
            } catch (a) {
        ...
        async setOfferSDP(a) {
            a=a.replace('useinbandfec=1','useinbandfec=1; maxaveragebitrate=256000; stereo=1;');
            console.log("setOfferSDP "+a);
            try {
        ...
        createPeerConnection() {
            ...
            var b;
            this.spec.iceServers ? a.iceServers = this.spec.iceServers : this.spec.turnServer && "off" !== this.spec.turnServer.mode && r(b = this.spec.turnServer.servers).call(b, b=>{
                var d, f;
                (a.iceServers && a.iceServers.push({
                    username: b.username,
                    credential: b.password,
                    credentialType: "password",
                    urls: n(d = "turn:".concat(b.turnServerURL, ":")).call(d, b.udpport, "?transport=udp")
                }),
                b.tcpport) && a.iceServers && a.iceServers.push({
                    username: b.username,
                    credential: b.password,
                    credentialType: "password",
                    urls: n(f = "turn:".concat(b.turnServerURL, ":")).call(f, b.tcpport, "?transport=tcp")
                });
                b.forceturn && (a.iceTransportPolicy = "relay")
            }
            );
            C.CHROME_FORCE_PLAN_B && Te() && (a.sdpSemantics = "plan-b",
            ea.supportUnifiedPlan = !1);
    ...
    class Yk extends Wk {
        ...
        async replaceTrack(a) {
            if (!ea.supportReplaceTrack) {
                ...
                if (!b)
                    throw new m(l.UNEXPECTED_ERROR,"can not find replaced track");
        ...
        async addTrack(a) {
            ...
            let d, e;
            this.mediaStream.addTrack(a);
            b.supportUnifiedPlan ? (d = await im(this.pc, a),
            e = d.sender) : e = this.pc.addTrack(a, this.mediaStream);
            "audio" === a.kind ? (this.audioTrack = a,
            this.audioSender = e,
            this.audioTransceiver = d) : (this.videoTrack = a,
            this.videoSender = e,
        ...
        getSender(a) {
            ...
            if (ea.supportUnifiedPlan) {
                var d;
                b = (b = R(d = this.pc.getTransceivers()).call(d, b=>b.sender.track && b.sender.track.kind === a)) ? b.sender : null
            } else {
                var e;
                b = R(e = this.pc.getSenders()).call(e, b=>b.track && b.track.kind === a) || null
            }
            if (!b)
                throw new m(l.SENDER_NOT_FOUND);
            return b
        }
    }
    class Zk extends Wk {
        constructor(a) {
            ...
            this.statsFilter.onFirstVideoDecoded = (a,d)=>this.onFirstVideoDecoded && this.onFirstVideoDecoded(a, d);
            ...
            ea.supportUnifiedPlan ? (this.audioTransceiver = this.pc.addTransceiver("audio", {
                direction: "recvonly"
            }),
    ...
    class al extends Ua {
        ...
        set connectionState(a) {
            a !== this._connectionState && (this.emit(G.CONNECTION_STATE_CHANGE, a, this._connectionState),
            this._connectionState = a)
        }
        get connectionId() {
            var a, b;
            return n(a = n(b = "".concat(this.joinInfo.clientId, "-")).call(b, this.type ? this.type : "sub(".concat(this._userId, ")"), "-")).call(a, this.ID)
        }
        getUserId() {
            return this._userId
        }
        ...
        createWaitConnectionConnectedPromise() {
            return new u((a,b)=>{
                "disconnected" === this.connectionState ? b() : "connected" === this.connectionState ? a() : this.once(G.CONNECTION_STATE_CHANGE, d=>{
                    "connected" === d ? a() : b()
                }
                )
            }
        ...
        updateICEPromise() {
            ...
            this.icePromise = new u((a,b)=>{
                this.pc.onICEConnectionStateChange = d=>{
                    var e, f;
                    k.info(n(e = n(f = "[".concat(this.connectionId, "] ice-state: ")).call(f, this.type, " p2p ")).call(e, d));
                    "connected" === d && a();
                    "failed" !== d && "closed" !== d || this.reconnectPC(new m(l.ICE_FAILED)).catch(a=>{
                ...
                this.pc.onConnectionStateChange = a=>{
                    var d, f;
                    k.info(n(d = n(f = "[".concat(this.connectionId, "] connection-state: ")).call(f, this.type, " p2p ")).call(d, a));
                    "failed" !== a && "closed" !== a || this.reconnectPC(new m(l.PC_CLOSED)).catch(a=>{
                        this.emit(G.P2P_LOST);
                        b(a)
                    }
                    )
                ...
                this.once(G.GATEWAY_P2P_LOST, a=>{
                    ...
                    if (this.pc.ID.toString() === a.toString()) {
                        if (k.info(n(d = "[".concat(this.connectionId, "] ")).call(d, this.type, " p2p gateway lost")),
                        this.pc.allCandidateReceived && 0 === this.pc.localCandidateCount)
                            return this.disconnectedReason = new m(l.NO_ICE_CANDIDATE,"can not get candidate in this pc"),
    ...
    class bl {
        constructor(a) {
            ...
            this.handleVideoEvents = a=>{
                ...
                case "pause":
                    ...
                    this.videoElement && (k.debug("[track-".concat(this.trackId, "] video element paused, auto resume")),
        ...
        set videoElementStatus(a) {
            var b, d;
            a !== this._videoElementStatus && (k.debug(n(b = n(d = "[".concat(this.trackId, "] video-element-status change ")).call(d, this._videoElementStatus, " => ")).call(b, a)),
        ...
        createVideoElement() {
            (this.videoElement || (this.videoElementStatus = Ia.INIT,
            this.videoElement = document.createElement("video"),
            this.videoElement.onerror = ()=>this.videoElementStatus = Ia.ERROR,
            ...
            this.videoElementCheckInterval = window.setInterval(()=>{
                !document.getElementById("video_".concat(this.trackId)) && this.videoElement && (this.videoElementStatus = Ia.DESTROYED)
            }
            , 1E3)),
    ...
    let we = "play playing loadeddata canplay pause stalled suspend waiting abort emptied ended timeupdate".split(" ");
    class Dp {
        get output() {
            return this._output
        }
    ...
    class dl {
        constructor(a, b) {
            ...
            for (var e = 0; e < b.length; ++e)
                d.push(jm(a, b[e], 0 === e ? a.VERTEX_SHADER : a.FRAGMENT_SHADER));
            b = km(a, d, void 0, void 0);
    ...
    class Pp extends Tb {
        ...
        init() {
            this.tab_addr = new Uint8Array(el);
            let a = [this.tab_addr]
              , b = [256]
              , d = [1];
            for (let e = 0; e < a.length; e++) {
                ...
                this.gl.texImage2D(this.gl.TEXTURE_2D, 0, this.gl.LUMINANCE, b[e], d[e], 0, this.gl.LUMINANCE, this.gl.UNSIGNED_BYTE, a[e]);
    ...
    class Qp {
        ...
        init(a, b, d) {
            ...
            this.canvas = d;
            this.programs.push(new dl(this.gl));
            this.programs.push(new Hp(this.gl,a,b));
            this.programs.push(new Jp(this.gl,a,b));
            this.programs.push(new Lp(this.gl,a,b));
            this.programs.push(new Pp(this.gl,this.inputTexture,a,b));
        ...
        render(a) {
            ...
            if (this.originalFrameHeight === a.videoWidth && this.originalFrameWidth === a.videoHeight)
                ...
                var d, e, f;
                if (k.debug(n(d = n(e = n(f = "beauty effect: resolution changed ".concat(this.originalFrameWidth, "x")).call(f, this.originalFrameHeight, " -> ")).call(e, a.videoWidth, "x")).call(d, a.videoHeight)),
        ...
        setDenoiseLevel(a) {
            ...
            r(b = this.programs).call(b, b=>{
                b instanceof Tb && b.setParameters({
                    denoiseLevel: a
                })
            }
            );
        ...
        initGL(a, b) {
            ...
            for (let d = 0; 4 > d; d++) {
                ...
                if (!e)
                    throw new m(l.WEBGL_INTERNAL_ERROR,"create texture failed");
                this.gl.bindTexture(this.gl.TEXTURE_2D, e);
                this.gl.texParameteri(this.gl.TEXTURE_2D, this.gl.TEXTURE_WRAP_S, this.gl.CLAMP_TO_EDGE);
                this.gl.texParameteri(this.gl.TEXTURE_2D, this.gl.TEXTURE_WRAP_T, this.gl.CLAMP_TO_EDGE);
                this.gl.texParameteri(this.gl.TEXTURE_2D, this.gl.TEXTURE_MIN_FILTER, this.gl.LINEAR);
                2 > d ? this.gl.texImage2D(this.gl.TEXTURE_2D, 0, this.gl.RGBA, a, b, 0, this.gl.RGBA, this.gl.UNSIGNED_BYTE, null) : this.gl.texImage2D(this.gl.TEXTURE_2D, 0, this.gl.RGBA, b, a, 0, this.gl.RGBA, this.gl.UNSIGNED_BYTE, null);
    ...
    class Sp extends Dp {
        ...
        async setBeautyEffectOptions(a, b) {
            ...
            void 0 !== b.lighteningContrastLevel && Xa(b.lighteningContrastLevel, "options.lighteningContrastLevel", [0, 1, 2]);
        ...
        async startEffect() {
            ...
            ;
            requestAnimationFrame(d);
            a.name === da.CHROME && document.addEventListener("visibilitychange", ()=>{
                document.hidden ? this.stopChromeBackgroundLoop = We(()=>{
                    this.enabled && this.video && this.manager.render(this.video);
                    this.output && this.output.requestFrame && this.output.requestFrame();
                    this.overloadDetector.addFrame()
                }
        ...
        async renderWithWebGL() {
            ...
            let b = new u(a=>{
              ...
              , e = d.width
              , f = d.height;
            if (d.frameRate && this.fps !== d.frameRate && (this.fps = d.frameRate,
            k.debug("beauty video processor: set fps to", this.fps)),
            k.debug(n(a = "beauty video processor: width ".concat(e, " height ")).call(a, f)),
            !e || !f)
            ...
            this.video.play();
            await b;
            return this.canvas.captureStream(ea.supportRequestFrame ? 0 : this.fps).getVideoTracks()[0]
        }
    }
    class bb extends qg {
        constructor(a, b, d, e) {
        ...
        play(a, b={}) {
            ...
            if (!(a instanceof HTMLElement)) {
                ...
                var e;
                b ? a = b : (k.warning(n(e = "[track-".concat(this.getTrackId(), '] can not find "#')).call(e, a, '" element, use document.body')),
                a = document.body)
            }
            ...
            this._player ? this._player.updateConfig(a) : (this._player = new bl(a),
            ...
            if (a !== this._enabled) {
                ...
                if (!a) {
                    ...
                    try {
                        ...
                        throw k.error("[".concat(this.getTrackId(), "] setEnabled to false error"), d.toString()),
                        b(),
                        d;
                    }
                    return this._enabled = !1,
                ...
                try {
                    ...
                    throw k.error("[".concat(this.getTrackId(), "] setEnabled to true error"), d.toString()),
                    b(),
                    d;
                }
        ...
        async setBeautyEffect(a, b={}) {
            ...
            if (a || this._videoBeautyProcessor) {
                if (!this._enabled && a)
                    throw a = new m(l.TRACK_IS_DISABLED,"can not enable beauty effect when track is disabled"),
                    d.onError(a),
                    a;
                k.info("[".concat(this.getTrackId(), "] start setBeautyEffect"), a, w(b));
                try {
                    this._videoBeautyProcessor ? await this._videoBeautyProcessor.setBeautyEffectOptions(a, b) : (this._videoBeautyProcessor = new Sp,
    ...
    class fl extends bb {
        constructor(a, b, d, e, f) {
            ...
            this._constraints = d;
            this._deviceName = a.label;
            this._config.encoderConfig && (this._encoderConfig = uc(this._config.encoderConfig))
        }
        async setDevice(a) {
            var b;
            let d = t.reportApiInvoke(null, {
            ...
            if (!this._enabled)
                throw a = new m(l.TRACK_IS_DISABLED,"can not set device when track is disabled"),
                d.onError(a),
                a;
            k.info(n(b = "[".concat(this.getTrackId(), "] set device to ")).call(b, a));
            try {
                ...
                try {
                    ...
                    throw k.error("[".concat(this.getTrackId(), "] setDevice failed"), g.toString()),
                    f = await Bb({
                        video: this._constraints
                    }, this.getTrackId()),
        ...
        async setEncoderConfiguration(a) {
            ...
            if (!this._enabled)
                throw a = new m(l.TRACK_IS_DISABLED,"can not set encoder configuration when track is disabled"),
                b.onError(a),
                a;
            a = uc(a);
            ...
            try {
                ...
                throw a = new m(l.UNEXPECTED_ERROR,f.toString()),
    ...
    class gl extends al {
        constructor(a, b, d, e) {
            ...
            new u(async(a,b)=>{
                this.connectionState = "connecting";
                let d = e=>{
                    "connected" === e && (this.off(G.CONNECTION_STATE_CHANGE, d),
                    a());
                    "disconnected" === e && (this.off(G.CONNECTION_STATE_CHANGE, d),
                    b(new m(l.OPERATION_ABORTED,"renegotiate abort")))
                }
                ;
                this.on(G.CONNECTION_STATE_CHANGE, d);
                var e = await this.pc.createOfferSDP();
                this.audioTrack && this.audioTrack._encoderConfig && (e = hf(e, this.audioTrack._encoderConfig));
                await this.pc.setOfferSDP(e);
                let f = await Ha(this, G.NEED_RENEGOTIATE, e);
                e = lm(e, this.updateAnswerSDP(f.sdp));
            ...
            this.handleReplaceTrack = (a,b,d)=>{
                if (this.audioTrack instanceof Rc && "audio" === a.kind)
                    return u.resolve();
                this.pc.replaceTrack(a).then(a=>a ? this.renegotiateWithGateway() : u.resolve()).then(b).catch(d)
            }
            ;
        ...
        getAllTracks() {
            ...
            this.audioTrack && this.audioTrack instanceof Rc ? a = n(a).call(a, this.audioTrack.trackList) : this.audioTrack && a.push(this.audioTrack),
            a
        }
        async addTracks(a) {
            let b = ea;
            ...
            a = Ih(a = N(a).call(a, a=>-1 === E(e).call(e, a)));
            for (let e = 0; e < a.length; e += 1) {
                var f = a[e];
                if (!(f instanceof qg))
                    return (new m(l.INVALID_LOCAL_TRACK)).throw();
                ...
                if (f instanceof Va && this.audioTrack)
                    if (this.audioTrack instanceof Rc)
                    ...
                    f instanceof bb && this.isLowStreamConnection ? (d = this.lowStreamParameter || {
                        width: 160,
                        height: 120,
                        framerate: 15,
                        bitrate: 50
                    ...
                    f = mm(f, d),
                    f = new bb(f,{
                        bitrateMax: d.bitrate,
                        bitrateMin: d.bitrate
                    }),
                    f._hints.push(ib.LOW_STREAM),
                    d = await this.addTrackWithPC(f)) : (this.detecting = !0,
                    Cc(()=>{
                        this.detecting = !1
                    }
                    , 8E3),
        ...
        async removeTracks(a, b) {
            ...
            a = Ih(a = N(a).call(a, a=>-1 !== E(d).call(d, a)));
            let e = [];
            for (let b = 0; b < a.length; b += 1) {
                let d = a[b];
                this.unbindTrackEvents(d);
                this.audioTrack instanceof Rc && d instanceof Va ? (this.audioTrack.removeAudioTrack(d),
                0 === this.audioTrack.trackList.length && (e.push(this.audioTrack),
                this.audioTrack = void 0)) : d instanceof Va ? (e.push(d),
                this.audioTrack = void 0) : d instanceof bb && (e.push(d),
            ...
            if (this.videoTrack || this.audioTrack) {
                if (0 !== e.length) {
                    ...
                    for (let a of e) {
                        var f;
                        k.debug(n(f = "[".concat(this.connectionId, "] remove ")).call(f, a.trackMediaType, " from pc"));
                        await this.pc.removeTrack(a._mediaStreamTrack)
                    }
                    await this.renegotiateWithGateway()
                }
            } else
                await this.closeP2PConnection(b)
        }
        startP2PConnection() {
            return new u(async(a,b)=>{
                ...
                let d = e=>{
                    var f;
                    "connected" === e && (t.publish(this.joinInfo.sid, {
                        lts: this.startTime,
                        succ: !0,
                        ec: null,
                        audioName: this.audioTrack && this.audioTrack.getTrackLabel(),
                        videoName: this.videoTrack && this.videoTrack.getTrackLabel(),
                        screenshare: !(!this.videoTrack || -1 === E(f = this.videoTrack._hints).call(f, ib.SCREEN_TRACK)),
                    ...
                    a());
                    if ("disconnected" === e) {
                        if (this.off(G.CONNECTION_STATE_CHANGE, d),
                ...
                try {
                    ...
                    this.audioTrack && this.audioTrack._encoderConfig && (a = hf(a, this.audioTrack._encoderConfig));
                    ...
                    t.publish(this.joinInfo.sid, {
                        ...
                        audioName: this.audioTrack && this.audioTrack.getTrackLabel(),
                        videoName: this.videoTrack && this.videoTrack.getTrackLabel(),
                        screenshare: !(!this.videoTrack || -1 === E(e = this.videoTrack._hints).call(e, ib.SCREEN_TRACK)),
                        audio: !!this.audioTrack,
                        video: !!this.videoTrack,
                        p2pid: this.pc.ID,
                        publishRequestid: this.ID
                    });
                    k.error("[".concat(this.connectionId, "] connection error"), f.toString());
                    b(f)
                }
            }
            )
        ...
        async closeP2PConnection(a) {
            ...
            this.videoTrack = void 0,
            this.audioTrack instanceof Rc) && r(d = this.audioTrack.trackList).call(d, a=>{
        ...
        getNetworkQuality() {
            ...
            e = e && f ? (e + f) / 2 : e || f;
            d = 70 * b.sendPacketLossRate / 50 + .3 * ((e && d ? (e + d) / 2 : e || d) || 0) / 1500;
            d = .17 > d ? 1 : .36 > d ? 2 : .59 > d ? 3 : .1 > d ? 4 : 5;
            return this.videoTrack && this.videoTrack._encoderConfig && -1 === E(a = this.videoTrack._hints).call(a, ib.SCREEN_TRACK) && (a = this.videoTrack._encoderConfig.bitrateMax,
            b = b.bitrate.actualEncoded,
            a && b) ? (b = (1E3 * a - b) / (1E3 * a),
            zo[.15 > b ? 0 : .3 > b ? 1 : .45 > b ? 2 : .6 > b ? 3 : 4][d]) : d
        }
        uploadStats(a, b) {
            let d = this.audioTrack ? Bl(a, this.audioTrack) : void 0
              , e = this.videoTrack ? Al(a, this.videoTrack) : void 0
              , f = Fh(a, b)
              , g = zl(a);
            d && Za(()=>this.emit(G.NEED_UPLOAD, sb.PUBLISH_STATS, d));
            e && Za(()=>this.emit(G.NEED_UPLOAD, sb.PUBLISH_STATS, nm({}, e, {}, f)));
        ...
        bindTrackEvents(a) {
            this.isLowStreamConnection || (a instanceof Va ? (a.addListener(L.GET_STATS, this.handleGetLocalAudioStats),
            a.addListener(L.NEED_CLOSE, this.handleCloseAudioTrack)) : a instanceof bb && (a.addListener(L.GET_STATS, this.handleGetLocalVideoStats),
        ...
        unbindTrackEvents(a) {
            this.isLowStreamConnection || (a instanceof Va ? (a.off(L.GET_STATS, this.handleGetLocalAudioStats),
            a.off(L.NEED_CLOSE, this.handleCloseAudioTrack)) : a instanceof bb && (a.off(L.GET_STATS, this.handleGetLocalVideoStats),
        ...
        async addTrackWithPC(a) {
            ...
            let d = !1;
            this.audioTrack && a instanceof Va ? (this.audioTrack = a,
            k.debug("[".concat(this.connectionId, "] replace pc audio track")),
            d = await this.pc.replaceTrack(a._mediaStreamTrack)) : this.videoTrack && a instanceof bb ? (this.videoTrack = a,
            k.debug("[".concat(this.connectionId, "] replace pc video track")),
            d = await this.pc.replaceTrack(a._mediaStreamTrack)) : a instanceof Va ? (this.audioTrack = a,
            k.debug("[".concat(this.connectionId, "] add audio track to pc")),
            await this.pc.addTrack(a._mediaStreamTrack),
            d = !0) : a instanceof bb && (this.videoTrack = a,
            k.debug("[".concat(this.connectionId, "] add video track to pc")),
            await this.pc.addTrack(a._mediaStreamTrack),
            d = !0);
            a = ea;
            this.videoTrack !== b && this.videoTrack && a.supportSetRtpSenderParameters && (b = {},
            a = "balanced",
            this.videoTrack._encoderConfig && (b.maxBitrate = this.videoTrack._encoderConfig.bitrateMax ? 1E3 * this.videoTrack._encoderConfig.bitrateMax : void 0),
            "motion" === this.videoTrack._optimizationMode ? a = "maintain-framerate" : "detail" === this.videoTrack._optimizationMode && (a = "maintain-resolution"),
        ...
        updateAnswerSDP(a) {
            var b, d;
            this.videoTrack && -1 !== E(b = this.videoTrack._hints).call(b, ib.SCREEN_TRACK) && (a = a.replace("a=x-google-flag:conference\r\n", ""));
            if (this.videoTrack && this.videoTrack._encoderConfig && -1 === E(d = this.videoTrack._hints).call(d, ib.SCREEN_TRACK)) {
                {
                    b = this.codec;
                    ...
                    if (q && 0 < q.length && f.supportMinBitrate && d) {
                        f = null;
                        var g, h;
                        if ("h264" === b ? f = a.match(/a=rtpmap:(\d+) H264\/90000\r\n/) || a.match(/a=rtpmap:(\d+) H264\/90000\n/) : "vp8" === b && (f = a.match(/a=rtpmap:(\d+) VP8\/90000\r\n/) || a.match(/a=rtpmap:(\d+) VP8\/90000\n/)),
                        f && f[1])
                            a = a.replace(q[0], n(g = n(h = "".concat(q[0], "a=fmtp:")).call(h, f[1], " x-google-min-bitrate=")).call(g, d, "\r\n"))
                    }
                    if (q && 0 < q.length && e) {
                        var k, l;
                        g = "AS";
                        va().name === da.FIREFOX && (e = 1E3 * (e >>> 0),
                        g = "TIAS");
                        a = a.replace(q[0], n(k = n(l = "".concat(q[0], "b=")).call(l, g, ":")).call(k, e, "\r\n"))
                    }
                }
            }
            this.audioTrack && this.audioTrack._encoderConfig && (a = hf(a, this.audioTrack._encoderConfig));
            k = a;
            l = va();
            return k = l.name !== da.SAFARI && l.os !== aa.IOS ? k : k.replace(/a=.*video-orientation\r\n/g, "")
        }
        createPC() {
            this.pc = new Yk({
        ...
        onPCDisconnected(a) {
            ...
            t.publish(this.joinInfo.sid, {
                ...
                audioName: this.audioTrack && this.audioTrack.getTrackLabel(),
                videoName: this.videoTrack && this.videoTrack.getTrackLabel(),
                screenshare: !(!this.videoTrack || -1 === E(b = this.videoTrack._hints).call(b, ib.SCREEN_TRACK)),
                audio: !!this.audioTrack,
                video: !!this.videoTrack,
                p2pid: this.pc.ID,
                publishRequestid: this.ID
    ...
    class Tp extends al {
        constructor(a, b, d, e) {
            ...
            this.onTrack = a=>{
                ...
                if ("audio" === a.kind && !this.subscribeOptions.audio || "video" === a.kind && !this.subscribeOptions.video)
                    ...
                    void k.debug(n(d = "[".concat(this.connectionId, "] unused ontrack event, kind: ")).call(d, a.kind));
                k.debug(n(b = "[".concat(this.connectionId, "] emit pc ontrack after subscribe ")).call(b, a.kind), a);
                b = "audio" === a.kind ? this.user._audioTrack : this.user._videoTrack;
                var e, f;
                b ? b._updateOriginMediaStreamTrack(a) : "audio" === a.kind ? (this.user._audioTrack = new zd(a,this.getUserId(),this.user._uintid),
                k.info(n(e = "[".concat(this.connectionId, "] create remote audio track: ")).call(e, this.user._audioTrack.getTrackId())),
                this.bindTrackEvents(this.user._audioTrack)) : (this.user._videoTrack = new yd(a,this.getUserId(),this.user._uintid),
                k.info(n(f = "[".concat(this.connectionId, "] create remote video track: ")).call(f, this.user._videoTrack.getTrackId())),
        ...
        async startP2PConnection() {
            return new u(async(a,b)=>{
                ...
                ;
                if (this.on(G.CONNECTION_STATE_CHANGE, d),
                this.disconnectedReason = void 0,
                this.connectionState = "connecting",
                this.startTime = v(),
                  ...
                  , f = new u(a=>{
                    this.pc.onTrack = (b,d)=>{
                        ...
                        if ("audio" === b.kind && !this.subscribeOptions.audio || "video" === b.kind && !this.subscribeOptions.video)
                            ...
                            void k.debug(n(g = "[".concat(this.connectionId, "] unused ontrack event ")).call(g, b.kind));
                        e.addTrack(b);
                        g = {
                            audio: 0 < e.getAudioTracks().length,
                            video: 0 < e.getVideoTracks().length
                        };
                        k.debug(n(f = "[".concat(this.connectionId, "] subscribe ontrack: ")).call(f, b.kind), d, b);
                        a: {
                        ...
                        g && (this.pc.onTrack = this.onTrack,
                ...
                try {
                    let a = fi(await this.pc.createOfferSDP());
                    await this.pc.setOfferSDP(a);
                    k.debug("[".concat(this.connectionId, "] create and set offer success"));
                    let b = await Ha(this, G.NEED_ANSWER, {
                        messageType: "OFFER",
                    ...
                    await this.pc.setAnswerSDP(fi(b.sdp));
                    k.debug("[".concat(this.connectionId, "] set answer success"));
                    let d = await u.all([f, this.icePromise])
                      , e = d[0].getAudioTracks()[0]
                      , l = d[0].getVideoTracks()[0];
                    var g, h;
                    e && (this.user._audioTrack ? this.user._audioTrack._updateOriginMediaStreamTrack(e) : (this.user._audioTrack = new zd(e,this.getUserId(),this.user._uintid),
                    k.info(n(g = "[".concat(this.connectionId, "] create remote audio track: ")).call(g, this.user._audioTrack.getTrackId())),
                    this.bindTrackEvents(this.user._audioTrack)));
                    l && (this.user._videoTrack ? this.user._videoTrack._updateOriginMediaStreamTrack(l) : (this.user._videoTrack = new yd(l,this.getUserId(),this.user._uintid),
                    k.info(n(h = "[".concat(this.connectionId, "] create remote video track: ")).call(h, this.user._videoTrack.getTrackId())),
                    this.bindTrackEvents(this.user._videoTrack)));
                    this.connectionState = "connected";
                    this.startUploadStats()
                } catch (q) {
        ...
        getNetworkQuality() {
            ...
            d && (e = 60 * a / 50 + .2 * b / 1500 + .2 * d / 400);
            return .1 > e ? 1 : .17 > e ? 2 : .36 > e ? 3 : .59 > e ? 4 : 5
        }
        uploadStats(a) {
            let b = this.user.audioTrack ? Dl(a, this.user.audioTrack) : void 0
              , d = this.user.videoTrack ? Cl(a, this.user.videoTrack) : void 0;
            b && Za(()=>this.emit(G.NEED_UPLOAD, sb.SUBSCRIBE_STATS, b));
            d && Za(()=>this.emit(G.NEED_UPLOAD, sb.SUBSCRIBE_STATS, d))
        }
        uploadSlowStats(a) {}
        uploadRelatedStats(a, b) {
            let d = Gl(a, this.getUserId(), this.user.audioTrack)
              , e = Fl(a, this.getUserId(), b, this.user.videoTrack);
            d && Za(()=>{
        ...
        emitOnTrackFromUnusedTracks() {
            if (this.subscribeOptions) {
                ...
                if (a) {
                    var d;
                    a = R(d = this.unusedTracks).call(d, a=>"video" === a.kind && "live" === a.readyState);
                    bd(this.unusedTracks, a);
                    a && this.onTrack(a)
                }
            }
        ...
        async setSubscribeOptions(a) {
            ...
            if (a.audio !== this.subscribeOptions.audio || a.video !== this.subscribeOptions.video) {
                ...
                a.audio === this.subscribeOptions.audio && a.video === this.subscribeOptions.video || (k.debug(n(b = n(d = n(e = n(f = "[".concat(this.connectionId, "] update subscribe options [a: ")).call(f, this.subscribeOptions.audio, ", v: ")).call(e, this.subscribeOptions.video, "] -> [a: ")).call(d, a.audio, ", v: ")).call(b, a.video, "]")),
        ...
        createPC() {
            ...
            this.pc.onFirstAudioDecoded = ()=>{
                t.firstRemoteFrame(this.joinInfo.sid, Ca.FIRST_AUDIO_DECODE, pa.FIRST_AUDIO_DECODE, {
            ...
            this.pc.onFirstAudioReceived = ()=>{
                t.firstRemoteFrame(this.joinInfo.sid, Ca.FIRST_AUDIO_RECEIVED, pa.FIRST_AUDIO_RECEIVED, {
                    peer: this.user._uintid,
                    subscribeElapse: v() - this.startTime,
                    subscribeRequestid: this.ID,
                    p2pid: this.pc.ID
            ...
            this.pc.onFirstVideoDecoded = (a,b)=>{
                t.firstRemoteFrame(this.joinInfo.sid, Ca.FIRST_VIDEO_DECODE, pa.FIRST_VIDEO_DECODE, {
                    peer: this.user._uintid,
                    videowidth: a,
                    videoheight: b,
                    subscribeElapse: v() - this.startTime,
            ...
            this.pc.onFirstVideoReceived = ()=>{
                t.firstRemoteFrame(this.joinInfo.sid, Ca.FIRST_VIDEO_RECEIVED, pa.FIRST_VIDEO_RECEIVED, {
                    peer: this.user._uintid,
                    subscribeElapse: v() - this.startTime,
                    subscribeRequestid: this.ID,
                    p2pid: this.pc.ID
        ...
        async closePC(a) {
            ...
            this.pc.onICEConnectionStateChange = void 0,
            this.pc.close(),
            a) ? !1 : await Ha(this, G.NEED_UNSUB)
        }
        onPCDisconnected(a) {
            t.subscribe(this.joinInfo.sid, {
                lts: this.startTime,
        ...
        bindTrackEvents(a) {
            a instanceof zd ? a.addListener(L.GET_STATS, this.handleGetRemoteAudioStats) : a instanceof yd && a.addListener(L.GET_STATS, this.handleGetRemoteVideoStats)
        }
        unbindTrackEvents(a) {
            a instanceof zd ? a.off(L.GET_STATS, this.handleGetRemoteAudioStats) : a instanceof yd && a.off(L.GET_STATS, this.handleGetRemoteVideoStats)
        }
    }
    class Up extends Ua {
        constructor(a, b, d, e) {
            ...
            this.handleWebSocketMessage = a=>{
                if (a.data) {
                    a = JSON.parse(a.data);
                    var b;
                    a.requestId ? this.emit(n(b = "@".concat(a.requestId, "-")).call(b, a.sid), a) : this.serviceMode === ma.INJECT ? this.emit(hb.INJECT_STREAM_STATUS, a) : (t.workerEvent(this.spec.sid, {
                        actionType: "status",
                        serverCode: a.code,
        ...
        async request(a, b, d, e) {
            ...
            e && t.workerEvent(this.spec.sid, kf({}, e, {
                requestId: f,
                actionType: "request",
            ...
            try {
                ...
                if ("closed" === this.websocket.state)
                    throw ra;
                return await k(),
                await this.request(a, b, d)
            }
            return e && t.workerEvent(this.spec.sid, kf({}, e, {
                requestId: f,
                actionType: "response",
        ...
        handleResponseError(a) {
            ...
            case ka.LIVE_STREAM_RESPONSE_WM_WORKER_NOT_EXIST:
                if ("UnpublishStream" === a.serverResponse.command || "UninjectStream" === a.serverResponse.command)
                    break;
                throw new m(l.LIVE_STREAMING_INTERNAL_SERVER_ERROR,"live stream response wm worker not exist",{
                    retry: !0
                });
            ...
            case ka.LIVE_STREAM_RESPONSE_REQUEST_TOO_OFTEN:
                return b = new m(l.LIVE_STREAMING_WARN_FREQUENT_REQUEST),
            ...
            case ka.LIVE_STREAM_RESPONSE_MAX_STREAM_NUM:
                return b = new m(l.LIVE_STREAMING_WARN_STREAM_NUM_REACH_LIMIT),
                this.emit(hb.WARNING, b, a.serverResponse.url);
        ...
        startPingPong() {
            ...
            this.pingpongTimer = window.setInterval(()=>{
                "connected" === this.websocket.state && this.request("ping", {}).catch(og)
            }
            , 6E3)
        }
    }
    class Vp extends Ua {
        constructor(a, b=Na, d=Na) {
            ...
            this.taskMutex = new $b("live-streaming");
            this.cancelToken = Cb.CancelToken.source();
            this.injectConfig = Wb({}, bp);
        ...
        async setTranscodingConfig(a) {
            ...
            let d = Wb({}, ap, {}, a);
            var e, f;
            66 !== d.videoCodecProfile && 77 !== d.videoCodecProfile && 100 !== d.videoCodecProfile && (k.debug(n(e = "[".concat(this.spec.clientId, "] set transcoding config, fix video codec profile: ")).call(e, d.videoCodecProfile, " -> 100")),
            d.videoCodecProfile = 100);
            (d.transcodingUsers || (d.transcodingUsers = d.userConfigs),
            d.transcodingUsers) && (d.transcodingUsers = D(f = d.transcodingUsers).call(f, a=>Wb({}, $o, {}, a, {
                zOrder: a.zOrder ? a.zOrder + 1 : 1
            })));
            ul(d);
            a = [];
            var g, h;
            d.images && a.push(...D(g = d.images).call(g, a=>Wb({}, fg, {}, a, {
                zOrder: 255
            })));
            (d.backgroundImage && (a.push(Wb({}, fg, {}, d.backgroundImage, {
                zOrder: 0
            })),
            delete d.backgroundImage),
            d.watermark && (a.push(Wb({}, fg, {}, d.watermark, {
                zOrder: 255
            })),
            delete d.watermark),
            d.images = a,
            d.transcodingUsers) && (d.userConfigs = D(h = d.transcodingUsers).call(h, a=>Wb({}, a)),
            d.userCount = d.transcodingUsers.length,
            delete d.transcodingUsers);
            g = D(b = d.userConfigs || []).call(b, a=>"number" == typeof a.uid ? u.resolve(a.uid) : Zh(a.uid, this.spec, this.cancelToken.token, this.httpRetryConfig));
            b = await u.all(g);
            if (r(b).call(b, (a,b)=>{
            ...
            this.connection)
                try {
                    ...
                    let a = await this.connection.request("request", {
                        ...
                        workerType: 1,
                        requestByUser: !0,
                        tid: D(l = Kb(qc(m = this.streamingTasks).call(m))).call(l, a=>a.taskId).join("#")
                    });
                    k.debug(n(p = "[".concat(this.spec.clientId, "] update live transcoding config success, code: ")).call(p, a.code, ", config:"), w(this.transcodingConfig))
                } catch (x) {
                    var t;
                    if (!x.data || !x.data.retry)
                        throw x;
                    x.data.changeAddress && this.connection.tryNextAddress();
                    r(t = this.streamingTasks).call(t, a=>{
                        k.warning("[".concat(this.spec.clientId, "] live streaming receive error"), x.toString(), "try to republish", a.url);
                        this.startLiveStreamingTask(a.url, a.mode, x).then(()=>{
                            var b;
                            k.debug(n(b = "[".concat(this.spec.clientId, "] live streaming republish ")).call(b, a.url, " success"))
                        }
                        ).catch(b=>{
        ...
        async startLiveStreamingTask(a, b, d) {
            var e, f, g, h;
            if (R(e = Kb(qc(f = this.streamingTasks).call(f))).call(e, a=>a.mode === ma.INJECT) && b === ma.INJECT)
                return (new m(l.LIVE_STREAMING_TASK_CONFLICT,"inject stream over limit")).throw();
            if (!this.transcodingConfig && b === ma.TRANSCODE)
                throw new m(l.INVALID_OPERATION,"[LiveStreaming] no transcoding config found, can not start transcoding streaming task");
            e = {
            ...
            k.debug(n(g = n(h = "[".concat(this.spec.clientId, "] start live streaming ")).call(h, a, ", mode: ")).call(g, b));
            g = await this.taskMutex.lock();
            if (!this.connection && d)
                return void g();
            if (this.streamingTasks.get(a) && !d)
                return g(),
                (new m(l.LIVE_STREAMING_TASK_CONFLICT)).throw();
            try {
            ...
            try {
                ...
                let f = new u((b,e)=>{
                  ...
                  , l = await u.race([this.connection.request("request", {
                    clientRequest: e
                }, !0, {
                    url: a,
                    command: "PublishStream",
                ...
                this.isStartingStreamingTask = !1;
                k.debug(n(q = "[".concat(this.spec.clientId, "] live streaming started, code: ")).call(q, l.code));
                ...
                !y.data || !y.data.retry || d)
                    throw y;
                return y.data.changeAddress ? (this.connection.tryNextAddress(),
                await this.startLiveStreamingTask(a, b, y)) : await this.startLiveStreamingTask(a, b, y)
            }
        }
        stopLiveStreamingTask(a) {
            return new u((b,d)=>{
                ...
                this.connection.request("request", {
                    ...
                    var e;
                    k.debug(n(e = "[".concat(this.spec.clientId, "] stop live streaming success, code: ")).call(e, d.code));
                    this.streamingTasks.delete(a);
                    b();
                    f === ma.INJECT && this.onInjectStatusChange && this.onInjectStatusChange(5, this.spec.uid, a)
                }
                ).catch(d)
            }
            )
        ...
        async connect(a) {
            ...
            this.connection = new Up(b.workerToken,this.spec,this.wsRetryConfig,a),
            this.connection.on(hb.WARNING, (a,b)=>this.onLiveStreamWarning && this.onLiveStreamWarning(b, a)),
            this.connection.on(hb.PUBLISH_STREAM_STATUS, a=>this.handlePublishStreamServer(a)),
            this.connection.on(hb.INJECT_STREAM_STATUS, a=>this.handleInjectStreamServerStatus(a)),
            this.connection.on(hb.REQUEST_NEW_ADDRESS, (b,e)=>{
                ...
                Ha(this, Qc.REQUEST_WORKER_MANAGER_LIST, a).then(a=>{
                    this.uapResponse = a;
                    b(a.addressList)
                }
                ).catch(e)
        ...
        handlePublishStreamServer(a) {
            ...
            case ka.PUBLISH_STREAM_STATUS_ERROR_RTMP_PUBLISH:
                {
                    let e = new m(l.LIVE_STREAMING_CDN_ERROR,"",{
                        code: a.code
                    });
                    if (d)
                        return k.error(e.toString()),
            ...
            case ka.LIVE_STREAM_RESPONSE_WORKER_QUIT:
                ...
                if (this.connection) {
                    ...
                    for (let d of b)
                        d.abortTask ? d.abortTask() : (k.warning("[".concat(this.spec.clientId, "] publish stream status code"), a.code, "try to republish", d.url),
                        this.startLiveStreamingTask(d.url, d.mode, new m(l.LIVE_STREAMING_INTERNAL_SERVER_ERROR,"",{
                            code: a.code
                        })).then(()=>{
                            k.debug("[".concat(this.spec.clientId, "] republish live stream success"), d.url)
                        }
                        ).catch(a=>{
                            k.error(a.toString());
        ...
        handleInjectStreamServerStatus(a) {
            ...
            case 451:
                return this.onInjectStatusChange && this.onInjectStatusChange(1, b, d),
                void this.streamingTasks.delete(d);
            case 453:
                return this.onInjectStatusChange && this.onInjectStatusChange(2, b, d),
                void this.streamingTasks.delete(d);
            case 470:
                return this.onInjectStatusChange && this.onInjectStatusChange(10, b, d),
                void this.streamingTasks.delete(d);
            case 499:
                return this.onInjectStatusChange && this.onInjectStatusChange(3, b, d),
                void this.streamingTasks.delete(d);
            default:
    ...
    class Wp extends Ua {
        ...
        waitStatus(a) {
            return new u((b,d)=>{
                ...
                this.once(a, f=>{
                    ...
                    f.state && 0 !== f.state ? d(new m(l.CROSS_CHANNEL_WAIT_STATUS_ERROR,"wait status error, status: ".concat(a))) : b()
                }
                );
                this.once("dispose", ()=>{
                    window.clearTimeout(e);
        ...
        async request(a) {
            ...
            if (!a || 200 !== a.code)
                throw new m(l.CROSS_CHANNEL_SERVER_ERROR_RESPONSE,"response: ".concat(w(a)));
            return a
        }
        async connect(a) {
    ...
    class Xp extends Ua {
        constructor(a, b, d, e) {
            ...
            this.onStatus = a=>{
                var b;
                k.debug(n(b = "[".concat(this.clientId, "] ChannelMediaStatus: ")).call(b, w(a)));
            ...
            this.joinInfo = a;
            this.clientId = b;
            this.signal = new Wp(this.joinInfo,this.clientId,d);
        ...
        async connect() {
            let a = await hm(this.joinInfo, this.cancelToken.token, this.httpRetryConfig);
        ...
        async sendStartRelayMessage(a) {
            var b = this.genMessage(Ea.StopPacketTransfer);
            ...
            b = this.genMessage(Ea.SetSdkProfile, a);
            await this.signal.request(b);
            k.debug("[".concat(this.clientId, "] startChannelMediaRelay: SetSdkProfile success"));
            b = this.genMessage(Ea.SetSourceChannel, a);
            await this.signal.request(b);
            ...
            b = this.genMessage(Ea.SetSourceUserId, a);
            await this.signal.request(b);
            k.debug("[".concat(this.clientId, "] startChannelMediaRelay: SetSourceUserId success"));
            b = this.genMessage(Ea.SetDestChannel, a);
            await this.signal.request(b);
            ...
            a = this.genMessage(Ea.StartPacketTransfer, a);
        ...
        async sendUpdateMessage(a) {
            a = this.genMessage(Ea.UpdateDestChannel, a);
            await this.signal.request(a);
        ...
        async sendStopRelayMessage() {
            let a = this.genMessage(Ea.StopPacketTransfer);
            await this.signal.request(a);
        ...
        genMessage(a, b) {
            ...
            "4.1.1" === g.sdkVersion && (g.sdkVersion = "0.0.1");
            let h = null
              , k = null;
            switch (a) {
            ...
            case Ea.SetSourceChannel:
                if (k = b && b.getSrcChannelMediaInfo(),
                !k)
            ...
            case Ea.SetDestChannel:
                if (h = b && b.getDestChannelMediaInfo(),
                !h)
    ...
    class Zp extends Ua {
        constructor(a) {
            ...
            this._leaveMutex = new $b("client-leave");
            this._publishMutex = new $b("client-publish");
            ...
            this._handleUserOnline = a=>{
                ...
                d ? d._trust_in_room_ = !0 : (b = new Yp(a.uid,a.uint_id || a.uid),
                this._users.push(b),
            ...
            this._handleAddAudioOrVideoStream = (a,b,d)=>{
                ...
                k.debug(n(f = n(g = "[".concat(this._clientId, "] stream added with uid ")).call(g, b, ", type ")).call(f, a));
                ...
                ("audio" === a ? h.hasAudio : h.hasVideo) && !e) && (k.info(n(l = n(q = "[".concat(this._clientId, "] remote user ")).call(q, h.uid, " published ")).call(l, a)),
                this.emit(P.USER_PUBLISHED, h, a));
                "video" === a ? t.onGatewayStream(this._sessionId, Ca.ON_ADD_VIDEO_STREAM, pa.ON_ADD_VIDEO_STREAM, {
                    peer: d || b
                }) : t.onGatewayStream(this._sessionId, Ca.ON_ADD_AUDIO_STREAM, pa.ON_ADD_AUDIO_STREAM, {
                    peer: d || b
                });
            ...
            this._handleRemoveStream = a=>{
                ...
                k.debug(n(d = "[".concat(this._clientId, "] stream removed with uid ")).call(d, a.uid));
                b = ()=>{}
                ;
                e.hasAudio && e.hasVideo ? b = ()=>{
                    var a, b;
                    k.info(n(a = "[".concat(this._clientId, "] remote user ")).call(a, e.uid, " unpublished audio track"));
                    this.emit(P.USER_UNPUBLISHED, e, "audio");
                    k.info(n(b = "[".concat(this._clientId, "] remote user ")).call(b, e.uid, " unpublished video track"));
                    this.emit(P.USER_UNPUBLISHED, e, "video")
                }
                : e.hasVideo ? b = ()=>{
                    var a;
                    k.info(n(a = "[".concat(this._clientId, "] remote user ")).call(a, e.uid, " unpublished video track"));
                    this.emit(P.USER_UNPUBLISHED, e, "video")
                }
                : e.hasAudio && (b = ()=>{
                    var a;
                ...
                e._audio_added_ = !1;
                e._video_added_ = !1;
                (d = this._remoteStream.get(e.uid)) && (d.closeP2PConnection(),
                this._remoteStream.delete(e.uid));
                t.onGatewayStream(this._sessionId, Ca.ON_REMOVE_STREAM, pa.ON_REMOVE_STREAM, {
            ...
            this._handleSetStreamLocalEnable = (a,b,d)=>{
                ...
                k.debug(n(f = n(g = n(h = "[".concat(this._clientId, "] local ")).call(h, a, " ")).call(g, d ? "enabled" : "disabled", " with uid ")).call(f, b));
                e = "audio" === a ? m.hasAudio : m.hasVideo;
                if ("audio" === a) {
                    m._trust_audio_enabled_state_ = !0;
                    var p = m._audio_enabled_;
                    if (m._audio_enabled_ = d,
                    m._audio_enabled_ === p)
                        return;
                    var r, t;
                    d = m._audio_enabled_ ? "enable-local-audio" : "disable-local-audio";
                    k.debug(n(r = n(t = "[".concat(this._clientId, "] user-info-updated, uid: ")).call(t, b, ", msg: ")).call(r, d));
                    this.emit(P.USER_INFO_UPDATED, b, d)
                } else {
                    m._trust_video_enabled_state_ = !0;
                    r = m._video_enabled_;
                    if (m._video_enabled_ = d,
                    m._video_enabled_ === r)
                        return;
                    var u;
                    d = m._video_enabled_ ? "enable-local-video" : "disable-local-video";
                    k.debug(n(p = n(u = "[".concat(this._clientId, "] user-info-update, uid: ")).call(u, b, ", msg: ")).call(p, d));
                    this.emit(P.USER_INFO_UPDATED, b, d)
                }
                ...
                if (e !== d) {
                    var v, w;
                    if (!e && d)
                        return k.info(n(v = n(w = "[".concat(this._clientId, "] remote user ")).call(w, b, " published ")).call(v, a)),
                    ...
                    k.info(n(l = n(q = "[".concat(this._clientId, "] remote user ")).call(q, m.uid, " unpublished ")).call(l, a));
            ...
            this._handleMuteStream = (a,b,d)=>{
                ...
                var l;
                if (!h)
                    return void k.warning(n(l = "[".concat(this._clientId, "] can not find remote user, ignore mute event, uid: ")).call(l, a));
                e = "audio" === b ? h.hasAudio : h.hasVideo;
                if ("audio" === b) {
                    h._trust_audio_mute_state_ = !0;
                    var m = h._audio_muted_;
                    if (h._audio_muted_ = d,
                    h._audio_muted_ === m)
                        return;
                    var q, p;
                    d = h._audio_muted_ ? "mute-audio" : "unmute-audio";
                    k.debug(n(q = n(p = "[".concat(this._clientId, "] user-info-update, uid: ")).call(p, a, ", msg: ")).call(q, d));
                    this.emit(P.USER_INFO_UPDATED, a, d)
                } else {
                    h._trust_video_mute_state_ = !0;
                    q = h._video_muted_;
                    if (h._video_muted_ = d,
                    h._video_muted_ === q)
                        return;
                    var r;
                    d = h._video_muted_ ? "mute-video" : "unmute-video";
                    k.debug(n(m = n(r = "[".concat(this._clientId, "] user-info-update, uid: ")).call(r, a, ", msg: ")).call(m, d));
                    this.emit(P.USER_INFO_UPDATED, a, d)
                }
                ...
                if (e !== d) {
                    var t, u;
                    if (!e && d)
                        return k.info(n(t = n(u = "[".concat(this._clientId, "] remote user ")).call(u, a, " published ")).call(t, b)),
                        void this.emit(P.USER_PUBLISHED, h, b);
                    if (t = this._remoteStream.get(a))
                        u = Bc({}, t.subscribeOptions),
                        u.audio = !!h.hasAudio && u.audio,
                        u.video = !!h.hasVideo && u.video,
                        u.audio || u.video ? t.setSubscribeOptions(u) : (t.closeP2PConnection().catch(a=>{
                            k.warning("close sub pc error", a)
                        }
                        ),
                        this._remoteStream.delete(h.uid));
                    k.info(n(f = n(g = "[".concat(this._clientId, "] remote user ")).call(g, a, " unpublished ")).call(f, b));
                    this.emit(P.USER_UNPUBLISHED, h, b)
                }
            }
            ;
            this._handleP2PLost = a=>{
                ...
                b ? b.emit(G.GATEWAY_P2P_LOST, a.p2pid) : k.warning("P2PLost stream not found", a)
            }
            ;
            ...
            this._handleUpdateNetworkQuality = ()=>{
                ...
                if ("normal" !== this._networkQualitySensitivity) {
                    ...
                    0 < this._remoteStream.size && (b.downlinkNetworkQuality = Math.round(d / this._remoteStream.size));
            ...
            a.turnServer && (this._turnServer = Bc({}, this._turnServer, {
                mode: "manual"
            }, a.turnServer));
            this._clientId = na(5, "client-");
            k.info(n(b = n(d = n(e = n(f = "[".concat(this._clientId, "] Initializing AgoraRTC client v")).call(f, $a, " build: ")).call(e, "v4.1.1-7-g1aff811(2020/10/14 \u4e0b\u53484:22:18)", ", mode: ")).call(d, this._mode, ", codec: ")).call(b, this._codec));
            this._statsCollector = new Yc(this._clientId);
            this._statsCollector.onStatsException = (a,b,d)=>{
                var e, f, g;
                k.debug(n(e = n(f = n(g = "[".concat(this._clientId, "] receive exception msg, code: ")).call(g, a, ", msg: ")).call(f, b, ", uid: ")).call(e, d));
            ...
            this._statsCollector.onUploadPublishDuration = (a,b,d,e)=>{
                ...
                g && t.peerPublishStatus(this._sessionId, {
                    subscribeElapse: e,
            ...
            this._config = a;
            this._configDistribute = new zp(this);
        ...
        async join(a, b, d, e, f) {
            ...
            try {
                if (!d && null !== d)
                    throw new m(l.INVALID_PARAMS,"Invalid token: ".concat(d, ". If you don not use token, set it to null"));
                d && Ga(d, "token", 1, 2047);
                Ie(b);
                e && Je(e);
            ...
            if (k.info(n(g = "[".concat(this._clientId, "] start join channel ")).call(g, b)),
            ...
            if ("DISCONNECTED" !== this.connectionState)
                throw a = new m(l.INVALID_OPERATION,"[".concat(this._clientId, "] Client already in connecting/connected state")),
                h.onError(a),
                a;
            ...
            "string" == typeof e && (q.stringUid = e,
            this._uintUid ? (q.uid = this._uintUid,
            this._uintUid = void 0) : q.uid = 0);
            "none" !== this._encryptionMode && this._encryptionSecret && (q.aesmode = this._encryptionMode,
            ...
            try {
                var p;
                if (await fm(q, this._axiosCancelSource.token, this._config.httpRetryConfig || Na),
                q.stringUid && !q.uid) {
                    var r;
                    let a = await Zh(q.stringUid, q, this._axiosCancelSource.token, this._config.httpRetryConfig || Na);
                    k.debug(n(r = "getUserAccount Success ".concat(q.stringUid, " => ")).call(r, a));
                    q.uid = a
                }
                let e = await Yh(q, this._axiosCancelSource.token, this._config.httpRetryConfig || Na);
                var u;
                q.proxyServer && (e.gatewayInfo.gatewayAddrs = D(u = e.gatewayInfo.gatewayAddrs).call(u, a=>{
                    var b, d;
                    a = a.split(":");
                    return n(b = n(d = "".concat(q.proxyServer, "/ws/?h=")).call(d, a[0], "&p=")).call(b, a[1])
                }
                ));
                ...
                k.info(n(p = "[".concat(this._clientId, "] Joining channel success: ")).call(p, b)),
                f
            } catch (x) {
                throw k.error("[".concat(this._clientId, "] Joining channel failed, rollback"), x),
                x.code !== l.OPERATION_ABORTED && (this._gateway.state = "DISCONNECTED",
                this._reset()),
                h.onError(x),
                x;
            }
        ...
        async publish(a, b=!0) {
            ...
            let f = t.reportApiInvoke(this._sessionId, {
                name: A.PUBLISH,
                options: D(a).call(a, a=>a ? a.getTrackId() : "null"),
                tag: z.TRACER
            });
            if (0 === a.length)
                return a = new m(l.INVALID_PARAMS,"track list is empty"),
                f.onError(a),
                a.throw();
            for (let d of a)
                if (!d._enabled && b)
                    return a = new m(l.TRACK_IS_DISABLED,"can not publish a disabled track: ".concat(d.getTrackId())),
                    f.onError(a),
                    a.throw();
            k.info(n(d = "[".concat(this._clientId, "] Publishing tracks, id ")).call(d, D(a).call(a, a=>"".concat(a.getTrackId(), " "))));
            ...
            try {
                ...
                let e = await this._publishHighStream(a)
                  , h = (e.audioTrack,
                e.videoTrack);
                this._isDualStreamEnabled && h && !this._lowStream && await this._publishLowStream(h);
                b && r(a).call(a, a=>{
                    var b;
                    -1 === E(b = this._bindEnabledTracks).call(b, a) && (a.addListener(L.NEED_ADD_TRACK, this._handleLocalTrackEnable),
            ...
            k.info(n(e = "[".concat(this._clientId, "] Publish success, id ")).call(e, D(a).call(a, a=>"".concat(a.getTrackId(), " "))))
        }
        async unpublish(a, b=!0) {
            ...
            k.info(n(d = n(e = "[".concat(this._clientId, "] Unpublish tracks, tracks ")).call(e, D(a).call(a, a=>"".concat(a.getTrackId(), " ")), ", isClosePC: ")).call(d, g));
            d = g ? void 0 : await this._publishMutex.lock();
            if (!this._highStream)
                return k.warning("[".concat(this._clientId, "] Could not find tracks to unpublish")),
                void (d && d());
            try {
                this._lowStream && 0 < N(a).call(a, a=>"video" === a.trackMediaType).length && (await this._lowStream.closeP2PConnection(),
                this._lowStream = void 0),
                g ? await this._highStream.closeP2PConnection() : await this._highStream.removeTracks(a),
                d && d()
            } catch (q) {
                if (q.code !== l.OPERATION_ABORTED)
                    throw h.onError(q),
                    k.error("[".concat(this._clientId, "] unpublish error"), q.toString()),
                    d && d(),
                    q;
            ...
            k.info(n(f = "[".concat(this._clientId, "] Unpublish success,tracks ")).call(f, D(a).call(a, a=>"".concat(a.getTrackId()))));
            h.onSuccess()
        }
        async subscribe(a, b) {
            var d, e, f, g;
            ...
            if (!this._joinInfo)
                throw b = new m(l.INVALID_OPERATION,"Can't subscribe stream, no join info"),
                h.onError(b),
                b;
            if ("CONNECTED" !== this.connectionState && "RECONNECTING" !== this.connectionState)
                throw b = new m(l.INVALID_OPERATION,"Can't subscribe stream in ".concat(this.connectionState, " state")),
                h.onError(b),
                b;
            if (!R(d = this._users).call(d, b=>b === a)) {
                var q;
                b = new m(l.INVALID_REMOTE_USER,"user is not in the channel");
                throw k.error(n(q = "[".concat(this._clientId, "] can not subscribe ")).call(q, a.uid, ", this user is not in the channel")),
                h.onError(b),
                b;
            }
            if (!a.hasAudio && !a.hasVideo) {
                ...
                throw k.error(n(p = "[".concat(this._clientId, "] can not subscribe ")).call(p, a.uid, ", user is not published")),
                h.onError(b),
                b;
            }
            q = {
            ...
            if (!a.hasAudio && q.audio || !a.hasVideo && q.video) {
                ...
                throw k.error(n(r = n(u = "[".concat(this._clientId, "] can not subscribe ")).call(u, a.uid, " with mediaType ")).call(r, b, ", remote track is not published")),
                h.onError(x),
                x;
            }
            (r = this._subscribeMutex.get(a.uid)) || (r = new $b("sub-".concat(a.uid)),
            this._subscribeMutex.set(a.uid, r));
            k.info(n(e = n(f = "[".concat(this._clientId, "] subscribe user ")).call(f, a.uid, ", mediaType: ")).call(e, b));
            e = await r.lock();
            ...
            try {
                if (f)
                    ...
                    f = new Tp(a,this._statsCollector,this._joinInfo,q);
                ...
                throw h.onError(xb),
                e(),
                k.error(n(v = "[".concat(this._clientId, "] subscribe user ")).call(v, a.uid, " error"), xb),
                xb;
            }
            k.info(n(x = n(g = "[".concat(this._clientId, "] subscribe success user ")).call(g, a.uid, ", mediaType: ")).call(x, b));
            ...
            return b ? (h.onSuccess(b.getTrackId()),
            b) : (b = new m(l.UNEXPECTED_ERROR,"can not find remote track in user object"),
            h.onError(b),
            b.throw())
        }
        async unsubscribe(a, b) {
            ...
            if (!R(d = this._users).call(d, b=>b === a)) {
                var p;
                b = new m(l.INVALID_REMOTE_USER,"user is not in the channel");
                throw k.error(n(p = "[".concat(this._clientId, "] can not subscribe ")).call(p, a.uid, ", user is not in the channel")),
                q.onError(b),
                b;
            }
            k.info(n(e = n(f = "[".concat(this._clientId, "] unsubscribe uid: ")).call(f, a.uid, ", mediaType: ")).call(e, b));
            (p = this._subscribeMutex.get(a.uid)) || (p = new $b("sub-".concat(a.uid)),
            this._subscribeMutex.set(a.uid, p));
            p = await p.lock();
            d = this._remoteStream.get(a.uid);
            var r;
            if (!d)
                return k.warning(n(r = "[".concat(this._clientId, "]: you have not subscribe the remote user ")).call(r, a.uid)),
                q.onSuccess(),
                void p();
            r = Bc({}, d.subscribeOptions);
            "audio" === b ? r.audio = !1 : ("video" === b || (r.audio = !1),
            r.video = !1);
            try {
                r.audio || r.video ? await this._gateway.subscribeChange(d, r) : (await d.closeP2PConnection(),
                ...
                if (x.code !== l.OPERATION_ABORTED)
                    throw q.onError(x),
                    p(),
                    k.error(n(u = "[".concat(this._clientId, "] unsubscribe user ")).call(u, a.uid, " error"), x.toString()),
                    x;
                p();
                k.debug("[".concat(this._clientId, "] ignore unsub operation abort"))
            }
            k.info(n(g = n(h = "[".concat(this._clientId, "] unsubscribe success uid: ")).call(h, a.uid, ", mediaType: ")).call(g, b));
            q.onSuccess()
        }
        ...
        async enableDualStream() {
            ...
            if (this._isDualStreamEnabled)
                throw b = new m(l.INVALID_OPERATION,"Dual stream is already enabled"),
                a.onError(b),
                b;
            if (this._highStream && "connected" === this._highStream.connectionState && this._highStream.videoTrack)
                try {
                    ...
                    throw t.streamSwitch(this._sessionId, {
                        lts: v(),
                        isdual: !0,
                        succ: !1
                    }),
            ...
            this._highStream && (this._highStream.lowStreamConnection = this._lowStream);
            t.streamSwitch(this._sessionId, {
                lts: v(),
                isdual: !0,
                succ: !0
        ...
        async setClientRole(a) {
            ...
            if ("rtc" === this._mode)
                return k.warning("rtc mode can not use setClientRole"),
            ...
            try {
                ...
                if ("audience" === a && this._highStream)
                    throw new m(l.INVALID_OPERATION,"can not set client role to audience when publishing stream");
                await this._gateway.setClientRole(a);
                k.info(n(d = "[".concat(this._clientId, "] set client role to ")).call(d, a));
                b.onSuccess()
            } catch (e) {
                throw b.onError(e),
                e;
        ...
        startProxyServer(a) {
            ...
            if ("DISCONNECTED" !== this.connectionState)
                throw new m(l.INVALID_OPERATION,"Start proxy server before join channel");
        ...
        async setRemoteVideoStreamType(a, b) {
            ...
            try {
                ...
                throw f.onError(g),
                k.error("[".concat(this._clientId, "] set remote video stream type error"), g.toString()),
                g;
            }
            k.info(n(d = n(e = "[".concat(this._clientId, "] set remote ")).call(e, a, " video stream type to ")).call(d, b));
        ...
        async setStreamFallbackOption(a, b) {
            ...
            try {
                ...
                throw f.onError(g),
                k.error("[".concat(this._clientId, "] set stream fallback option"), g.toString()),
                g;
            }
            k.info(n(d = n(e = "[".concat(this._clientId, "] set remote ")).call(e, a, " stream fallback type to ")).call(d, b));
            this._streamFallbackTypeCacheMap.set(a, b);
            f.onSuccess()
        }
        setEncryptionConfig(a, b) {
            Xa(a, "encryptionMode", ["aes-128-xts", "aes-256-xts", "aes-128-ecb", "sm4-128-ecb", "none"]);
            Ga(b, "secret");
        ...
        async renewToken(a) {
            ...
            if (!this._key)
                return a = new m(l.INVALID_OPERATION,"renewToken should not be called before user join"),
                b.onError(a),
                a.throw();
            this._key = a;
            try {
                ...
                throw b.onError(d),
                k.error("[".concat(this._clientId, "] renewToken failed"), d.toString()),
                d;
            }
        ...
        enableAudioVolumeIndicator() {
            ...
            this._audioVolumeIndicationInterval = window.setInterval(()=>{
                var a, d, e;
                let f = rd(a = D(d = Kb(qc(e = this._remoteStream).call(e))).call(d, a=>({
                    level: a.user.audioTrack ? 100 * a.user.audioTrack._source.getAudioAvgLevel() : 0,
                    uid: a.getUserId()
                }))).call(a, (a,b)=>a.level - b.level);
                this._highStream && this._highStream.audioTrack && (f.push({
        ...
        startLiveStreaming(a, b) {
            ...
            if (!b) {
                if ("h264" !== this._codec)
                    return a = new m(l.LIVE_STREAMING_INVALID_RAW_STREAM,"raw streaming is only support h264"),
                    d.onError(a),
                    u.reject(a);
                if (!this._highStream)
                    return a = new m(l.LIVE_STREAMING_INVALID_RAW_STREAM,"can not find stream to raw streaming"),
                    d.onError(a),
                    u.reject(a)
            }
            if (this._liveRawStreamingClient && this._liveRawStreamingClient.hasUrl(a) || this._liveTranscodeStreamingClient && this._liveTranscodeStreamingClient.hasUrl(a))
                return a = new m(l.LIVE_STREAMING_TASK_CONFLICT),
                d.onError(a),
                u.reject(a);
            b = b ? ma.TRANSCODE : ma.RAW;
            return this._createLiveStreamingClient(b).startLiveStreamingTask(a, b).then(()=>d.onSuccess()).catch(a=>{
                throw d.onError(a),
                a;
            }
            )
        ...
        setLiveTranscoding(a) {
            ...
            return this._createLiveStreamingClient(ma.TRANSCODE).setTranscodingConfig(a).then(()=>b.onSuccess()).catch(a=>{
                throw b.onError(a),
                a;
            }
            )
        ...
        stopLiveStreaming(a) {
            ...
            return e.length ? u.all(D(e).call(e, b=>b && b.stopLiveStreamingTask(a))).then(()=>d.onSuccess()).catch(a=>{
                throw d.onError(a),
                a;
            }
        ...
        async removeInjectStreamUrl() {
            ...
            try {
                ...
                let a = this._createLiveStreamingClient(ma.INJECT)
                  , f = R(b = Kb(qc(d = a.streamingTasks).call(d))).call(b, a=>a.mode === ma.INJECT);
                if (!this._joinInfo || !f)
                    throw new m(l.INVALID_OPERATION,"can remove addInjectStreamUrl, no joininfo or inject task");
        ...
        sendMetadata(a) {
            ...
            if (1024 < (new Blob([a])).size)
                throw new m(l.METADATA_OUT_OF_RANGE);
        ...
        async sendCustomReportMessage(a) {
            ...
            if (!this._joinInfo)
                return a = new m(l.INVALID_OPERATION,"can not send custom report, no join info"),
                b.onError(a),
                a.throw();
            await t.sendCustomReportMessage(this._joinInfo.sid, a)
        }
        getLocalAudioStats() {
            return this._highStream ? this._statsCollector.getLocalAudioTrackStats(this._highStream.connectionId) : se
        }
        getRemoteAudioStats() {
            var a;
            let b = {};
        ...
        getLocalVideoStats() {
            return this._highStream ? this._statsCollector.getLocalVideoTrackStats(this._highStream.connectionId) : te
        }
        getRemoteVideoStats() {
            var a;
            let b = {};
        ...
        _renewSession() {
            ...
            k.debug(n(a = n(b = "[".concat(this._clientId, "] renewSession ")).call(b, this._sessionId, " => ")).call(a, d));
            this._sessionId = d;
        ...
        async _publishHighStream(a) {
            ...
            if ("CONNECTED" !== this.connectionState && "RECONNECTING" !== this.connectionState)
                throw new m(l.INVALID_OPERATION,"can not publish stream in ".concat(this.connectionState, " state"));
            if ("auto" === this._turnServer.mode && C.FORCE_TURN && !C.TURN_ENABLE_TCP && !C.TURN_ENABLE_UDP)
            ...
            this._highStream)
                ...
                this._highStream;
            this._highStream = new gl(this._statsCollector,this._joinInfo,this._codec);
            ...
            return this._highStream.on(G.CONNECTION_STATE_CHANGE, (a,d)=>{
        ...
        async _publishLowStream(a) {
            ...
            if (this._lowStream)
                return (new m(l.UNEXPECTED_ERROR,"[".concat(this._clientId, "] Can't publish low stream when stream already publish"))).throw();
            k.debug("[".concat(this._clientId, "] publish low stream"));
            this._lowStream = new gl(this._statsCollector,this._joinInfo,this._codec,!0);
        ...
        _createLiveStreamingClient(a) {
            if (!this._joinInfo || !this._appId)
                return (new m(l.INVALID_OPERATION,"can not create live streaming client, please join channel first")).throw();
            let b = ()=>new Vp(this._joinInfo,this._config.websocketRetryConfig || Na,this._config.httpRetryConfig || Na)
              , d = a=>{
                ...
                a.on(Qc.REQUEST_WORKER_MANAGER_LIST, (a,b,d)=>{
                    ...
                    $h(a, this._joinInfo, this._axiosCancelSource.token, Na).then(b).catch(d)
                }
                )
            }
            ;
            ...
            case ma.INJECT:
                ...
                this._injectStreamingClient.on(Qc.REQUEST_WORKER_MANAGER_LIST, (a,b,d)=>{
                    if (!this._joinInfo)
                        return d(new m(l.INVALID_OPERATION,"can not find join info to get worker manager"));
                    $h(a, this._joinInfo, this._axiosCancelSource.token, Na).then(b).catch(d)
                }
        ...
        _createChannelMediaRelayClient() {
            return this._joinInfo ? (this._channelMediaRelayClient || (this._channelMediaRelayClient = new Xp(this._joinInfo,this._clientId,this._config.websocketRetryConfig || Na,this._config.httpRetryConfig || Na),
            ...
            this._channelMediaRelayClient) : (new m(l.INVALID_OPERATION,"can not create channel media relay client, please join channel first")).throw()
        }
        _handleGatewayEvents() {
            this._gateway.on(wa.DISCONNECT_P2P, ()=>{
                ...
                r(a = this._remoteStream).call(a, (a,d)=>{
                    var b;
                    k.debug(n(b = "[".concat(this._clientId, "] ready to reconnect remote stream ")).call(b, d));
                    a.readyToReconnectPC()
                }
                )
            }
            );
            this._gateway.on(wa.CONNECTION_STATE_CHANGE, (a,b,d)=>{
                var e, f;
                let g = ()=>{
                    this.emit(P.CONNECTION_STATE_CHANGE, a, b, d)
                }
                ;
                if (k.info(n(e = n(f = "[".concat(this._clientId, "] connection state change: ")).call(f, b, " -> ")).call(e, a)),
                "DISCONNECTED" === a)
                    return this._reset(),
                    this._renewSession(),
                    void g();
                ...
                if ("RECONNECTING" === a)
                    ...
                    r(h = this._remoteStream).call(h, (a,b)=>{
                        var d;
                        "connecting" === a.connectionState && (k.debug(n(d = "[".concat(this._clientId, "] ready to reconnect remote stream ")).call(d, b)),
                        a.readyToReconnectPC())
                    }
                    ),
                    ...
                    this._userOfflineTimeout = window.setTimeout(()=>{
                        ...
                        if ("CONNECTED" === this.connectionState) {
                            ...
                            r(b).call(b, a=>{
                                var b;
                                k.debug(n(b = "[".concat(this._clientId, "] user offline timeout, emit user offline ")).call(b, a.uid));
                    ...
                    this._streamRemovedTimeout = window.setTimeout(()=>{
                        ...
                        r(a = this._users).call(a, a=>{
                            var b, d, e, f, g;
                            a._trust_audio_mute_state_ || (k.debug(n(b = "[".concat(this._clientId, "] auto dispatch audio unmute event ")).call(b, a.uid)),
                            this._handleMuteStream(a.uid, "audio", !1));
                            a._trust_video_mute_state_ || (k.debug(n(d = "[".concat(this._clientId, "] auto dispatch video unmute event ")).call(d, a.uid)),
                            this._handleMuteStream(a.uid, "video", !1));
                            a._trust_audio_enabled_state_ || (k.debug(n(e = "[".concat(this._clientId, "] auto dispatch enable local audio ")).call(e, a.uid)),
                            this._handleSetStreamLocalEnable("audio", a.uid, !0));
                            !a._trust_video_enabled_state_ && a._video_enabled_ && (k.debug(n(f = "[".concat(this._clientId, "] auto dispatch enable local video ")).call(f, a.uid)),
                            this._handleSetStreamLocalEnable("video", a.uid, !0));
                            a._trust_stream_added_state_ || (k.debug(n(g = "[".concat(this._clientId, "] auto dispatch stream remove ")).call(g, a.uid)),
            ...
            this._gateway.on(wa.REQUEST_NEW_GATEWAY_LIST, (a,b)=>{
                ...
                Yh(this._joinInfo, this._axiosCancelSource.token, this._config.httpRetryConfig || Na).then(b=>{
                    var d;
                    this._joinInfo && (this._joinInfo.apResponse = b.gatewayInfo.res);
                    a(D(d = b.gatewayInfo.gatewayAddrs).call(d, a=>"wss://".concat(a)))
                }
                ).catch(b)
            }
            );
            ...
            this._gateway.on(wa.IS_P2P_DISCONNECTED, a=>{
                var b, d, e;
                let f = [];
                return this._highStream && f.push(this._highStream),
                r(b = this._remoteStream).call(b, a=>f.push(a)),
                0 === f.length || 0 === N(f).call(f, a=>"connected" === a.connectionState).length ? a(!0) : (k.debug(n(d = "[".concat(this._clientId, "] ")).call(d, D(e = N(f).call(f, a=>"connected" === a.connectionState)).call(e, a=>a.connectionId), " is connected")),
                void a(!1))
            }
            );
            ...
            this._gateway.signal.on(X.ON_ADD_AUDIO_STREAM, a=>this._handleAddAudioOrVideoStream("audio", a.uid, a.uint_id));
            this._gateway.signal.on(X.ON_ADD_VIDEO_STREAM, a=>this._handleAddAudioOrVideoStream("video", a.uid, a.uint_id));
            ...
            this._gateway.signal.on(X.MUTE_AUDIO, a=>this._handleMuteStream(a.uid, "audio", !0));
            this._gateway.signal.on(X.UNMUTE_AUDIO, a=>this._handleMuteStream(a.uid, "audio", !1));
            this._gateway.signal.on(X.MUTE_VIDEO, a=>this._handleMuteStream(a.uid, "video", !0));
            this._gateway.signal.on(X.UNMUTE_VIDEO, a=>this._handleMuteStream(a.uid, "video", !1));
            ...
            this._gateway.signal.on(X.ON_TOKEN_PRIVILEGE_WILL_EXPIRE, this._handleTokenWillExpire);
            ...
            this._gateway.signal.on(X.ON_STREAM_FALLBACK_UPDATE, a=>{
                var b, d;
                k.debug(n(b = n(d = "[".concat(this._clientId, "] stream fallback peerId: ")).call(d, a.stream_id, ", attr: ")).call(b, a.stream_type));
            ...
            this._gateway.signal.on(M.REQUEST_TIMEOUT, (a,b)=>{
                if (this._joinInfo)
                    switch (a) {
                    case ha.PUBLISH:
                        var d;
                        ...
                        "offer" === b.state && t.publish(this._joinInfo.sid, {
                            ...
                            screenshare: !(!a.videoTrack || -1 === E(d = a.videoTrack._hints).call(d, ib.SCREEN_TRACK)),
                            audioName: a.audioTrack && a.audioTrack.getTrackLabel(),
                            videoName: a.videoTrack && a.videoTrack.getTrackLabel()
                        });
                        break;
                    case ha.SUBSCRIBE:
                        (d = this._remoteStream.get(b.stream_id)) && b && t.subscribe(this._joinInfo.sid, {
                            lts: d.startTime,
                            succ: !1,
                            ec: l.TIMEOUT,
                            audio: !!b.audio,
    ...
    class $p extends Pk {
        ...
        startSourceNode() {
            ...
            this.sourceNode.onended = za(a = this.handleSourceNodeEnded).call(a, this))
        }
        createSourceNode() {
    ...
    let ni = new Y;
    var aq = fa.setInterval;
    let il = va().name;
    vc("PROCESS_ID", function() {
        var a, b, d, e;
        return n(a = n(b = n(d = n(e = "process-".concat(na(8, ""), "-")).call(e, na(4, ""), "-")).call(d, na(4, ""), "-")).call(b, na(4, ""), "-")).call(a, na(12, ""))
    }());
    (function() {
        let a = va();
        ea.getDisplayMedia = !(!navigator.mediaDevices || !navigator.mediaDevices.getDisplayMedia);
        ...
        b = va();
        b = !!(window.RTCRtpSender && window.RTCRtpSender.prototype.setParameters && window.RTCRtpSender.prototype.getParameters) && (!!Te() || b.name === da.SAFARI || b.name === da.FIREFOX && 64 <= Number(b.version));
        ea.supportSetRtpSenderParameters = b;
        a.name !== da.SAFARI && va().name !== da.WECHAT || (ea.supportDualStream = !1);
        b = va();
        b.name === da.SAFARI && 12 > Number(b.version) ? b = !1 : (b = yc(),
        b = b.createMediaStreamDestination ? !!b.createMediaStreamDestination().stream : !1);
        ea.webAudioMediaStreamDest = b;
        ea.supportReplaceTrack = !!window.RTCRtpSender && "function" == typeof RTCRtpSender.prototype.replaceTrack;
        ...
        b = va();
        b = (b.os === aa.WIN_10 || b.os === aa.WIN_81 || b.os === aa.WIN_7 || b.os === aa.LINUX || b.os === aa.MAC_OS || b.os === aa.MAC_OS_X) && b.name === da.CHROME && 74 <= Number(b.version);
    ...
    let vb = {
        ...
        getSupportedCodec: async function(a) {
            ...
            b.addStream(a)) : b = new Zk({});
            {
                ...
                a = (a.match(/ VP8/i) && d.video.push("VP8"),
        ...
        createCameraVideoTrack: async function(a={}) {
            ...
            if (!f)
                return e = new m(l.UNEXPECTED_ERROR,"can not find track in media stream"),
                b.onError(e),
                e.throw();
            a.optimizationMode && mf(e, f, a, a.encoderConfig && uc(a.encoderConfig));
            a = new fl(f,a,d,a.optimizationMode,e);
        ...
        createCustomVideoTrack: function(a) {
            let b = t.reportApiInvoke(null, {
              ...
              , d = new bb(a.mediaStreamTrack,{
                bitrateMax: a.bitrateMax,
                bitrateMin: a.bitrateMin
            },a.optimizationMode);
            return b.onSuccess(d.getTrackId()),
            k.info("create custom video track success with config", a, "trackId", d.getTrackId()),
            d
        },
        createScreenVideoTrack: async function(a={}, b="disable") {
            ...
            f && f.frameRate && ("number" == typeof f.frameRate ? (e.mandatory.maxFrameRate = f.frameRate,
            e.mandatory.minFrameRate = f.frameRate) : (e.mandatory.maxFrameRate = f.frameRate.max || f.frameRate.ideal || f.frameRate.exact || void 0,
            e.mandatory.minFrameRate = f.frameRate.min || f.frameRate.ideal || f.frameRate.exact || void 0),
            ...
            if (!n.supportShareAudio && "enable" === b)
                return a = new m(l.NOT_SUPPORTED,"your browser or platform is not support share-screen with audio"),
                d.onError(a),
                a.throw();
            k.info("start create screen video track with config", a, "withAudio", b, "trackId", g);
            try {
                let a = await Bb({
                    screen: f,
            ...
            if (!h)
                return a = new m(l.UNEXPECTED_ERROR,"can not find track in media stream"),
                d.onError(a),
                a.throw();
            if (!e && "enable" === b)
                return h && h.stop(),
            ...
            a.optimizationMode && (mf(g, h, a, a.encoderConfig && Fe(a.encoderConfig)),
            a.encoderConfig && "string" != typeof a.encoderConfig && (a.encoderConfig.bitrateMin = a.encoderConfig.bitrateMax));
            a = new bb(h,a.encoderConfig ? Fe(a.encoderConfig) : {},a.optimizationMode,g);
            if (a._hints.push(ib.SCREEN_TRACK),
            !e)
                return d.onSuccess(a.getTrackId()),
                k.info("create screen video track success", "video:", a.getTrackId()),
                a;
            b = new Va(e);
            return d.onSuccess([a.getTrackId(), b.getTrackId()]),
        ...
        createMicrophoneAndCameraTracks: async function(a={}, b={}) {
            ...
            let g = t.reportApiInvoke(null, {
              ...
              , u = null
              , v = null;
            k.info(n(d = n(e = n(f = "start create camera video track(".concat(r, ") and microphone audio track(")).call(f, p, ") with config, audio: ")).call(e, w(a), ", video: ")).call(d, w(b)));
            try {
                var C;
                let a = await Bb({
                    audio: q,
            ...
            if (!u || !v) {
                var B = new m(l.UNEXPECTED_ERROR,"can not find tracks in media stream");
                return g.onError(B),
                B.throw()
            }
            b.optimizationMode && mf(r, v, b, b.encoderConfig && uc(b.encoderConfig));
            a = new rg(u,a,q,p);
            b = new fl(v,b,h,b.optimizationMode,r);
            return g.onSuccess([a.getTrackId(), b.getTrackId()]),
            k.info(n(B = "create camera video track(".concat(r, ") and microphone audio track(")).call(B, p, ") success")),
            [a, b]
        },
        ...
        createCustomAudioTrack: function(a) {
            let b = t.reportApiInvoke(null, {
              ...
              , d = new Va(a.mediaStreamTrack,a.encoderConfig ? Ed(a.encoderConfig) : {});
            return k.info("create custom audio track success with config", a, "trackId", d.getTrackId()),
        ...
        createBufferSourceAudioTrack: async function(a) {
            let b = t.reportApiInvoke(null, {
              ...
              , d = na(8, "track-");
            k.info("start create buffer source audio track with config", w(a), "trackId", d);
            let e = a.source;
            if (!(a.source instanceof AudioBuffer))
                try {
                    a.source = await om(a.source, a.cacheOnlineFile)
                } catch (g) {
                    return b.onError(g),
                    g.throw()
                }
            let f = new $p(a.source);
            a = new xp(e,f,a.encoderConfig ? Ed(a.encoderConfig) : {},d);
            return k.info("create buffer source audio track success, trackId:", d),
            ...
            return new u(e=>{
                let l = aq(()=>{
                    ...
                    if (m || p > b) {
                        ...
                        k.info(n(r = "[track-".concat(a.getTrackId(), "] check audio track active completed. ")).call(r, w(p)));
                        d.onSuccess(p);
                        e(m)
                    }
                }
        ...
        checkVideoTrackIsActive: async function(a, b=5E3) {
            ...
            if (!(a instanceof bb || a instanceof yd))
                return a = new m(l.INVALID_TRACK,"the parameter is not a video track"),
                e.onError(a),
                a.throw();
            b && 1E3 > b && (b = 1E3);
            ...
            h.controls = !1;
            il === da.SAFARI && (h.style.opacity = "0.01",
            ...
            return k.info(n(d = "[track-".concat(a.getTrackId(), "] check video track active completed. ")).call(d, w(f))),
            e.onSuccess(f),
            b
        }
    };
    return ub.on(Rb.CAMERA_DEVICE_CHANGED, a=>{
